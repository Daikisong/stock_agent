...
| `medicube_ulta_tiktok_omnichannel_case` | `BEAUTY_DEVICE_EXPORT` | 2026-02-13 | missing_direct_symbol_mapping |
| `coupang_data_breach_case` | `DATA_SECURITY_SUPPLIER_REGULATION_OVERLAY` | undated | needs_exact_stage_date_backfill |
...
| `whirlpool_dividend_suspension_case` | `HOME_LIVING_APPLIANCE_RENTAL` | undated | needs_exact_stage_date_backfill |
| `shein_temu_ip_litigation_case` | `APPAREL_FAST_FASHION_BRAND_OEM` | 2026-05-11 | missing_public_price_data |
| `shein_temu_eu_product_safety_case` | `APPAREL_FAST_FASHION_BRAND_OEM` | undated | needs_exact_stage_date_backfill |
