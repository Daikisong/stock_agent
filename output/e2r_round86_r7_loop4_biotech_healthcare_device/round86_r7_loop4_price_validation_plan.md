...
| `lilly_foundayo_fda_approval_case` | `ORAL_GLP1_MAINTENANCE_THERAPY` | 2026-04-01 | needs_price_backfill |
| `lilly_foundayo_prescription_uptake_case` | `ORAL_GLP1_MAINTENANCE_THERAPY` | 2026-05-08 | needs_price_backfill |
| `lilly_foundayo_switch_maintenance_case` | `ORAL_GLP1_MAINTENANCE_THERAPY` | 2026-05-12 | needs_price_backfill |
| `boehringer_goodrx_humira_biosimilar_case` | `BIOSIMILAR_COMMERCIALIZATION` | 2024-07-18 | missing_direct_symbol_mapping |
...
| `hims_novo_partnership_case` | `GLP1_TELEHEALTH_CHANNEL` | 2026-03-09 | needs_price_backfill |
