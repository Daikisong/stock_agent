...
| `CRO_FUNDING_CYCLE_OVERLAY` | REDTEAM_FIRST |  | funding_cycle, customer_budget, forecast_cut, trial_delay |
...
| `BIOSIMILAR_PBM_FORMULARY_SWITCH` | WATCH_YELLOW_FIRST | pbm_listing, prescription_conversion, margin_defense, payer_access_scaled | pbm, formulary, prescription_switch, margin |
...
| `ORAL_GLP1_APPROVAL_COMMERCIALIZATION` | WATCH_YELLOW_FIRST | weekly_scripts, insurance_coverage, repeat_refill, price_defense, op_eps_revision | approval, scripts, coverage, price, refills |
...
| `MEDICAL_AI_SUBGROUP_GENERALIZATION_RISK` | REDTEAM_FIRST |  | subgroup, dataset_bias, deployment, reimbursement, liability |
...
| `SURGICAL_ROBOT_GLP1_PROCEDURE_MIX_OVERLAY` | REDTEAM_FIRST |  | procedure_mix, glp1, bariatric, hospital_capex |
