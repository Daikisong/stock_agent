...
| `samsung_hbm4_shipping_case` | `MEMORY_HBM_CAPACITY` | 2026-02-12 | needs_price_backfill |
| `samsung_labor_strike_execution_case` | `MEMORY_HBM_CAPACITY` | 2026-05-15 | needs_price_backfill |
| `kioxia_ai_nand_profit_case` | `COMMODITY_MEMORY_GENERAL_SEMI` | 2026-05-15 | needs_price_backfill |
...
| `coreweave_openai_contract_case` | `NEOCLOUD_GPU_RENTAL` | 2025-03-20 | needs_price_backfill |
| `coreweave_downsized_ipo_debt_case` | `NEOCLOUD_GPU_RENTAL` | 2025-03-28 | needs_price_backfill |
