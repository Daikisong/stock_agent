...
| full_4b_overlay_candidate | L10_POLICY_EVENT_CROSS_REDTEAM_MISC | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | L1_INDUSTRIALS_INFRA_DEFENSE_GRID | hold_for_more_evidence | Type1_safety_guardrail | False | need_more_good_non_price_4b_timing_cases | collect_non_overlapping_cases |
...
| full_4b_overlay_candidate | L2_AI_SEMICONDUCTOR_ELECTRONICS | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | L3_BATTERY_EV_GREEN_MOBILITY | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
| stage2_bonus_candidate_delta | L4_MATERIALS_SPREAD_RESOURCE | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
...
| local_4b_watch_guard | L5_CONSUMER_BRAND_DISTRIBUTION | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| full_4b_overlay_candidate | L6_FINANCIAL_CAPITAL_RETURN_DIGITAL | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| stage2_bonus_candidate_delta | L9_CONSTRUCTION_REALESTATE_HOUSING | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
...
| stage2_required_bridge | C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG | hold_for_more_evidence | Type1_safety_guardrail | False | guardrail_support_below_minimum | collect_non_overlapping_cases |
...
| full_4b_overlay_candidate | C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY | hold_for_more_evidence | Type1_safety_guardrail | False | need_more_good_non_price_4b_timing_cases | collect_non_overlapping_cases |
...
| stage2_bonus_candidate_delta | C07_HBM_EQUIPMENT_ORDER_RELATIVE_STRENGTH | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
| local_4b_watch_guard | C07_HBM_EQUIPMENT_ORDER_RELATIVE_STRENGTH | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
| stage2_bonus_candidate_delta | C09_ADVANCED_EQUIPMENT_VALUATION_BLOWOFF | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
| full_4b_overlay_candidate | C09_ADVANCED_EQUIPMENT_VALUATION_BLOWOFF | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| stage2_bonus_candidate_delta | C11_BATTERY_ORDERBOOK_RERATING | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
| stage2_bonus_candidate_delta | C12_BATTERY_CUSTOMER_CONTRACT_CALL_OFF_RISK | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
...
| full_4b_overlay_candidate | C13_BATTERY_JV_UTILIZATION_AMPC_IRA | hold_for_more_evidence | Type1_safety_guardrail | False | need_more_good_non_price_4b_timing_cases | collect_non_overlapping_cases |
| full_4b_overlay_candidate | C14_EV_DEMAND_SLOWDOWN_4B_4C | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
| stage2_bonus_candidate_delta | C15_MATERIAL_SPREAD_SUPERCYCLE | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
| stage2_bonus_candidate_delta | C16_STRATEGIC_RESOURCE_POLICY_SUPPLY | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
| stage2_bonus_candidate_delta | C17_CHEMICAL_COMMODITY_MARGIN_SPREAD | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
...
| local_4b_watch_guard | C21_FINANCIAL_ROE_PBR_CAPITAL_RETURN | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
| stage2_bonus_candidate_delta | C22_INSURANCE_RATE_CYCLE_RESERVE | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
| full_4b_overlay_candidate | C22_INSURANCE_RATE_CYCLE_RESERVE | hold_for_more_evidence | Type1_safety_guardrail | False | need_more_good_non_price_4b_timing_cases | collect_non_overlapping_cases |
...
| local_4b_watch_guard | C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| full_4b_overlay_candidate | C25_MEDICAL_DEVICE_EXPORT_REIMBURSEMENT | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| local_4b_watch_guard | C27_CONTENT_IP_GLOBAL_MONETIZATION | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| stage2_bonus_candidate_delta | C28_SOFTWARE_SECURITY_CONTRACT_RETENTION | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
...
| stage2_bonus_candidate_delta | C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
| stage2_bonus_candidate_delta | C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
...
| full_4b_overlay_candidate | C31_POLICY_SUBSIDY_LEGISLATION_EVENT | hold_for_more_evidence | Type1_safety_guardrail | False | need_more_good_non_price_4b_timing_cases | collect_non_overlapping_cases |
...
| full_4b_overlay_candidate | C32_GOVERNANCE_CONTROL_PREMIUM_TENDER_CAP | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
