...
| stage2_bonus_candidate_delta | L6_FINANCIAL_CAPITAL_RETURN_DIGITAL | blocked_by_data_quality | Type2_stage2_yellow_observation | False | evidence_url_pending_or_source_proxy_rate_above_25pct | verify_evidence_urls_or_replace_source_proxy_rows |
...
| stage2_bonus_candidate_delta | C02_POWER_GRID_DATACENTER_CAPEX | blocked_by_data_quality | Type2_stage2_yellow_observation | False | evidence_url_pending_or_source_proxy_rate_above_25pct | verify_evidence_urls_or_replace_source_proxy_rows |
...
| stage2_bonus_candidate_delta | C06_HBM_MEMORY_CUSTOMER_CAPACITY | blocked_by_data_quality | Type2_stage2_yellow_observation | False | evidence_url_pending_or_source_proxy_rate_above_25pct | verify_evidence_urls_or_replace_source_proxy_rows |
| stage2_bonus_candidate_delta | C07_HBM_EQUIPMENT_ORDER_RELATIVE_STRENGTH | blocked_by_data_quality | Type2_stage2_yellow_observation | False | evidence_url_pending_or_source_proxy_rate_above_25pct | verify_evidence_urls_or_replace_source_proxy_rows |
...
| stage2_bonus_candidate_delta | C10_MEMORY_RECOVERY_EQUIPMENT_CYCLE | blocked_by_data_quality | Type2_stage2_yellow_observation | False | evidence_url_pending_or_source_proxy_rate_above_25pct | verify_evidence_urls_or_replace_source_proxy_rows |
...
| local_4b_watch_guard | C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| stage2_bonus_candidate_delta | C22_INSURANCE_RATE_CYCLE_RESERVE | blocked_by_data_quality | Type2_stage2_yellow_observation | False | evidence_url_pending_or_source_proxy_rate_above_25pct | verify_evidence_urls_or_replace_source_proxy_rows |
...
| hard_4c_confirmation | R13_CROSS_ARCHETYPE_ACCOUNTING_TRUST_PRICE_VALIDATION | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
## Blockers
- evidence_url_pending: 1506 / v12 rows can support shadow analysis but need exact public evidence URLs before default promotion. / needed: Attach verified DART/IR/report/news URLs or mark rows as evidence-verified.
- source_proxy_only: 1340 / Some evidence is source-name-level historical event proxy, not verified production evidence. / needed: Replace proxy rows with verified as-of evidence records.
- rejected_rows: 1059 / Some rows failed validation or were not usable for shadow calibration. / needed: Fix missing sector/archetype IDs, price fields, or evidence flags.
