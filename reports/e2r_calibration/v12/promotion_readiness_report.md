...
| local_4b_watch_guard | L6_FINANCIAL_CAPITAL_RETURN_DIGITAL | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| stage2_bonus_candidate_delta | L9_CONSTRUCTION_REALESTATE_HOUSING | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
...
| full_4b_overlay_candidate | C13_BATTERY_JV_UTILIZATION_AMPC_IRA | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| local_4b_watch_guard | C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| stage2_bonus_candidate_delta | C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
...
## Blockers
- evidence_url_pending: 8 / v12 rows can support shadow analysis but need exact public evidence URLs before default promotion. / needed: Attach verified DART/IR/report/news URLs or mark rows as evidence-verified.
- source_proxy_only: 15 / Some evidence is source-name-level historical event proxy, not verified production evidence. / needed: Replace proxy rows with verified as-of evidence records.
- rejected_rows: 1484 / Some rows failed validation or were not usable for shadow calibration. / needed: Fix missing sector/archetype IDs, price fields, or evidence flags.
