...
- apply_next_patch_count: `111`
- stage_transition_summary_rows: `2251`
...
| local_4b_watch_guard | L10_POLICY_EVENT_CROSS_REDTEAM_MISC | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| full_4b_overlay_candidate | C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | C07_HBM_EQUIPMENT_ORDER_RELATIVE_STRENGTH | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | C11_BATTERY_ORDERBOOK_RERATING | hold_for_more_evidence | Type1_safety_guardrail | False | need_more_good_non_price_4b_timing_cases | collect_non_overlapping_cases |
...
| stage2_bonus_candidate_delta | C15_MATERIAL_SPREAD_SUPERCYCLE | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
...
| local_4b_watch_guard | C17_CHEMICAL_COMMODITY_MARGIN_SPREAD | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| full_4b_overlay_candidate | C21_FINANCIAL_ROE_PBR_CAPITAL_RETURN | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| full_4b_overlay_candidate | C27_CONTENT_IP_GLOBAL_MONETIZATION | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| local_4b_watch_guard | R13_CROSS_ARCHETYPE_HIGH_MAE_GUARDRAIL | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| full_4b_overlay_candidate | R13_CROSS_ARCHETYPE_STAGE2_FALSE_POSITIVE_REVIEW | hold_for_more_evidence | Type1_safety_guardrail | False | need_more_good_non_price_4b_timing_cases | collect_non_overlapping_cases |
...
## Blockers
- evidence_url_pending: 27 / v12 rows can support shadow analysis but need exact public evidence URLs before default promotion. / needed: Attach verified DART/IR/report/news URLs or mark rows as evidence-verified.
- source_proxy_only: 40 / Some evidence is source-name-level historical event proxy, not verified production evidence. / needed: Replace proxy rows with verified as-of evidence records.
- rejected_rows: 2886 / Some rows failed validation or were not usable for shadow calibration. / needed: Fix missing sector/archetype IDs, price fields, or evidence flags.
