...
| stage2_bonus_candidate_delta | L6_FINANCIAL_CAPITAL_RETURN_DIGITAL | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
...
| local_4b_watch_guard | C05_EPC_MEGA_CONTRACT_MARGIN_GAP | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| full_4b_overlay_candidate | C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY | apply_next_patch | Type1_safety_guardrail | True | none | implement_non_price_4b_overlay |
...
| stage2_bonus_candidate_delta | C21_FINANCIAL_ROE_PBR_CAPITAL_RETURN | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
| stage2_bonus_candidate_delta | C22_INSURANCE_RATE_CYCLE_RESERVE | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
...
| local_4b_watch_guard | C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |
...
| stage2_bonus_candidate_delta | C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE | apply_next_patch | Type2_stage2_yellow_observation | True | none | implement_bounded_stage2_bridge |
...
| stage2_bonus_candidate_delta | C32_GOVERNANCE_CONTROL_PREMIUM_TENDER_CAP | hold_for_more_evidence | Type2_stage2_yellow_observation | False | need_3_positive_symbols_2_counterexamples_8_rows_3_transitions | collect_non_overlapping_cases |
...
| local_4b_watch_guard | R13_CROSS_ARCHETYPE_STAGE2_FALSE_POSITIVE_REVIEW | apply_next_patch | Type1_safety_guardrail | True | none | implement_defensive_guardrail |

## Blockers
- evidence_url_pending: 34 / v12 rows can support shadow analysis but need exact public evidence URLs before default promotion. / needed: Attach verified DART/IR/report/news URLs or mark rows as evidence-verified.
- source_proxy_only: 36 / Some evidence is source-name-level historical event proxy, not verified production evidence. / needed: Replace proxy rows with verified as-of evidence records.
- rejected_rows: 721 / Some rows failed validation or were not usable for shadow calibration. / needed: Fix missing sector/archetype IDs, price fields, or evidence flags.
