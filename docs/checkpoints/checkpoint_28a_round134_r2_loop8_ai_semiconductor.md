# Checkpoint 28A Round 134 R2 Loop 8 AI Semiconductor Electronics

## 목적

`docs/round/round_134.md`의 R2 Loop 8 내용을 캘리브레이션 팩으로 반영했다.
...
- `src/e2r/sector/round134_r2_loop8_ai_semiconductor.py` 추가
- `src/e2r/cli/build_round134_r2_loop8_report.py` 추가
- `tests/test_round134_r2_loop8_ai_semiconductor.py` 추가
- R2 Loop 8 전용 case pack과 score profile 생성
...
- `data/e2r_case_library/cases_r2_loop8_round134.jsonl`
- `data/sector_taxonomy/score_weight_profiles_round134_r2_loop8_v8.csv`
- `output/e2r_round134_r2_loop8_ai_semiconductor/round134_r2_loop8_ai_semiconductor_summary.md`
- `output/e2r_round134_r2_loop8_ai_semiconductor/round134_r2_loop8_case_matrix.csv`
- `output/e2r_round134_r2_loop8_ai_semiconductor/round134_r2_loop8_score_stage_price_alignment.md`
...
```bash
PYTHONPATH=src python -m unittest tests/test_round134_r2_loop8_ai_semiconductor.py -v
PYTHONPATH=src python -m e2r.cli.build_round134_r2_loop8_report
```
