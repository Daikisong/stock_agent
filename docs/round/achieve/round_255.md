순서상 이번은 **R12 Loop 11 — 농업·생활서비스·기타 가격경로 검증 라운드**다.
...
이번 R12는 **생활가전 렌탈, 의대정원·사교육, AI 교과서·교실 기기 규제, 출산·돌봄정책, 김치 원재료 shock, 사료곡물 input cost, 펫/동물복지 전환, celebrity food event**를 같이 본다.

원시 수정주가 일봉 OHLC는 이번 환경에서 안정적으로 확보하지 못했다. 대신 Reuters / FT / Business Insider / MarketWatch / Tom’s Hardware / 공개 기업정보에서 확인되는 **정책 수치, 이벤트 수익률, 가격 anchor, input-cost 지표, 수요·공급 지표**만 계산했다. 그래서 30D/90D/180D full OHLC가 없는 항목은 `price_data_unavailable_after_deep_search`로 둔다.
...
R12의 Stage 3는 “방어주”, “정책 수혜”, “출산율 반등”, “교육정책”, “농산물 가격 상승”, “펫 전환”, “이벤트성 화제”가 아니다.

**반복매출·유료전환·ARPU·unit economics·가격전가·재고/채권 품질·현금전환이 확인되는 순간**이 Stage 3다.
...
- Malaysia / U.S. / Thailand / Indonesia / Vietnam expansion
- account growth / churn / ARPU / FCF

교육:
- Megastudy / YBMNet / NE Neungyule / Woongjin Thinkbig basket
- medical-school quota
- repeat course / paid enrollment / ARPU / OPM
...
- paid enrollment / utilization / margin
...
펫·동물복지:
- pet food / shelter / animal welfare / service basket
...
- celebrity/meme rally without revenue evidence
```
...
## Case A — Coway `success_candidate / recurring rental, but insufficient price evidence`
...
Stage 1:
2024~2026
- 정수기 / 공기청정기 / 비데 / 매트리스 렌탈 반복매출
- 생활가전 관리서비스
- Malaysia / U.S. / Thailand / Indonesia / Vietnam 등 해외 법인
...
Stage 3:
없음
- recurring rental 구조는 좋지만 최신 계정·churn·ARPU·FCF·가격경로 확인 전 Green 금지

Stage 4B:
방어적 렌탈 / 반복매출 frame으로 valuation이 성장률보다 먼저 확장되면 후보

Stage 4C:
product recall, churn spike, overseas slowdown, service-cost inflation, Netmarble capital-allocation risk
```

Coway는 R12에서 구조적으로 가장 Stage 3에 가까운 후보 중 하나지만, 이번 라운드에서는 최신 rental account, churn, ARPU, FCF, full OHLC를 확보하지 못했다. 공개 프로필상 Coway는 국내 최대 정수기 회사이고, 정수기·공기청정기·비데·매트리스 등 생활가전 렌탈/서비스 모델과 Malaysia, U.S., Thailand, Indonesia, Vietnam 등 해외 법인을 갖고 있다. 이 구조는 좋지만, **구조만으로 Green을 주면 안 된다**. ([위키백과][1])

### 실제 가격경로 검증

```text
price_data_source:
public company profile / search result only

stage3_price:
N/A

known_business_anchor:
largest domestic water purifier company
rental/service model
overseas subsidiaries present

latest_rental_accounts:
...
stage_failure_type = structural_candidate_not_green
```
...
```text
symbols = Megastudy / YBMNet / NE Neungyule / Woongjin Thinkbig basket
...
- 의대정원 확대 정책
- 의대 입시 / 재수 / 사교육 수요 기대
- trainee doctor strike 이후 정책 불확실성

Stage 2:
2026-02-10
- 의대정원 3,058명 → 2027년 3,548명
...
없음
- 정책만으로 교육주 Green 금지
- 실제 paid enrollment, repeat course, ARPU, OPM, cash conversion 확인 필요

Stage 4B:
의대정원 뉴스로 사교육주가 실제 수강생 증가보다 먼저 급등하면 후보

Stage 4C:
정책 후퇴, 의사단체 재반발, 사교육 규제, 학령인구 감소, AI tutoring disruption
```

의대정원 정책은 교육주에 Stage 1~2 event는 될 수 있다. 정부는 2027년 의대 정원을 3,058명에서 3,548명으로 늘리고, 2030년 3,871명까지 단계적으로 확대하겠다고 밝혔다. 계산상 2027년 증가는 +16.0%, 2030년 증가는 +26.6%다. 하지만 사교육주 Stage 3는 정책 수치가 아니라 **유료수강생·repeat course·ARPU·OPM**으로 확인되어야 한다. ([Reuters][2])
...
## Case C — AI textbook rollback / classroom device ban `4C-watch for edtech`
...
Stage 2:
약함
- AI 교육정책 자체는 attention event

Stage 3:
없음
- AI textbook adoption headline만으로 Green 금지

Stage 4C-watch:
2025-08
- AI textbooks reclassified from official textbooks to supplementary materials
- teacher/parent backlash
- teacher preparation concern

추가 4C-watch:
2025-08-27 / 2026-03 effective
- classroom mobile/digital-device ban passed
- 37% of middle/high school students say social media affects daily life
- 22% anxious without social media access
```

R12 교육·에듀테크에서 가장 중요한 건 “AI 교육”이라는 말이 아니라 **제도 채택과 예산, 교사·학부모 수용성**이다. South Korea는 AI 교과서를 공식 교과서에서 supplementary material로 낮췄고, 교사 설문에서 87.4%가 준비와 지원 부족을 느꼈다는 보도가 있었다. 동시에 국회는 2026년 3월부터 교실 내 휴대폰·디지털기기 사용을 금지하는 법안을 통과시켰다. 이는 AI edtech theme에 강한 policy-friction 4C-watch다. ([Business Insider][3])
...
2024~2025
- 저출산 정책
- 돌봄 / 육아 / 출산지원 / 외국인 가사노동 pilot
- childcare service 수요 기대

Stage 2:
2025-02-26 / 2026-02-25
- fertility rate 2023년 0.72 → 2024년 0.75 → 2025년 0.80
- 2025 births +6.8%
- marriages +8.1%
- Seoul fertility +8.9%
...
- successful pilot이면 1,200명까지 확대 가능

Stage 3:
없음
- 출산율 반등과 정책만으로 Green 금지
- 실제 childcare demand, paid enrollment, utilization, margin, recurring revenue 확인 필요
...
South Korea의 합계출산율은 2023년 0.72에서 2024년 0.75, 2025년 0.80으로 2년 연속 반등했고, 2025년 출생아는 +6.8%, 혼인은 +8.1% 증가했다. 동시에 외국인 가사·돌봄 노동 pilot은 약 100명의 Filipina workers로 시작해, 성공 시 1,200명까지 확대될 수 있다는 정책 frame이 있다. 하지만 childcare/infant goods/care service의 Stage 3는 fertility headline이 아니라 **유료수요·utilization·margin·반복매출**이다. ([Reuters][4])
...
## Case E — Kimchi cabbage / agri-food input shock `4C-watch`
...
- climate adaptation / stockpiling policy

Stage 2:
없음
- 원재료 가격 shock은 positive evidence가 아니라 RedTeam input
...
김치·식품가공 basket은 원재료 price shock을 강하게 봐야 한다. 정부는 이상고온으로 배추 작황이 악화되자 김장철을 앞두고 24,000톤의 배추를 방출하기로 했고, 배추 도매가격은 7월 초 약 3,000원에서 9월 중순 9,537원으로 급등했다가 10월 말 5,610원으로 내려왔다. 별도 Reuters 보도에 따르면 고랭지 배추 재배면적은 20년 전 8,796ha에서 최근 3,995ha로 줄었다. 이건 식품주 Green이 아니라 **input-cost 4C-watch**다. ([Reuters][5])
...
Stage 4C-watch:
2026-05-13
- Korea Feed Leaders Committee believed to make no purchase in 65,000t feed wheat tender
- prices regarded too high
- lowest offer $298.50/t c&f + $2/t surcharge
```

사료·축산 basket은 곡물 input cost를 반드시 RedTeam에 넣어야 한다. Korea Feed Leaders Committee는 최대 65,000톤 사료용 밀 tender에서 구매를 하지 않은 것으로 보였고, 이유는 가격 제시가 너무 높았기 때문이다. 최저 제안가는 $298.50/t c&f에 추가 하역 surcharge $2/t였고, 실질 최저가는 $300.50/t로 계산된다. ([Reuters][6])
...
## Case G — Dog-meat ban / pet-welfare transition `event_premium / policy watch`

```text
symbols = pet-food / shelter / animal-welfare / livestock-transition basket
case_type = event_premium / policy_watch
...
개식용 금지 전환은 pet/welfare transition policy event다. 정부는 약 1,000억 원의 지원책을 마련하고, 식용견 약 50만 마리를 입양·보호시설로 전환하려 하며, 농가는 반납하는 개 한 마리당 최대 600,000원을 받을 수 있다. 하지만 이것은 **정책 이벤트**이지, 상장 pet-food/service 기업의 매출 evidence는 아니다. ([Reuters][7])
...
- APEC / Nvidia Korea AI-chip deals
...
- Neuromeka jumped; MarketWatch says only Neuromeka retained gains by close
- event driver was viral dinner at non-listed Kkanbu Chicken
```

이 case는 R12에서 가장 깨끗한 `price_moved_without_evidence`다. Jensen Huang이 Samsung·Hyundai 경영진과 비상장 Kkanbu Chicken에서 치킨을 먹은 장면이 퍼지자, 상장 동종주 Kyochon F&B, Cherrybro, Neuromeka가 급등했다. Tom’s Hardware는 Kyochon이 최대 20%, Cherrybro가 daily limit 30%까지 올랐다고 보도했고, MarketWatch는 세 종목 중 Neuromeka만 종가까지 상승분을 유지했다고 전했다. 실제 store traffic, same-store sales, franchise margin은 확인되지 않았다. ([Tom's Hardware][8])
...
Neuromeka_event:
jumped; only one of the three retained gains by close according to MarketWatch
...
| ------------------------------- | -------------------------------- | ------------------------------------------------------------------------: | -------------------- |
| Coway                           | success_candidate / insufficient |                                       반복 렌탈 구조 확인, 최신 OHLC·churn·ARPU 미확보 | structural candidate |
| 의대정원 / 교육 basket                | event premium                    |                                    quota 3,058→3,548→3,871, +16.0%/+26.6% | policy watch         |
| AI textbook / phone ban         | 4C-watch                         |                                      AI textbook 보조자료화, phone ban 2026-03 | edtech friction      |
| fertility / childcare           | success_candidate                | fertility 0.72→0.80, births +6.8%, marriages +8.1%, housekeeper 100→1,200 | Stage 2              |
...
| dog-meat ban / pet transition   | event premium                    |                                 100B won support, 500k dogs, 600k won/dog | policy event         |
...
success_candidate:
- Coway
- fertility / childcare / care-service basket
...
- Coway latest rental accounts / churn / ARPU / FCF
...
Coway 같은 렌탈 기업은 R12에서 구조적으로 가장 좋은 후보군이다. 그러나 계정 수·churn·ARPU·FCF 없이는 Green이 아니다. 교육·돌봄·펫·농식품도 정책보다 실제 **유료수요와 가격전가**가 중요하다.
...
의대정원은 사교육주 수요 가능성을 만들지만, 곧바로 매출은 아니다. 출산율 반등도 childcare revenue로 바로 닫히지 않는다. 배추와 사료곡물 가격 shock은 식품·축산 기업의 margin risk다. Jensen Huang chicken event는 매출 evidence 없이 주가만 뛴 대표적인 4B다.
...
이번 R12 Loop 11에서는 hard 4C를 억지로 확정하지 않는다. `AI textbook rollback`, `kimchi cabbage input shock`, `feed wheat input shock`은 강한 4C-watch이고, `Kyochon/Cherrybro/Neuromeka`는 4B/event premium이다.
...
## docs/round/round_183.md 요약

```md
# R12 Loop 11. Agriculture / Life Service / Misc Price Validation

이번 라운드는 R12 Loop 11 price-validation 라운드다.

핵심 결론:
- Coway remains recurring-rental structural candidate, but latest rental accounts, churn, ARPU, FCF and OHLC were unavailable in this pass.
- Medical-school quota policy is education Stage 1/2. Quota rises from 3,058 to 3,548 in 2027 and 3,871 by 2030, implying +16.0% and +26.6%. Paid enrollment, ARPU and OPM required.
- AI textbook rollback and classroom phone/device ban are edtech 4C-watch. AI textbooks were reclassified as supplementary materials and classroom device ban starts March 2026.
- Fertility/childcare policy is Stage 2. Fertility rose from 0.72 in 2023 to 0.80 in 2025, births +6.8%, marriages +8.1%, and foreign housekeeper pilot could expand from 100 to 1,200 workers. Company revenue conversion required.
...
```md
# Checkpoint 28A Round 183 R12 Loop 11 Agri Life Service Misc Price Validation

## 반영 내용
- R12 Loop 11 price-validation 라운드를 추가했다.
...
- Reuters/FT/Business Insider/MarketWatch/Tom’s Hardware/public-company anchors로 가능한 MFE/MAE 및 policy/input-cost/event metrics를 계산했다.
...
{"case_id":"r12_loop11_kyochon_cherrybro_neuromeka_jensen_event","symbol":"339770/066360/348340","company_name":"Kyochon F&B / Cherrybro / Neuromeka","case_type":"overheat","primary_archetype":"FOOD_SERVICE_CELEBRITY_EVENT_PREMIUM","stage1_date":"2025-10-31","stage4b_date":"2025-10-31","price_validation":{"price_data_source":"Tom's Hardware/MarketWatch event-return summary","stage3_price":null,"kyochon_event_mfe_pct":20,"cherrybro_event_mfe_pct":30,"neuromeka_event":"jumped; only one of the three retained gains by close according to MarketWatch","fundamental_revenue_evidence_confirmed":false,"event_driver":"viral dinner at non-listed Kkanbu Chicken","price_validation_status":"reported_event_return_not_full_ohlc"},"score_price_alignment":"price_moved_without_evidence","rerating_result":"celebrity_food_event_premium","notes":"Celebrity fried-chicken event is 4B/event premium until store traffic, same-store sales, franchise margin and repeat demand confirm."}
```

## shadow weight row 초안

```csv
archetype,recurring_revenue,churn_stability,arpu_or_repeat_purchase,paid_conversion,utilization,unit_economics,cash_conversion,input_cost_pass_through,inventory_quality,subsidy_independence,event_penalty,4b_watch_sensitivity,hard_4c_sensitivity,notes
HOME_LIVING_RENTAL_RECURRING,+5,+5,+4,+3,+4,+5,+5,+2,+4,+3,-1,+3,+4,Coway recurring rental can be Stage 3 candidate but needs accounts/churn/ARPU/FCF.
EDUCATION_POLICY_MEDICAL_QUOTA,+3,+2,+5,+5,+3,+4,+4,+0,+1,+2,-5,+5,+4,Medical quota is event until paid enrollment/ARPU/OPM confirm.
EDTECH_AI_TEXTBOOK_POLICY_REVERSAL,+2,+2,+3,+4,+3,+4,+4,+0,+1,+2,-5,+4,+4,AI textbook rollback and phone ban create edtech policy friction.
CHILDCARE_DEMOGRAPHIC_POLICY_EVENT,+4,+3,+4,+5,+5,+4,+4,+1,+1,+3,-4,+5,+3,Fertility rebound is Stage 2; company utilization and recurring revenue must confirm.
AGRI_FOOD_INPUT_COST_SHOCK,+2,+0,+3,+2,+2,+4,+4,+5,+5,+2,-4,+4,+4,Kimchi cabbage shock requires pass-through and inventory control.
FEED_GRAIN_INPUT_COST_4C,+2,+0,+2,+1,+1,+4,+4,+5,+5,+2,-4,+4,+4,Feed wheat cost spike is 4C-watch for livestock/feed names.
PET_WELFARE_POLICY_TRANSITION,+2,+2,+3,+3,+3,+4,+4,+1,+2,+3,-5,+5,+3,Dog-meat ban is policy event until pet/service monetization confirms.
FOOD_SERVICE_CELEBRITY_EVENT_PREMIUM,+2,+0,+3,+3,+2,+4,+4,+3,+3,+1,-5,+5,+3,Celebrity food event is price_moved_without_evidence until traffic and margins confirm.
```
...
R12는 **좋은 구조 후보와 잡음성 이벤트가 가장 많이 섞이는 섹터**다. 그래서 Green gate는 느리게, 4B/Event Premium 분리는 빠르게 해야 한다.

```text
1. Coway는 recurring rental 구조 후보지만,
...
> **R12에서 진짜 Stage 3는 “정책·교육·출산·농산물·펫·생활서비스 테마가 좋아 보인다”가 아니라, 반복매출·유료전환·unit economics·가격전가·현금전환이 실제로 확인되는 순간이다.**
...
[4]: https://www.reuters.com/business/healthcare-pharmaceuticals/south-koreas-birthrate-worlds-lowest-rises-again-amid-signs-easing-demographic-2026-02-25/?utm_source=chatgpt.com "South Korea's birthrate, the world's lowest, rises again amid signs of easing demographic crisis"
