...
fine_archetype_id: AMPC_IRA_JV_UTILIZATION_TO_CASH_CONVERSION_HOLDOUT_V137_CELL_SEPARATOR_FOIL_MATERIAL_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 373220/2024: reused_from_prior_local_C13_C31_row_or_not_recomputed_this_turn
    - 361610/2024: reused_from_prior_local_C13_C31_hard_4C_row_or_not_recomputed_this_turn
    - 011790/2024: reused_from_prior_local_C13_C15_C16_boundary_row
    - 006110/2024: reused_from_prior_local_C13_C15_C16_foil_row
    - 018470/2024: reused_from_prior_local_C13_C15_C16_hard_4C_row
    - 006400/2024: not_recomputed_this_turn_future_C12_C13_candidate
    - 096770/2024: not_recomputed_this_turn_future_C12_C13_candidate
    - 003670/2024: not_recomputed_this_turn_future_C13_C15_candidate
    - 247540/2024: not_recomputed_this_turn_future_C12_C13_candidate
    - 121600/2024: not_recomputed_this_turn_future_C13_material_boundary
...
This file continues the local C13 sequence after the previously referenced `R3/C13 loop 136`; selected loop is therefore `137`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C13 AMPC/JV/battery candidate shards cache-missed or were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C13/C31/C15/C16 rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
```text
C13_AMPC_IRA_JV_UTILIZATION_TO_CASH_CONVERSION_GATE_V137_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L3_BATTERY_EV_GREEN_MOBILITY | C13_BATTERY_JV_UTILIZATION_AMPC_IRA | AMPC_IRA_JV_UTILIZATION_TO_CASH_HOLDOUT_V137 | 1 | 4 | 2 | 2 | 0 | 5 | 5 | 0 | 4 | false | false | 15 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C13 AMPC/JV/battery candidate shards cache-missed or were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_cache_miss_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R3","loop":"137","large_sector_id":"L3_BATTERY_EV_GREEN_MOBILITY","canonical_archetype_id":"C13_BATTERY_JV_UTILIZATION_AMPC_IRA","new_independent_case_count":0,"reused_case_count":5,"new_symbol_count":0,"new_trigger_family_count":0,"narrative_only_future_todo_count":1,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C13_AMPC_IRA_JV_utilization_to_cash_gate","dominant_driver_reclassification_guard"],"residual_error_types_found":["AMPC_label_without_cash_conversion","separator_localization_without_utilization","battery_material_event_wrong_bridge","foil_capacity_proxy_high_MAE","battery_proxy_commodity_false_positive"],"loop_contribution_label":"duplicate_low_value_loop_with_cache_miss_todo","do_not_propose_new_weight_delta":true}
```
