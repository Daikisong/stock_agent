...
fine_archetype_id: CHEMICAL_COMMODITY_SPREAD_MARGIN_FCF_HOLDOUT_V140_PETROCHEM_SYNTHETIC_RUBBER_POLYSILICON_EPOXY_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 011170/2024: cache_miss_observed_this_turn_or_reused_from_prior_local_file
    - 006650/2024: cache_miss_observed_this_turn_or_reused_from_prior_local_file
    ...
    - 161000/2024: reused_from_prior_local_C17_row
    - 004000/2024: cache_miss_or_not_recomputed_this_turn
    - 014680/2024: cache_miss_or_not_recomputed_this_turn
    - 178920/2024: cache_miss_or_not_recomputed_this_turn
...
This file continues the local C17 sequence after previously referenced `R4/C17 loop 139`; selected loop is therefore `140`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C17 chemical candidate shards cache-missed or were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C17/C15/C16 rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
reason:
  ...
  - direct fresh C17 chemical candidate shards cache-missed or were not recomputed in this execution
...
```text
C17_CHEMICAL_FEEDSTOCK_TO_PRODUCT_SPREAD_MARGIN_GATE_V140_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L4_MATERIALS_SPREAD_RESOURCE | C17_CHEMICAL_COMMODITY_MARGIN_SPREAD | CHEMICAL_COMMODITY_SPREAD_MARGIN_FCF_HOLDOUT_V140 | 3 | 7 | 4 | 5 | 0 | 10 | 10 | 0 | 7 | false | false | 18 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C17 chemical candidate shards cache-missed or were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_cache_miss_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R4","loop":"140","large_sector_id":"L4_MATERIALS_SPREAD_RESOURCE","canonical_archetype_id":"C17_CHEMICAL_COMMODITY_MARGIN_SPREAD","new_independent_case_count":0,"reused_case_count":10,"new_symbol_count":0,"new_trigger_family_count":0,"narrative_only_future_todo_count":1,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C17_chemical_feedstock_to_product_spread_margin_gate","dominant_driver_reclassification_guard"],"residual_error_types_found":["petrochemical_bottom_call_without_spread_repair","leveraged_chemical_balance_sheet_failure","solar_polysilicon_event_contamination","battery_material_event_wrong_bridge","specialty_high_MFE_without_FCF_bridge"],"loop_contribution_label":"duplicate_low_value_loop_with_cache_miss_todo","do_not_propose_new_weight_delta":true}
```
