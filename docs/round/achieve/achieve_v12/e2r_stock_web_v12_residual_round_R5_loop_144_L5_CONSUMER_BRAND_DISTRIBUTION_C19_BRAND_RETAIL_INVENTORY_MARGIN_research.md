...
fine_archetype_id: INVENTORY_SELLTHROUGH_OPM_RECEIVABLES_HOLDOUT_V144_DEPARTMENTSTORE_HYPERMARKET_APPAREL_BEAUTY_CONVENIENCE_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 069960/2024: reused_from_prior_local_C19_loop_143_positive_row
    - 139480/2024: reused_from_prior_local_C19_loop_143_hard_4C_row
    - 383220/2024: reused_from_prior_local_C18_C19_C20_channel_inventory_hard_4C_row
    - 090430/2024: reused_from_prior_local_C18_C19_C20_legacy_channel_hard_4C_row
    - 004170/2024: source_proxy_only_reverify_required_from_loop_143
    - 023530/2024: source_proxy_only_reverify_required_from_loop_143
    - 282330/2024: source_proxy_only_reverify_required_from_loop_143
    - 007070/2024: source_proxy_only_reverify_required_from_loop_143
    - 008770/2024: source_proxy_only_reverify_required_from_loop_143
    - 081660/2024: not_recomputed_this_turn_future_apparel_inventory_candidate
    - 051900/2024: not_recomputed_this_turn_future_legacy_beauty_inventory_candidate
    - 114090/2024: not_recomputed_this_turn_future_retail_distribution_candidate
    - 005440/2024: not_recomputed_this_turn_future_food_inventory_margin_candidate
    - 057050/2024: not_recomputed_this_turn_future_home_shopping_inventory_candidate
    - 002310/2024: not_recomputed_this_turn_future_packaging_inventory_boundary
    - 051500/2024: not_recomputed_this_turn_future_food_distribution_inventory_candidate
    - 192080/2024: not_recomputed_this_turn_future_retail_platform_inventory_boundary
    - 111770/2024: not_recomputed_this_turn_future_lifestyle_brand_inventory_candidate
...
This file continues the local R5/C19 consumer sequence after `R5/C19 loop 143`; selected loop is therefore `144`.

This is a **dedupe-aware holdout validation / mixed proxy-reverification** MD. Several rows reuse prior current-session stock-web-derived C18/C20/C19 rows. Several additional retail rows remain marked `source_proxy_only=true` because direct fresh C19 brand-retail inventory/margin candidate shards were not recomputed in this execution. Those source-proxy rows carry complete MFE/MAE fields for schema compatibility, but must be batch-reverified before any scoring update. No production scoring is changed.
...
```yaml
loop_144_note:
  independence_status: duplicate_holdout_with_proxy_reverify
  fresh_reprice_status: not_recomputed_this_execution
  reason: C19 remains under-covered, but this run reuses prior C19/C18/C20 boundary rows and must not create a new weight delta.
```
...
```text
C19_INVENTORY_SELLTHROUGH_OPM_RECEIVABLES_GATE_V144_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L5_CONSUMER_BRAND_DISTRIBUTION | C19_BRAND_RETAIL_INVENTORY_MARGIN | INVENTORY_SELLTHROUGH_OPM_RECEIVABLES_HOLDOUT_V144 | 2 | 7 | 2 | 5 | 0 | 9 | 9 | 0 | 7 | false | false | 9 |
...
```text
Do not patch production scoring from this MD alone. Treat this R5/C19 loop 144 as holdout validation only. Batch it with C19 loops 141~143, C18/C20 reclassification boundary rows, and R13 accounting-trust / Stage2 false-positive / high-MAE / 4B-4C guardrails. If exact same_entry_group_id rows already exist, dedupe them. Preserve the C19 inventory/sell-through/OPM/receivables gate, but do not create a new weight delta from this loop because five trigger rows are source_proxy_only and require batch reverification. Future research should directly reprice 신세계(004170), 롯데쇼핑(023530), BGF리테일(282330), GS리테일(007070), 호텔신라(008770), 휠라홀딩스(081660), LG생활건강(051900), 현대홈쇼핑(057050), 아세아제지(002310), CJ프레시웨이(051500), 코웨이(021240), 영원무역(111770), 신성통상(005390) when stock-web shards are accessible.
```
