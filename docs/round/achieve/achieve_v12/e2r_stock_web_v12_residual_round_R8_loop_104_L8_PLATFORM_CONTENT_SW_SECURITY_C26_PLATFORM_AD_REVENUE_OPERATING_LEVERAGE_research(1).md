...
fine_archetype_id: OWNED_INVENTORY_ARPU_MARGIN_HOLDOUT_VALIDATION_V104_VS_ADTECH_AGENCY_TRUE_PLATFORM_LABEL
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  uncached_symbol_shards:
    - additional_platform_adtech_candidate_shards: cache_miss_or_not_recomputed_this_turn
...
`C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE` remains Priority 0 in the current no-repeat index: 3 representative rows and 27 rows short of the 30-row minimum. The v12 scheduler maps C26~C28 to `R8 / L8_PLATFORM_CONTENT_SW_SECURITY`.

This file continues the local C26 sequence after `R8/C26 loop 103`; selected loop is therefore `104`.

This is a **dedupe-aware holdout validation** MD. It does not claim fresh independent evidence because additional platform/adtech candidate shards were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C26 rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.

---

## 1. Research thesis

C26 should not reward the word `platform`.

C26 should reward owned inventory monetization:
...
The recurring false-positive bucket is broad:
...
A company can live near advertising without owning the toll road. C26 should only pay when the company owns the surface and that surface turns into ARPU and margin.
...
### 5.1 NAVER / 035420 — owned platform bridge passport

NAVER remains the C26 positive-control because the bridge is owned inventory and ARPU/margin, not generic ad recovery.
...
SOOP owns the surface, but monetization refresh is incomplete after high MAE.
...
True platform identity does not equal operating leverage.
...
Adtech vocabulary does not pass the owned-inventory bridge test.
...
Agency business is not C26 owned-platform leverage.
...
Ad recovery label remains watch until ARPU/margin bridge appears.
...
```jsonl
{"row_type":"score_simulation","symbol":"035420","raw_owned_inventory":5,"raw_ARPU_take_rate":4,"raw_conversion_retention":4,"raw_margin_leverage":4,"raw_price_validation":4,"raw_label_only_risk":0,"raw_wrong_archetype_risk":0,"stage2_actionable_bonus_before":2.0,"stage2_actionable_bonus_after":2.0,"simulated_route":"KeepStage2_OwnedPlatform"}
{"row_type":"score_simulation","symbol":"067160","raw_owned_inventory":4,"raw_ARPU_take_rate":3,"raw_conversion_retention":3,"raw_margin_leverage":2,"raw_price_validation":2,"raw_label_only_risk":1,"raw_wrong_archetype_risk":0,"stage2_actionable_bonus_before":2.0,"stage2_actionable_bonus_after":1.0,"simulated_route":"Local4B_MonetizationRefresh"}
{"row_type":"score_simulation","symbol":"035720","raw_owned_inventory":4,"raw_ARPU_take_rate":1,"raw_conversion_retention":2,"raw_margin_leverage":0,"raw_price_validation":0,"raw_label_only_risk":2,"raw_wrong_archetype_risk":0,"stage2_actionable_bonus_before":2.0,"stage2_actionable_bonus_after":0.0,"simulated_route":"Stage2Cap_TruePlatformNoLeverage"}
{"row_type":"score_simulation","symbol":"214270","raw_owned_inventory":0,"raw_ARPU_take_rate":1,"raw_conversion_retention":1,"raw_margin_leverage":0,"raw_price_validation":0,"raw_label_only_risk":5,"raw_wrong_archetype_risk":1,"stage2_actionable_bonus_before":2.0,"stage2_actionable_bonus_after":0.0,"simulated_route":"Hard4C_AdtechNoInventory"}
{"row_type":"score_simulation","symbol":"030000","raw_owned_inventory":0,"raw_ARPU_take_rate":0,"raw_conversion_retention":0,"raw_margin_leverage":1,"raw_price_validation":0,"raw_label_only_risk":5,"raw_wrong_archetype_risk":5,"stage2_actionable_bonus_before":2.0,"stage2_actionable_bonus_after":0.0,"simulated_route":"ReclassifyAdAgency"}
{"row_type":"score_simulation","symbol":"216050","raw_owned_inventory":1,"raw_ARPU_take_rate":1,"raw_conversion_retention":1,"raw_margin_leverage":1,"raw_price_validation":1,"raw_label_only_risk":3,"raw_wrong_archetype_risk":2,"stage2_actionable_bonus_before":2.0,"stage2_actionable_bonus_after":0.0,"simulated_route":"Stage2WatchWeakAdRecovery"}
```
...
```text
C26_OWNED_INVENTORY_MONETIZATION_BRIDGE_REQUIREMENT_V104_HELD_OUT
...
one_line_summary: "This loop adds 0 new independent cases and validates the C26 owned-inventory monetization bridge gate across owned-platform positives, local 4B, true-platform cap, adtech hard 4C, agency reclassification and weak-watch rows."
```
