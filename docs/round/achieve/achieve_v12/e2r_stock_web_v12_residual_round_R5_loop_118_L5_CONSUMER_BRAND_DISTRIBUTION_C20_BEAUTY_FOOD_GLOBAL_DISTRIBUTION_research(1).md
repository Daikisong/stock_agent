...
fine_archetype_id: GLOBAL_DISTRIBUTION_SELLTHROUGH_REORDER_OPM_REVISION_HOLDOUT_V118_KFOOD_KBEAUTY_ODM_DTC_LEGACY_CHANNEL_RETAIL_BOUNDARY_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 278470/2025: reused_from_prior_local_C20_loop_117_DTC_vertical_4B
    - 003230/2024: reused_from_prior_local_C18_C20_late_entry_4B
    - 004370/2024: reused_from_prior_local_C18_C20_shelf_expansion_4B
    - 097950/2024: reused_from_prior_local_C18_C20_capacity_cap
    - 161890/2024: reused_from_prior_local_C18_C20_ODM_positive
    - 192820/2024: reused_from_prior_local_C18_C20_ODM_4B
    ...
    - 257720/2024: not_recomputed_this_turn_future_C20_beauty_distribution_candidate
    - 241710/2024: not_recomputed_this_turn_future_C20_ODM_distribution_candidate
    - 005180/2024: not_recomputed_this_turn_future_C20_Kfood_distribution_candidate
    - 271560/2024: not_recomputed_this_turn_future_C20_Kfood_distribution_candidate
    - 280360/2024: not_recomputed_this_turn_future_C20_Kfood_distribution_candidate
    - 051900/2024: not_recomputed_this_turn_future_C20_legacy_beauty_turnaround_candidate
    - 018290/2024: not_recomputed_this_turn_future_C20_Kbeauty_distribution_candidate
    - 214150/2024: not_recomputed_this_turn_C25_medical_device_boundary_exclusion
...
This file continues the local C20 sequence after `R5/C20 loop 117`; selected loop is therefore `118`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C20 beauty/food global-distribution candidate shards were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C18/C19/C20 boundary rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
loop_118_note:
  ...
  reason: C20 remains under-covered, but this run reuses prior C18/C19/C20 boundary rows and must not create a new weight delta.
```
...
reason:
  ...
  - direct fresh C20 beauty/food global-distribution candidate shards were not recomputed in this execution
...
```text
C20_GLOBAL_DISTRIBUTION_SELLTHROUGH_REORDER_OPM_GATE_V118_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L5_CONSUMER_BRAND_DISTRIBUTION | C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION | GLOBAL_DISTRIBUTION_SELLTHROUGH_OPM_HOLDOUT_V118 | 3 | 7 | 5 | 3 | 0 | 10 | 10 | 0 | 7 | false | false | 24 |
