...
fine_archetype_id: POLICY_HEADLINE_TO_LEGISLATION_BUDGET_COMPANY_CASHFLOW_HOLDOUT_V111_VALUEUP_AMPC_RESERVE_EXPLORATION_CONSTRUCTION_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 373220/2024: reused_from_prior_local_C31_loop_110_AMPC_policy_positive_row
    - 361610/2024: reused_from_prior_local_C31_loop_110_localization_hard_4C_row
    - 036460/2024: reused_from_prior_local_C31_loop_110_exploration_policy_4B_row
    - 105560/2024: reused_from_prior_local_C31_loop_110_valueup_bank_4B_row
    - 316140/2024: reused_from_prior_local_C31_loop_110_valueup_label_cap_row
    - 005830/2024: reused_from_prior_local_C31_loop_110_insurance_policy_positive_boundary
    - 088350/2024: reused_from_prior_local_C31_loop_110_life_valueup_cap_row
    - 004960/2024: reused_from_prior_local_C31_loop_110_construction_support_watch_row
    - 034020/2024: not_recomputed_this_turn_future_nuclear_policy_budget_candidate
    - 010120/2024: not_recomputed_this_turn_future_grid_policy_budget_candidate
    - 267260/2024: not_recomputed_this_turn_future_grid_policy_budget_candidate
    - 298040/2024: not_recomputed_this_turn_future_grid_policy_budget_candidate
    - 005380/2024: not_recomputed_this_turn_future_valueup_auto_policy_candidate
    - 000270/2024: not_recomputed_this_turn_future_valueup_auto_policy_candidate
    - 009410/2024: not_recomputed_this_turn_future_PF_guarantee_policy_candidate
    - 034300/2024: not_recomputed_this_turn_future_PF_guarantee_policy_candidate
    - 055550/2024: not_recomputed_this_turn_future_bank_valueup_execution_candidate
    - 086790/2024: not_recomputed_this_turn_future_bank_valueup_execution_candidate
    - 000810/2024: not_recomputed_this_turn_future_insurance_capital_return_policy_candidate
    - 001450/2024: not_recomputed_this_turn_future_insurance_capital_return_policy_candidate
    - 047810/2024: not_recomputed_this_turn_future_defense_policy_subsidy_boundary
...
This file continues the local C31 policy sequence after `R11/C31 loop 110`; selected loop is therefore `111`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence. The trigger rows below reuse current-session stock-web-derived policy boundary rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Direct fresh C31 policy/subsidy/legislation/value-up/budget candidate shards were not recomputed in this execution and are kept as future TODO rows. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
loop_111_note:
  ...
  reason: C31 remains one of the lowest-row Priority 0 archetypes, but this run reuses prior C31/C13/C16/C21/C22/C30 boundary rows and must not create a new weight delta.
```
...
reason:
  ...
  - direct fresh C31 policy/subsidy/legislation candidate shards were not recomputed in this execution
...
```jsonl
{"row_type":"narrative_only_future_todo","selected_round":"R11","selected_loop":111,"large_sector_id":"L10_POLICY_EVENT_CROSS_REDTEAM_MISC","canonical_archetype_id":"C31_POLICY_SUBSIDY_LEGISLATION_EVENT","fine_archetype_id":"C31_NEW_POLICY_SUBSIDY_LEGISLATION_REPRICE_TODO_AFTER_CACHE_MISS","candidate_symbols":["034020","010120","267260","298040","005380","000270","009410","034300","009830","096770","000660","042660"],"candidate_names":["두산에너빌리티","LS ELECTRIC","HD현대일렉트릭","효성중공업","현대차","기아","태영건설","신세계건설","한화솔루션","SK이노베이션","SK하이닉스","한화오션"],"why_not_trigger_row_now":"fresh stock-web symbol-year shards for new C31 policy/subsidy/budget/legal/value-up events were not recomputed in this execution; no fresh 30D/90D/180D MFE/MAE computed here","calibration_usable":false,"score_alignment":"future run should compute stock-web windows before counting these as new C31 evidence; distinguish policy headline from enacted budget, eligibility, company allocation, cash recognition and adjacent archetype drivers"}
```
...
```text
C31_POLICY_HEADLINE_TO_LEGISLATION_BUDGET_COMPANY_CASHFLOW_GATE_V111_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L10_POLICY_EVENT_CROSS_REDTEAM_MISC | C31_POLICY_SUBSIDY_LEGISLATION_EVENT | POLICY_HEADLINE_TO_CASHFLOW_HOLDOUT_V111 | 3 | 5 | 2 | 1 | 0 | 8 | 8 | 0 | 6 | false | false | 27 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C31 policy/subsidy/legislation/value-up/budget candidates were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_cache_miss_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R11","loop":"111","large_sector_id":"L10_POLICY_EVENT_CROSS_REDTEAM_MISC","canonical_archetype_id":"C31_POLICY_SUBSIDY_LEGISLATION_EVENT","new_independent_case_count":0,"reused_case_count":8,"new_symbol_count":0,"new_trigger_family_count":0,"narrative_only_future_todo_count":1,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C31_policy_to_legislation_budget_cashflow_gate","adjacent_archetype_reclassification_guard"],"residual_error_types_found":["policy_headline_without_company_cashflow","localization_without_utilization","valueup_label_without_execution","exploration_policy_without_commerciality","construction_support_without_refinancing_cash"],"loop_contribution_label":"duplicate_low_value_loop_with_cache_miss_todo","do_not_propose_new_weight_delta":true}
```
...
```text
Do not patch production scoring from this MD alone. Treat this R11/C31 loop 111 as holdout validation only. Batch it with C31 loops 103~110, C13 AMPC/IRA rows, C16 policy-resource rows, C21/C22 value-up/capital-return rows, C30 construction support rows, and R13 accounting-trust / Stage2 false-positive / high-MAE / 4B-4C guardrails. If exact same_entry_group_id rows already exist, dedupe them. Preserve the C31 policy-headline-to-legislation/budget/company-cashflow gate and adjacent-archetype reclassification guard, but do not create a new weight delta from this loop because no new independent case was added. Future research should directly reprice new C31 policy/subsidy/legal events such as grid budget, defense subsidy, shipbuilding support, value-up executions, AMPC eligibility changes, nuclear project law/budget events, PF guarantee policies, auto value-up execution, insurance capital-return policy events, bank value-up execution events, and export-credit or defense procurement policy cases when stock-web shards are accessible.
```
