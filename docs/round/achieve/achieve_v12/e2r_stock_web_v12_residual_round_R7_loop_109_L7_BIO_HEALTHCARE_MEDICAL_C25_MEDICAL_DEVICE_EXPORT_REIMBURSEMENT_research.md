...
fine_archetype_id: INSTALLED_BASE_REIMBURSEMENT_RECURRING_REVENUE_HOLDOUT_V109_AESTHETIC_DENTAL_CGM_IMAGING_ROBOT_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 214150/2024: reused_from_prior_local_C25_loop_108_or_not_recomputed_this_turn
    - 145720/2024: reused_from_prior_local_C25_loop_108_or_not_recomputed_this_turn
    - 214450/2024: not_recomputed_this_turn_future_aesthetic_reimbursement_candidate
    - 336570/2024: not_recomputed_this_turn_future_aesthetic_device_candidate
    - 043150/2024: reused_from_prior_local_C25_row
    - 228670/2024: reused_from_prior_local_C25_row
    - 335890/2024: reused_from_prior_local_C25_row
    - 059210/2024: reused_from_prior_local_C25_row
    - 041830/2024: reused_from_prior_local_C25_row
    - 100120/2024: reused_from_prior_local_C25_row
    - 065510/2024: reused_from_prior_local_C25_row
    - 099190/2024: reused_from_prior_local_C25_row
    - 214680/2024: reused_from_prior_local_C25_row
    - 060280/2024: reused_from_prior_local_C25_row
    - 302550/2024: reused_from_prior_local_C25_row
    - 039840/2024: not_recomputed_this_turn_future_device_export_candidate
    - 226950/2024: not_recomputed_this_turn_future_implant_device_candidate
    - 246960/2024: not_recomputed_this_turn_future_device_component_boundary
    - 290650/2024: not_recomputed_this_turn_future_medtech_AI_boundary
...
This file continues the local C25 sequence after `R7/C25 loop 108`; selected loop is therefore `109`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C25 medical-device/export/reimbursement candidate shards were not recomputed in this execution. The trigger rows below reuse prior current-session / file-library stock-web-derived C25 rows that already contain complete 30D/90D/180D MFE and MAE. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
loop_109_note:
  ...
  reason: C25 remains under-covered, but this run reuses prior C25 rows and must not create a new weight delta.
```
...
```text
C25_INSTALLED_BASE_REIMBURSEMENT_RECURRING_REVENUE_GATE_V109_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L7_BIO_HEALTHCARE_MEDICAL | C25_MEDICAL_DEVICE_EXPORT_REIMBURSEMENT | INSTALLED_BASE_REIMBURSEMENT_RECURRING_REVENUE_HOLDOUT_V109 | 6 | 7 | 4 | 4 | 0 | 13 | 13 | 0 | 9 | false | false | 24 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C25 medical-device/export/reimbursement candidate shards were not recomputed in this execution
loop_contribution_label: duplicate_low_value_loop_with_cache_miss_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R7","loop":"109","large_sector_id":"L7_BIO_HEALTHCARE_MEDICAL","canonical_archetype_id":"C25_MEDICAL_DEVICE_EXPORT_REIMBURSEMENT","new_independent_case_count":0,"reused_case_count":13,"new_symbol_count":0,"new_trigger_family_count":0,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C25_installed_base_reimbursement_recurring_revenue_gate","source_proxy_batch_reverification_gate"],"residual_error_types_found":["dental_device_label_without_channel_bridge","medical_device_keyword_without_repeat_sales","high_MFE_price_blowoff_without_export_order_margin","CGM_reimbursement_without_recurring_sensor_revenue_refresh","imaging_robot_keyword_without_procedure_volume"],"loop_contribution_label":"duplicate_low_value_loop_with_cache_miss_todo","do_not_propose_new_weight_delta":true}
```
