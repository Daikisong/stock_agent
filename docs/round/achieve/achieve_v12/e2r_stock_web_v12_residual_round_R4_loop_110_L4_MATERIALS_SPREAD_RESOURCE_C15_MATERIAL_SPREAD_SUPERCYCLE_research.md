...
fine_archetype_id: MATERIAL_SPREAD_ASP_VOLUME_MARGIN_FCF_HOLDOUT_V110_CHEMICAL_METAL_FOIL_POLYSILICON_PROCESSING_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 002380/2024: reused_from_prior_local_C15_loop_109_positive_row
    - 011780/2024: reused_from_prior_local_C15_C17_positive_row
    - 010130/2024: reused_from_prior_local_C15_C16_C32_contamination_row
    - 011790/2024: reused_from_prior_local_C15_C16_C17_boundary_row
    - 103140/2024: reused_from_prior_local_C15_C16_processing_4B_row
    - 006110/2024: reused_from_prior_local_C15_C16_foil_4B_row
    - 018470/2024: reused_from_prior_local_C15_C16_hard_4C_row
    - 298000/2024: reused_from_prior_local_C15_C17_hard_4C_row
    - 011170/2024: reused_from_prior_local_C15_C17_hard_4C_row
    - 006650/2024: reused_from_prior_local_C15_C17_hard_4C_row
    - 010060/2024: reused_from_prior_local_C15_C17_4B_row
    - 009830/2024: reused_from_prior_local_C15_C17_hard_4C_row
    - 005490/2024: not_recomputed_this_turn_future_C15_steel_material_candidate
    - 003670/2024: not_recomputed_this_turn_future_C15_battery_material_candidate
    ...
    - 096770/2024: not_recomputed_this_turn_future_refining_material_boundary
...
This file continues the local C15 sequence after `R4/C15 loop 109`; selected loop is therefore `110`.

This is a **dedupe-aware holdout validation / adjacent-row reuse / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C15 material-spread candidate shards were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C15/C16/C17/C32 boundary rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
loop_110_note:
  ...
  reason: C15 remains under-covered, but this run reuses prior C15/C16/C17 boundary rows and must not create a new weight delta.
```
...
loop_contribution_label: duplicate_low_value_loop_with_adjacent_reuse_cache_miss_todo
...
```text
C15_MATERIAL_SPREAD_ASP_VOLUME_MARGIN_FCF_GATE_V110_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L4_MATERIALS_SPREAD_RESOURCE | C15_MATERIAL_SPREAD_SUPERCYCLE | MATERIAL_SPREAD_ASP_VOLUME_MARGIN_FCF_HOLDOUT_V110 | 2 | 10 | 5 | 5 | 0 | 12 | 12 | 0 | 9 | false | false | 24 |
