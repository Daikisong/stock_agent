...
fine_archetype_id: EXPORT_CHANNEL_REORDER_SELLTHROUGH_INVENTORY_OPM_HOLDOUT_V150_KFOOD_KBEAUTY_ODM_DTC_LEGACY_CHANNEL_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 278470/2025: reused_from_prior_local_C18_C20_row
    - 003230/2024: reused_from_prior_local_C18_C20_row
    - 004370/2024: reused_from_prior_local_C18_C20_row
    - 097950/2024: reused_from_prior_local_C18_C20_row
    - 161890/2024: reused_from_prior_local_C18_C20_positive_row
    - 192820/2024: reused_from_prior_local_C18_C20_4B_row
    - 090430/2024: reused_from_prior_local_C18_C19_C20_hard_4C_row
    - 383220/2024: reused_from_prior_local_C18_C19_C20_hard_4C_row
    - 069960/2024: reused_from_prior_local_C18_C19_wrong_archetype_row
    - 257720/2024: not_recomputed_this_turn_future_C18_C20_candidate
    - 241710/2024: not_recomputed_this_turn_future_C18_C20_candidate
...
This file continues the local C18 sequence after `R5/C18 loop 149`; selected loop is therefore `150`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C18 export-channel/reorder candidate shards were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C18/C20/C19 rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
reason:
  ...
  - direct fresh C18 export-channel/reorder candidate shards were not recomputed in this execution
...
```text
C18_EXPORT_CHANNEL_REORDER_SELLTHROUGH_OPM_GATE_V150_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L5_CONSUMER_BRAND_DISTRIBUTION | C18_CONSUMER_EXPORT_CHANNEL_REORDER | EXPORT_CHANNEL_REORDER_SELLTHROUGH_HOLDOUT_V150 | 4 | 5 | 5 | 2 | 0 | 9 | 9 | 0 | 5 | false | false | 27 |
