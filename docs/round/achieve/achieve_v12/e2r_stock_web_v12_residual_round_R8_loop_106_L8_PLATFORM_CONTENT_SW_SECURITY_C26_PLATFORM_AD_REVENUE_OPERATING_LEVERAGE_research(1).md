...
fine_archetype_id: PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_HOLDOUT_V106_SEARCH_TALKBIZ_CREATOR_COMMERCE_ADTECH_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 035420/2024: cache_miss_observed_this_turn
    - 035720/2024: cache_miss_observed_this_turn
    - 067160/2024: cache_miss_observed_this_turn
    - 042000/2024: cache_miss_observed_this_turn
    - 089600/2024: cache_miss_or_not_recomputed_this_turn
    - 216050/2024: cache_miss_or_not_recomputed_this_turn
    - 237820/2024: cache_miss_or_not_recomputed_this_turn
    - 214270/2024: cache_miss_or_not_recomputed_this_turn
    - 060250/2024: cache_miss_or_not_recomputed_this_turn
    - 030000/2024: cache_miss_or_not_recomputed_this_turn
...
This file follows recent R8 files and uses `selected_loop=106` for the C26 pair, matching the local sequence that previously referenced `R8/C26 loop 105`.

This is a **source-proxy-only holdout / reprice TODO** MD. Direct fresh `Songdaiki/stock-web` symbol-year shard access for the C26 candidates cache-missed or was unavailable in this execution. Therefore every trigger row below is explicitly marked:
...
row_provenance:
  ...
  reason:
    - direct raw stock-web shards for 035420, 035720, 067160 and 042000 returned cache miss
    - other C26 candidates were not recomputed in this execution
...
```jsonl
{"row_type":"narrative_only_future_todo","selected_round":"R8","selected_loop":106,"large_sector_id":"L8_PLATFORM_CONTENT_SW_SECURITY","canonical_archetype_id":"C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE","fine_archetype_id":"C26_NEW_PLATFORM_AD_REVENUE_REPRICE_TODO_AFTER_CACHE_MISS","candidate_symbols":["035420","035720","067160","042000","089600","216050","237820","214270","060250","030000","035600","064260","068790"],"candidate_names":["NAVER","카카오","SOOP","카페24","나스미디어","인크로스","플레이디","FSN","NHN KCP","제일기획","KG이니시스","다날","DMS-platform_noise_check"],"why_not_trigger_row_now":"fresh stock-web symbol-year shards were unavailable or cache-missed in this execution; no fresh independent 30D/90D/180D MFE/MAE computed here","calibration_usable":false,"score_alignment":"future run should compute stock-web windows before counting new C26 evidence; distinguish platform ad operating leverage from C27 content/IP, C28 software retention, payment processing volume and agency macro recovery"}
```
...
```text
C26_PLATFORM_AD_REVENUE_TO_OPERATING_LEVERAGE_GATE_V106_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L8_PLATFORM_CONTENT_SW_SECURITY | C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE | PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_HOLDOUT_V106 | 2 | 8 | 1 | 4 | 0 | 10 | 0 | 0 | 8 | false | false | 27 |
