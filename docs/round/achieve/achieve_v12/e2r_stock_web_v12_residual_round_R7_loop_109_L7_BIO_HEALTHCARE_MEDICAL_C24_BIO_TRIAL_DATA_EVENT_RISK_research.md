...
fine_archetype_id: BINARY_TRIAL_DATA_EVENT_QUALITY_FOLLOWTHROUGH_HOLDOUT_V109_PLATFORM_DATA_LICENSE_CRL_LABEL_SPIKE_REROUTE_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 196170/2024: reused_from_prior_local_C24_loop_108_platform_data_row_or_not_recomputed_this_turn
    - 141080/2024: reused_from_prior_local_C24_loop_108_ADC_license_row_or_not_recomputed_this_turn
    - 950160/2024: reused_from_prior_local_C24_loop_108_trial_restart_4B_row
    - 069620/2024: reused_from_prior_local_C24_loop_108_delayed_pipeline_row
    - 128940/2024: reused_from_prior_local_C24_loop_108_pipeline_label_4C_row_or_not_recomputed_this_turn
    - 028300/2024: reused_from_prior_local_C23_C24_binary_failure_row
    - 115180/2024: not_recomputed_this_turn_future_trial_data_candidate
    - 365270/2024: not_recomputed_this_turn_future_trial_data_candidate
    - 203400/2024: not_recomputed_this_turn_future_trial_data_candidate
    - 206650/2024: not_recomputed_this_turn_future_vaccine_trial_candidate
    - 237690/2024: not_recomputed_this_turn_future_CDMP_mRNA_trial_boundary
    - 256840/2024: not_recomputed_this_turn_future_bio_event_risk_candidate
    - 214450/2024: not_recomputed_this_turn_C25_medical_device_boundary_exclusion
    - 068270/2024: not_recomputed_this_turn_C23_commercialization_boundary
    - 185750/2024: not_recomputed_this_turn_C23_commercialization_boundary
...
This file continues the local C24 sequence after `R7/C24 loop 108`; selected loop is therefore `109`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C24 trial-data/event-risk candidate shards were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C24/C23/R13 rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
loop_109_note:
  ...
  reason: C24 remains under-covered, but this run reuses prior C24/C23/R13 boundary rows and must not create a new weight delta.
```
...
```text
C24_BINARY_EVENT_QUALITY_FOLLOWTHROUGH_GATE_V109_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L7_BIO_HEALTHCARE_MEDICAL | C24_BIO_TRIAL_DATA_EVENT_RISK | BINARY_TRIAL_DATA_EVENT_QUALITY_FOLLOWTHROUGH_HOLDOUT_V109 | 2 | 2 | 3 | 2 | 0 | 6 | 6 | 0 | 5 | false | false | 17 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C24 trial-data/event-risk candidate shards were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_cache_miss_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R7","loop":"109","large_sector_id":"L7_BIO_HEALTHCARE_MEDICAL","canonical_archetype_id":"C24_BIO_TRIAL_DATA_EVENT_RISK","new_independent_case_count":0,"reused_case_count":6,"new_symbol_count":0,"new_trigger_family_count":0,"narrative_only_future_todo_count":1,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C24_binary_event_quality_followthrough_gate","no_backfill_later_evidence"],"residual_error_types_found":["price_MFE_event_cap_without_endpoint_bridge","pipeline_label_false_positive","binary_regulatory_failure_no_backfill","platform_license_de_risking_needs_source_repair"],"loop_contribution_label":"duplicate_low_value_loop_with_cache_miss_todo","do_not_propose_new_weight_delta":true}
```
