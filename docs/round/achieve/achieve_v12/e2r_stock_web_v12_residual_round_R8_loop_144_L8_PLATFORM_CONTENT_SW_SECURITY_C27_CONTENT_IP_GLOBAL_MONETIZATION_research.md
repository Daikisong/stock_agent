...
fine_archetype_id: CONTENT_IP_REPEAT_CASH_BRIDGE_HOLDOUT_V144_WEBTOON_FILM_KIDS_GAME_ARTIST_SLATE_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 036570/2024: not_recomputed_this_turn_future_game_IP_candidate
    - 112040/2024: not_recomputed_this_turn_future_game_token_IP_boundary
    - 078340/2024: not_recomputed_this_turn_future_game_live_service_candidate
    - 194480/2024: not_recomputed_this_turn_future_cookie_run_IP_candidate
    - 263720/2024: reused_from_prior_local_C27_loop_143_webtoon_4B
    - 086980/2024: reused_from_prior_local_C27_loop_143_boxoffice_positive_cap
    - 419530/2024: reused_from_prior_local_C27_loop_143_character_IP_4B
    - 259960/2024: reused_from_prior_local_C27_loop_143_source_proxy_game_IP_positive
    - 263750/2024: reused_from_prior_local_C27_loop_143_source_proxy_game_launch_4B
    - 293490/2024: reused_from_prior_local_C27_loop_143_source_proxy_game_label_4C
    - 035900/2024: reused_from_prior_local_C27_loop_143_source_proxy_artist_cycle_4C
    - 253450/2024: reused_from_prior_local_C27_loop_143_source_proxy_drama_slate_4C
    - 095660/2024: not_recomputed_this_turn_future_game_IP_relaunch_candidate
    - 225570/2024: not_recomputed_this_turn_future_game_launch_candidate
    - 181710/2024: not_recomputed_this_turn_future_game_platform_candidate
    - 207760/2024: not_recomputed_this_turn_future_webtoon_IP_candidate
    - 950170/2024: not_recomputed_this_turn_content_tourism_noise_check
    - 041510/2023: not_recomputed_this_turn_C32_tender_boundary
...
This file continues the local C27 sequence after `R8/C27 loop 143`; selected loop is therefore `144`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence. Direct fresh C27 content/IP/global-monetization candidate shards were not recomputed in this execution, so the file reuses prior C27 rows as holdout and reclassification evidence. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
```yaml
loop_144_note:
  independence_status: duplicate_holdout_with_source_proxy_reverify
  fresh_reprice_status: not_recomputed_this_execution
  reason: C27 remains under-covered, but this run reuses prior C27 rows and must not create a new weight delta.
```
...
```jsonl
{"row_type":"narrative_only_future_todo","selected_round":"R8","selected_loop":144,"large_sector_id":"L8_PLATFORM_CONTENT_SW_SECURITY","canonical_archetype_id":"C27_CONTENT_IP_GLOBAL_MONETIZATION","fine_archetype_id":"C27_NEW_GAME_CONTENT_IP_REPRICE_TODO_AFTER_CACHE_MISS","candidate_symbols":["036570","112040","078340","194480","095660","225570","181710","207760","950170"],"candidate_names":["엔씨소프트","위메이드","컴투스","데브시스터즈","네오위즈","넥슨게임즈","NHN","미스터블루","JTC-content_tourism_noise_check"],"why_not_trigger_row_now":"fresh stock-web symbol-year shards for new game/content IP candidates were not recomputed in this execution; no fresh independent 30D/90D/180D MFE/MAE computed here","calibration_usable":false,"score_alignment":"future run should compute stock-web windows before counting new C27 evidence; distinguish repeat IP cashflow from one-off launch, content hit, C26 platform ARPU, C28 software retention, and C32 tender/governance mechanics"}
```
...
```text
C27_CONTENT_IP_REPEAT_CASH_BRIDGE_GATE_V144_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L8_PLATFORM_CONTENT_SW_SECURITY | C27_CONTENT_IP_GLOBAL_MONETIZATION | CONTENT_IP_REPEAT_CASH_BRIDGE_HOLDOUT_V144 | 2 | 6 | 4 | 3 | 0 | 8 | 3 | 5 | 0 | 6 | false | false | 9 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C27 content/IP/global-monetization candidate shards were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_source_proxy_reverify_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R8","loop":"144","large_sector_id":"L8_PLATFORM_CONTENT_SW_SECURITY","canonical_archetype_id":"C27_CONTENT_IP_GLOBAL_MONETIZATION","new_independent_case_count":0,"reused_case_count":8,"new_symbol_count":0,"new_trigger_family_count":0,"source_proxy_only_count":5,"batch_reverification_required_count":5,"narrative_only_future_todo_count":1,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C27_content_IP_repeat_cash_bridge_gate","C32_governance_reclassification_guard"],"residual_error_types_found":["one_off_hit_without_library_repeat","IP_option_stack_without_listed_company_cash","kids_character_IP_high_MAE","game_launch_expectation_without_retention","artist_cycle_without_recurring_cash_bridge","drama_slate_without_retained_margin"],"loop_contribution_label":"duplicate_low_value_loop_with_source_proxy_reverify_todo","do_not_propose_new_weight_delta":true}
```
...
```text
Do not patch production scoring from this MD alone. Treat this R8/C27 loop 144 as holdout validation only. Batch it with C27 loops 107, 142 and 143, C26/C28 adjacent L8 rows, C32 governance/tender contamination rows, and R13 accounting-trust / Stage2 false-positive / high-MAE / 4B-4C guardrails. If exact same_entry_group_id rows already exist, dedupe them. Preserve the C27 content-IP repeat-cash bridge, one-off-hit cap, IP-option-stack 4B guard, artist-cycle hard-4C guard, and C32 tender reclassification guard. Do not create a new weight delta from this loop because no new independent case was added and five rows are source_proxy_only. Future research should directly reprice 엔씨소프트(036570), 위메이드(112040), 컴투스(078340), 데브시스터즈(194480), 네오위즈(095660), 넥슨게임즈(225570), NHN(181710), 미스터블루(207760), 디앤씨미디어(263720), SAMG엔터(419530), 하이브(352820), 에스엠(041510), YG PLUS(037270), 팬엔터테인먼트(068050) when stock-web shards are accessible.
```
