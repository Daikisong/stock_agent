...
fine_archetype_id: CHEMICAL_COMMODITY_SPREAD_MARGIN_FCF_HOLDOUT_V141_PETROCHEM_SYNTHETIC_RUBBER_POLYSILICON_EPOXY_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 011170/2024: reused_from_prior_local_C17_loop_140_NCC_hard_4C
    - 006650/2024: reused_from_prior_local_C17_loop_140_petrochem_hard_4C
    - 011780/2024: reused_from_prior_local_C15_C17_positive_row
    - 009830/2024: reused_from_prior_local_C15_C17_hard_4C_row
    - 010060/2024: reused_from_prior_local_C15_C17_4B_row
    - 298000/2024: reused_from_prior_local_C15_C17_guardrail
    - 002380/2024: reused_from_prior_local_C15_C17_positive_row
    - 011790/2024: reused_from_prior_local_C15_C16_C17_boundary_row
    - 161000/2024: reused_from_prior_local_C17_specialty_boundary_row
    - 004000/2024: not_recomputed_this_turn_future_chemical_margin_candidate
    - 014680/2024: not_recomputed_this_turn_future_specialty_chemical_candidate
    - 178920/2024: not_recomputed_this_turn_future_advanced_material_candidate
    - 005290/2024: not_recomputed_this_turn_future_semichemical_boundary
    - 036830/2024: not_recomputed_this_turn_future_material_holdco_boundary
    - 298050/2024: not_recomputed_this_turn_future_specialty_material_boundary
    - 051910/2024: not_recomputed_this_turn_future_largecap_chemical_boundary
...
This file continues the local C17 sequence after `R4/C17 loop 140`; selected loop is therefore `141`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C17 chemical/commodity spread candidate shards were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C17/C15/C16 rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
loop_141_note:
  ...
  reason: C17 remains under-covered, but this run reuses prior C17/C15/C16 boundary rows and must not create a new weight delta.
```
...
reason:
  ...
  - direct fresh C17 chemical/commodity spread candidate shards were not recomputed in this execution
...
```jsonl
{"row_type":"narrative_only_future_trigger_todo","selected_round":"R4","selected_loop":141,"large_sector_id":"L4_MATERIALS_SPREAD_RESOURCE","canonical_archetype_id":"C17_CHEMICAL_COMMODITY_MARGIN_SPREAD","fine_archetype_id":"C17_NEW_CHEMICAL_REPRICE_TODO_AFTER_CACHE_MISS","candidate_symbols":["051910","004000","014680","178920","096770"],"candidate_names":["LG화학","롯데정밀화학","한솔케미칼","PI첨단소재","SK이노베이션"],"why_not_trigger_row_now":"fresh stock-web symbol-year shards were not recomputed in this execution; no fresh 30D/90D/180D MFE/MAE computed here","calibration_usable":false,"score_alignment":"future run should compute stock-web windows before counting these as new C17 evidence; distinguish product-spread margin bridge from battery, governance, or generic commodity beta"}
```
...
```text
C17_CHEMICAL_FEEDSTOCK_TO_PRODUCT_SPREAD_MARGIN_GATE_V141_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L4_MATERIALS_SPREAD_RESOURCE | C17_CHEMICAL_COMMODITY_MARGIN_SPREAD | CHEMICAL_COMMODITY_SPREAD_MARGIN_FCF_HOLDOUT_V141 | 3 | 7 | 4 | 5 | 0 | 10 | 10 | 0 | 7 | false | false | 18 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C17 chemical/commodity spread candidate shards were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_cache_miss_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R4","loop":"141","large_sector_id":"L4_MATERIALS_SPREAD_RESOURCE","canonical_archetype_id":"C17_CHEMICAL_COMMODITY_MARGIN_SPREAD","new_independent_case_count":0,"reused_case_count":10,"new_symbol_count":0,"new_trigger_family_count":0,"narrative_only_future_todo_count":1,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C17_chemical_feedstock_to_product_spread_margin_gate","dominant_driver_reclassification_guard"],"residual_error_types_found":["petrochemical_bottom_call_without_spread_repair","leveraged_chemical_balance_sheet_failure","solar_polysilicon_event_contamination","battery_material_event_wrong_bridge","specialty_high_MFE_without_FCF_bridge"],"loop_contribution_label":"duplicate_low_value_loop_with_cache_miss_todo","do_not_propose_new_weight_delta":true}
```
...
```text
Do not patch production scoring from this MD alone. Treat this R4/C17 loop 141 as holdout validation only. Batch it with C17 loops 136~140, C15/C16 adjacent material/resource rows, and R13 accounting-trust / Stage2 false-positive / high-MAE / 4B-4C guardrails. If exact same_entry_group_id rows already exist, dedupe them. Preserve the C17 chemical feedstock-to-product spread/margin/FCF bridge gate and dominant-driver reclassification guard, but do not create a new weight delta from this loop because no new independent case was added. Future research should directly reprice LG화학(051910), 롯데정밀화학(004000), 한솔케미칼(014680), PI첨단소재(178920), SK이노베이션(096770) when stock-web shards are accessible.
```
