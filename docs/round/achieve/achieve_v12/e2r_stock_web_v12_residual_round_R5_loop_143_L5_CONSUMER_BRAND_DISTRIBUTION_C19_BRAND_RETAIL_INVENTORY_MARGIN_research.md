...
fine_archetype_id: INVENTORY_SELLTHROUGH_OPM_RECEIVABLES_HOLDOUT_V143_DEPARTMENTSTORE_HYPERMARKET_APPAREL_BEAUTY_CONVENIENCE_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 069960/2024: reused_from_prior_local_C19_positive_row
    - 139480/2024: reused_from_prior_local_C19_hard_4C_row
    ...
    - 004170/2024: source_proxy_only_reverify_required_from_loop_142
    - 023530/2024: source_proxy_only_reverify_required_from_loop_142
    - 282330/2024: source_proxy_only_reverify_required_from_loop_142
    - 007070/2024: source_proxy_only_reverify_required_from_loop_142
    - 008770/2024: source_proxy_only_reverify_required_from_loop_142
...
This file continues the local R5 consumer sequence after `R5/C19 loop 142`; selected loop is therefore `143`.

This is a **dedupe-aware holdout validation / mixed proxy-reverification** MD. Several rows reuse prior current-session stock-web-derived C18/C20/C19 rows. Several additional retail rows remain marked `source_proxy_only=true` because direct fresh C19 retail inventory/margin candidate shards were not recomputed in this execution. Those source-proxy rows carry complete MFE/MAE fields for schema compatibility, but must be batch-reverified before any scoring update. No production scoring is changed.
...
```text
C19_INVENTORY_SELLTHROUGH_OPM_RECEIVABLES_GATE_V143_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L5_CONSUMER_BRAND_DISTRIBUTION | C19_BRAND_RETAIL_INVENTORY_MARGIN | INVENTORY_SELLTHROUGH_OPM_RECEIVABLES_HOLDOUT_V143 | 2 | 7 | 2 | 5 | 0 | 9 | 9 | 0 | 7 | false | false | 9 |
