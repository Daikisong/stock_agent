...
fine_archetype_id: APPROVAL_TO_COMMERCIAL_ECONOMICS_HOLDOUT_V140_COMMERCIALIZED_DRUG_LAUNCH_LABEL_BINARY_FAILURE_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 326030/2024: reused_from_prior_local_C23_R13_guardrails
    - 006280/2024: reused_from_prior_local_C23_R13_guardrails
    - 170900/2024: reused_from_prior_local_C23_R13_guardrails
    - 000100/2024: reused_from_prior_local_C23_R13_guardrails
    - 195940/2024: reused_from_prior_local_C23_guardrails
    - 028300/2024: reused_from_prior_local_C23_R13_guardrails
    - 145020/2024: reused_from_prior_local_C23_R13_guardrails
    - 068270/2024: cache_miss_observed_this_turn
    - 196170/2024: cache_miss_observed_this_turn
    - 128940/2024: cache_miss_or_not_recomputed_this_turn
    - 141080/2024: cache_miss_or_not_recomputed_this_turn
    - 950160/2024: cache_miss_or_not_recomputed_this_turn
...
This file continues the local C23 sequence after `R7/C23 loop 139`; selected loop is therefore `140`.

This is a **dedupe-aware holdout validation / cache-miss TODO** MD. It does not claim fresh independent stock-web evidence because direct fresh C23 bio-regulatory candidate shards cache-missed or were not recomputed in this execution. The trigger rows below reuse current-session stock-web-derived C23/R13 rows that already contain complete 30D/90D/180D MFE and MAE from `Songdaiki/stock-web` tradable OHLC. Exact duplicate `same_entry_group_id` rows should be deduped during batch ingest. No production scoring is changed.
...
reason:
  ...
  - direct fresh C23 bio-regulatory candidate shards cache-missed or were not recomputed in this execution
...
```text
C23_APPROVAL_TO_COMMERCIAL_ECONOMICS_REQUIREMENT_V140_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L7_BIO_HEALTHCARE_MEDICAL | C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION | APPROVAL_TO_COMMERCIAL_ECONOMICS_HOLDOUT_V140 | 3 | 4 | 3 | 1 | 0 | 7 | 7 | 0 | 5 | false | false | 18 |
...
no_new_signal_reason: all rows reused holdout validation after direct fresh C23 bio-regulatory candidate shards cache-missed or were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_cache_miss_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R7","loop":"140","large_sector_id":"L7_BIO_HEALTHCARE_MEDICAL","canonical_archetype_id":"C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION","new_independent_case_count":0,"reused_case_count":7,"new_symbol_count":0,"new_trigger_family_count":0,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C23_approval_to_commercial_economics_gate","no_backfill_later_evidence"],"residual_error_types_found":["approval_label_without_listed_company_economics","FDA_approval_launch_bridge_green_too_early","binary_regulatory_failure","post_approval_peak_zone_enthusiasm","commercialization_buffer_requires_channel_OPM_refresh"],"loop_contribution_label":"duplicate_low_value_loop_with_cache_miss_todo","do_not_propose_new_weight_delta":true}
```
...
```text
Do not patch production scoring from this MD alone. Treat this R7/C23 loop 140 as holdout validation only. Batch it with C23 loops 99/100/103/137/138/139 and R13 accounting-trust / Stage2 false-positive / high-MAE / 4B-4C guardrails. If exact same_entry_group_id rows already exist, dedupe them. Preserve the C23 approval-to-commercial-economics gate, FDA approval-to-launch local 4B guard, approval-label false-positive block, binary regulatory failure hard 4C guard, and post-approval peak-zone 4B guard. Do not create a new weight delta from this loop because no new independent case was added. Future research should directly reprice 셀트리온(068270), 알테오젠(196170), 한미약품(128940), 리가켐바이오(141080), 코오롱티슈진(950160), 유한양행(000100), 보령(003850) and other approval-to-commercialization cases when stock-web shards are accessible.
```
