...
fine_archetype_id: POWER_GRID_DATACENTER_CAPEX_BACKLOG_CAPA_ASP_DELIVERY_VISIBILITY_HOLDOUT_V120_TRANSFORMER_SWITCHGEAR_CABLE_THEME_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 267260/2024: source_proxy_reverify_required_from_loop_119
    - 298040/2024: source_proxy_reverify_required_from_loop_119
    - 010120/2024: source_proxy_reverify_required_from_loop_119
    - 103590/2024: source_proxy_reverify_required_from_loop_119
    - 001440/2024: source_proxy_reverify_required_from_loop_119
    - 000500/2024: source_proxy_reverify_required_from_loop_119
    - 033100/2024: source_proxy_reverify_required_from_loop_119
    - 006260/2024: source_proxy_reverify_required_from_loop_119
    - 024840/2024: source_proxy_reverify_required_from_loop_119
    - 017510/2024: source_proxy_reverify_required_from_loop_119
    ...
    - 017040/2024: not_recomputed_this_turn_future_grid_switchgear_candidate
    - 237750/2024: not_recomputed_this_turn_future_grid_relay_candidate
    - 189860/2024: not_recomputed_this_turn_future_electrical_equipment_candidate
    - 119650/2024: not_recomputed_this_turn_future_grid_component_candidate
    - 298020/2024: not_recomputed_this_turn_future_datacenter_power_component_boundary
...
This file continues the local R1/C02 holdout after `R1/C02 loop 119`; selected loop is therefore `120`.

This is a **dedupe-aware source-proxy holdout / reprice TODO** MD. Direct fresh `Songdaiki/stock-web` symbol-year shard recomputation for the C02 power-grid/datacenter candidates was not completed in this execution. Therefore every trigger row below is explicitly marked:
...
loop_120_note:
  ...
  reason: C02 remains under-covered, but this run reuses prior C02 source-proxy rows and must not create a new weight delta.
```
...
row_provenance:
  ...
  reason:
    - C02 loop 120 intentionally reuses loop 119 source-proxy rows as a dedupe holdout
    - no direct stock-web OHLC recomputation was completed for these C02 rows in this execution
    - exact same_entry_group_id rows from loops 118~119 must be deduped during aggregate ingest
...
```text
C02_POWER_GRID_DATACENTER_CAPEX_TO_BACKLOG_MARGIN_CASH_GATE_V120_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L1_INDUSTRIALS_INFRA_DEFENSE_GRID | C02_POWER_GRID_DATACENTER_CAPEX | POWER_GRID_DATACENTER_CAPEX_HOLDOUT_V120 | 3 | 7 | 4 | 2 | 0 | 10 | 0 | 0 | 7 | false | false | 6 |
