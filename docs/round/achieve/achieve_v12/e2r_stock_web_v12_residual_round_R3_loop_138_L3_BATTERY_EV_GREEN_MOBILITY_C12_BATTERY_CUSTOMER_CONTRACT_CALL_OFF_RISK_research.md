...
fine_archetype_id: CUSTOMER_CONTRACT_TO_CALL_OFF_UTILIZATION_MARGIN_HOLDOUT_V138_CELL_SEPARATOR_FOIL_MATERIAL_PROXY_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 373220/2024: reused_from_prior_local_C12_C13_C31_positive_row_or_not_recomputed_this_turn
    - 361610/2024: reused_from_prior_local_C12_C13_C31_hard_4C_row
    - 011790/2024: reused_from_prior_local_C12_C13_C15_C16_boundary_row
    - 006110/2024: reused_from_prior_local_C12_C13_C15_C16_foil_row
    - 018470/2024: reused_from_prior_local_C12_C13_C15_C16_hard_4C_row
...
This file continues the local R3 battery sequence after `R3/C12 loop 137` and the latest `R3/C13 loop 137`; selected loop is therefore `138` for this C12 holdout.
...
```text
C12_CUSTOMER_CONTRACT_TO_CALLOFF_UTILIZATION_MARGIN_GATE_V138_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L3_BATTERY_EV_GREEN_MOBILITY | C12_BATTERY_CUSTOMER_CONTRACT_CALL_OFF_RISK | CUSTOMER_CONTRACT_TO_CALLOFF_HOLDOUT_V138 | 1 | 4 | 2 | 2 | 0 | 5 | 5 | 0 | 4 | false | false | 14 |
