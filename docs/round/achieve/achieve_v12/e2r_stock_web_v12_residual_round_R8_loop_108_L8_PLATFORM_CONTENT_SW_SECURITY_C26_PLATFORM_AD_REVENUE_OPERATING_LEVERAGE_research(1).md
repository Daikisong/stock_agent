...
fine_archetype_id: PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_HOLDOUT_V108_SEARCH_TALKBIZ_CREATOR_COMMERCE_ADTECH_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 035420/2024: source_proxy_reverify_required_from_loop_107
    - 035720/2024: source_proxy_reverify_required_from_loop_107
    - 067160/2024: source_proxy_reverify_required_from_loop_107
    - 042000/2024: source_proxy_reverify_required_from_loop_107
    - 089600/2024: source_proxy_reverify_required_from_loop_107
    - 216050/2024: source_proxy_reverify_required_from_loop_107
    - 237820/2024: source_proxy_reverify_required_from_loop_107
    - 214270/2024: source_proxy_reverify_required_from_loop_107
    - 060250/2024: source_proxy_reverify_required_from_loop_107
    - 030000/2024: source_proxy_reverify_required_from_loop_107
    ...
    - 273060/2024: not_recomputed_this_turn_future_adtech_performance_candidate
    - 236810/2024: not_recomputed_this_turn_future_reward_ad_platform_candidate
    - 363260/2024: not_recomputed_this_turn_future_mobile_adtech_candidate
    - 041020/2024: not_recomputed_this_turn_C28_AI_office_boundary
    - 112040/2024: not_recomputed_this_turn_C27_game_platform_boundary
...
This file continues the local R8/C26 sequence after `R8/C26 loop 107`; selected loop is therefore `108`.

This is a **source-proxy-only holdout / reprice TODO** MD. Direct fresh `Songdaiki/stock-web` symbol-year shard recomputation for the C26 platform/ad-revenue candidates was not completed in this execution. The file reuses prior C26 source-proxy rows as dedupe holdout evidence and must not create a new production weight delta. Therefore every trigger row below is explicitly marked:
...
```yaml
loop_108_note:
  independence_status: duplicate_source_proxy_holdout_only
  fresh_reprice_status: not_recomputed_this_execution
  reason: C26 remains one of the lowest-row Priority 0 archetypes, but this run reuses prior C26 source-proxy rows and must not create a new weight delta.
```
...
row_provenance:
  ...
  reason:
    - C26 loop 108 intentionally reuses loop 107 source-proxy rows as a dedupe holdout
    - no direct stock-web OHLC recomputation was completed for these C26 rows in this execution
    - exact same_entry_group_id rows from loops 106~107 must be deduped during aggregate ingest
...
```jsonl
{"row_type":"narrative_only_future_todo","selected_round":"R8","selected_loop":108,"large_sector_id":"L8_PLATFORM_CONTENT_SW_SECURITY","canonical_archetype_id":"C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE","fine_archetype_id":"C26_NEW_PLATFORM_AD_REVENUE_REPRICE_TODO_AFTER_CACHE_MISS","candidate_symbols":["035420","035720","067160","042000","089600","216050","237820","214270","060250","030000","035600","064260","068790"],"candidate_names":["NAVER","카카오","SOOP","카페24","나스미디어","인크로스","플레이디","FSN","NHN KCP","제일기획","KG이니시스","다날","DMS-platform_noise_check"],"why_not_trigger_row_now":"fresh stock-web symbol-year shards were not recomputed in this execution; no fresh independent 30D/90D/180D MFE/MAE computed here","calibration_usable":false,"score_alignment":"future run should compute stock-web windows before counting new C26 evidence; distinguish platform ad operating leverage from C27 content/IP, C28 software retention, payment processing volume and agency macro recovery"}
```
...
```text
C26_PLATFORM_AD_REVENUE_TO_OPERATING_LEVERAGE_GATE_V108_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L8_PLATFORM_CONTENT_SW_SECURITY | C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE | PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_HOLDOUT_V108 | 2 | 8 | 1 | 4 | 0 | 10 | 0 | 0 | 8 | false | false | 27 |
...
no_new_signal_reason: all rows are source_proxy_only and reused from loop 107 because direct fresh C26 stock-web candidate shards were not recomputed
loop_contribution_label: duplicate_low_value_loop_with_source_proxy_reverify_todo
do_not_propose_new_weight_delta: true
```

```jsonl
{"row_type":"residual_contribution","round":"R8","loop":"108","large_sector_id":"L8_PLATFORM_CONTENT_SW_SECURITY","canonical_archetype_id":"C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE","new_independent_case_count":0,"reused_case_count":10,"new_symbol_count":0,"new_trigger_family_count":0,"source_proxy_only_count":10,"batch_reverification_required_count":10,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c","C26_platform_ad_revenue_operating_leverage_gate","C27_C28_payment_agency_reclassification_guard"],"residual_error_types_found":["ad_recovery_label_without_OPM_bridge","commerce_platform_theme_without_take_rate_proof","adtech_agency_label_without_platform_inventory","payment_volume_misfile","source_proxy_price_reverification_gap"],"loop_contribution_label":"duplicate_low_value_loop_with_source_proxy_reverify_todo","do_not_propose_new_weight_delta":true}
```
