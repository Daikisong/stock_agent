...
fine_archetype_id: POWER_GRID_DATACENTER_CAPEX_BACKLOG_CAPA_ASP_DELIVERY_VISIBILITY_HOLDOUT_V118_TRANSFORMER_SWITCHGEAR_CABLE_THEME_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    - 267260/2024: cache_miss_observed_this_turn
    - 298040/2024: cache_miss_observed_this_turn
    - 010120/2024: cache_miss_observed_this_turn
    - 103590/2024: cache_miss_observed_this_turn
    - 001440/2024: cache_miss_or_not_recomputed_this_turn
    - 000500/2024: cache_miss_or_not_recomputed_this_turn
    - 033100/2024: cache_miss_or_not_recomputed_this_turn
    - 006260/2024: cache_miss_or_not_recomputed_this_turn
    - 024840/2024: cache_miss_or_not_recomputed_this_turn
    - 017510/2024: cache_miss_or_not_recomputed_this_turn
...
This file follows the latest R1 holdout files and uses `selected_loop=118`, after the local R1 sequence reached C04 loop 117.

This is a **dedupe-aware source-proxy holdout / reprice TODO** MD. Direct fresh `Songdaiki/stock-web` symbol-year shard access for the C02 candidates cache-missed or was unavailable in this execution. Therefore every trigger row below is explicitly marked:
...
row_provenance:
  ...
  reason:
    - web raw access to C02 stock-web symbol-year shards cache-missed or returned internal error
    - no direct stock-web OHLC recomputation was completed for these C02 rows
...
```jsonl
{"row_type":"narrative_only_future_todo","selected_round":"R1","selected_loop":118,"large_sector_id":"L1_INDUSTRIALS_INFRA_DEFENSE_GRID","canonical_archetype_id":"C02_POWER_GRID_DATACENTER_CAPEX","fine_archetype_id":"C02_NEW_POWER_GRID_DATACENTER_REPRICE_TODO_AFTER_CACHE_MISS","candidate_symbols":["267260","298040","010120","103590","001440","000500","033100","006260","024840","017510","006340","014910","080010"],"candidate_names":["HD현대일렉트릭","효성중공업","LS ELECTRIC","일진전기","대한전선","가온전선","제룡전기","LS","KBI메탈","세명전기","대원전선","성문전자","이상네트웍스-grid_noise_check"],"why_not_trigger_row_now":"fresh stock-web symbol-year shards were unavailable or cache-missed in this execution; no fresh independent 30D/90D/180D MFE/MAE computed here","calibration_usable":false,"score_alignment":"future run should compute stock-web windows before counting new C02 evidence; distinguish transformer/switchgear backlog and delivery-margin bridge from cable/copper theme, C15/C16 material beta, holding-company discount and AI-data-center label"}
```
...
```text
C02_POWER_GRID_DATACENTER_CAPEX_TO_BACKLOG_MARGIN_CASH_GATE_V118_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L1_INDUSTRIALS_INFRA_DEFENSE_GRID | C02_POWER_GRID_DATACENTER_CAPEX | POWER_GRID_DATACENTER_CAPEX_HOLDOUT_V118 | 3 | 7 | 4 | 2 | 0 | 10 | 0 | 0 | 7 | false | false | 6 |
