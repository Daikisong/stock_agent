...
fine_archetype_id: FORMAL_MINORITY_CASH_EXIT_GATE_HOLDOUT_V107_TENDER_VS_VALUEUP_CAPITAL_RETURN_CONTROL_SALE
selection_basis:
...
This file continues the local C32 sequence after `R12/C32 loop 106`; selected loop is therefore `107`.
...
Those signals may be real, but they are not C32 unless minority holders can actually tender, appraise, squeeze out, or exit at a defined cash price.

The C32 gate is therefore:
...
reused_price_rows_from_current_session:
  - R12/C32 loops 102~106
  - R6/C21 loop 112
  - R6/C22 loop 111
  - R11/C31 loops 103~107
...
A control sale is not necessarily a minority exit. Activism proposal is not necessarily execution.
...
```text
C32_FORMAL_MINORITY_CASH_EXIT_REQUIREMENT_V107_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L10_POLICY_EVENT_CROSS_REDTEAM_MISC | C32_GOVERNANCE_CONTROL_PREMIUM_TENDER_CAP | FORMAL_MINORITY_CASH_EXIT_GATE_HOLDOUT_V107 | 2 | 8 | 3 | 2 | 0 | 10 | 10 | 0 | 7 | false | false | 27 |
...
```jsonl
{"row_type":"residual_contribution","round":"R12","loop":"107","large_sector_id":"L10_POLICY_EVENT_CROSS_REDTEAM_MISC","canonical_archetype_id":"C32_GOVERNANCE_CONTROL_PREMIUM_TENDER_CAP","new_independent_case_count":0,"reused_case_count":10,"new_symbol_count":0,"new_trigger_family_count":0,"tested_existing_calibrated_axes":["stage2_required_bridge","local_4b_watch_guard","hard_4c_thesis_break_routes_to_4c"],"residual_error_types_found":["capital_return_wrong_archetype_if_left_in_C32","control_sale_without_minority_exit_false_positive","low_PBR_label_without_tender_execution"],"loop_contribution_label":"duplicate_low_value_loop","do_not_propose_new_weight_delta":true}
```
