...
fine_archetype_id: GOVERNANCE_TENDER_CONTROL_PREMIUM_TO_CASH_EXIT_CAP_HOLDOUT_V109_SM_KOREAZINC_VALUEUP_INSURANCE_RECLASSIFICATION_SPLIT
selection_basis:
...
web_raw_fetch_status_this_turn:
  ...
  direct_stock_web_shards:
    ...
    - 041510/2023: source_proxy_reverify_required
    ...
    - additional_true_tender_candidates: not_recomputed_this_turn
...
```text
C32_GOVERNANCE_TENDER_CONTROL_PREMIUM_TO_CASH_EXIT_CAP_GATE_V109_HELD_OUT
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|---:|
| L10_POLICY_EVENT_CROSS_REDTEAM_MISC | C32_GOVERNANCE_CONTROL_PREMIUM_TENDER_CAP | GOVERNANCE_TENDER_CONTROL_PREMIUM_HOLDOUT_V109 | 2 | 6 | 3 | 1 | 0 | 8 | 7 | 0 | 6 | false | false | 27 |
