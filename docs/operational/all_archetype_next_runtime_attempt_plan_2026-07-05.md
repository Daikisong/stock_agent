...
- attempt_type_counts: `{"ACCEPTED_CLAIM_TO_FULL_THESIS_CLOSURE": 2, "ARCHETYPE_TARGET_MATERIALIZATION": 3, "BLOCKED_CANDIDATE_GAP_CLOSURE": 4, "PROMOTED_SCORE_PATH_GAP_CLOSURE": 7, "SOURCE_EXECUTION_REPAIR": 20}`
...
| C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY | 10 | PROMOTED_SCORE_PATH_GAP_CLOSURE | SYMBOL_SPECIFIC | named_customer_quality, qualification_confirmed, repeat_order_confirmed | NOT_PROVEN_SCORE_PATH_ONLY | - | - |
...
| C28_SOFTWARE_SECURITY_CONTRACT_RETENTION | 10 | PROMOTED_SCORE_PATH_GAP_CLOSURE | SYMBOL_SPECIFIC | arr_growth_visible, nrr, retention_or_renewal | NOT_PROVEN_SCORE_PATH_ONLY | - | - |
...
| C18_CONSUMER_EXPORT_CHANNEL_REORDER | 20 | BLOCKED_CANDIDATE_GAP_CLOSURE | SYMBOL_SPECIFIC | export_growth_pct, sell_through_confirmed, repeat_order_confirmed | NOT_PROVEN_BLOCKED_BY_MATERIAL_GAP | - | - |
...
| C11_BATTERY_ORDERBOOK_RERATING | 40 | ACCEPTED_CLAIM_TO_FULL_THESIS_CLOSURE | SYMBOL_SPECIFIC | order_backlog_to_sales, customer_contract, call_off_risk | NOT_PROVEN_ACCEPTED_CLAIM_NOT_CLOSED | - | - |
| C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE | 40 | ACCEPTED_CLAIM_TO_FULL_THESIS_CLOSURE | SYMBOL_SPECIFIC | volume_growth_visible, mix_improvement, operating_leverage_visible | NOT_PROVEN_ACCEPTED_CLAIM_NOT_CLOSED | - | - |
