...
- attempt_type_counts: `{"ARCHETYPE_TARGET_MATERIALIZATION": 3, "BLOCKED_CANDIDATE_GAP_CLOSURE": 1, "PLANNER_TO_SOURCE_TASK_MATERIALIZATION": 1, "PROMOTED_SCORE_PATH_GAP_CLOSURE": 4, "SOURCE_EXECUTION_REPAIR": 27}`
...
| C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY | 30 | SOURCE_EXECUTION_REPAIR | SYMBOL_SPECIFIC | named_customer_quality, qualification_confirmed, repeat_order_confirmed | NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM |
...
| C10_MEMORY_RECOVERY_EQUIPMENT_CYCLE | 30 | SOURCE_EXECUTION_REPAIR | SYMBOL_SPECIFIC | memory_price_increase_mentioned, supply_discipline_mentioned, cycle_demand_visibility | NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM |
...
| C15_MATERIAL_SPREAD_SUPERCYCLE | 30 | SOURCE_EXECUTION_REPAIR | SYMBOL_SPECIFIC | spread_expansion, utilization_rate, inventory_cycle | NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM |
...
| C17_CHEMICAL_COMMODITY_MARGIN_SPREAD | 30 | SOURCE_EXECUTION_REPAIR | SYMBOL_SPECIFIC | spread_expansion, raw_material_cost_risk, utilization_rate | NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM |
...
| C24_BIO_TRIAL_DATA_EVENT_RISK | 30 | SOURCE_EXECUTION_REPAIR | SYMBOL_SPECIFIC | trial_quality_visible, binary_event_unresolved, approval_not_confirmed | NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM |
...
| R13_CROSS_ARCHETYPE_HIGH_MAE_GUARDRAIL | 50 | PLANNER_TO_SOURCE_TASK_MATERIALIZATION | SYMBOL_SPECIFIC | high_mae_history, valuation_overheat, liquidity_or_microcap_risk | NOT_PROVEN_PLANNER_ONLY |
