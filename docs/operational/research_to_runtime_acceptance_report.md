...
- full-thesis candidate attempts by archetype: `{"C06_HBM_MEMORY_CUSTOMER_CAPACITY": 1}`
- promoted full-thesis rows by archetype: `{"C06_HBM_MEMORY_CUSTOMER_CAPACITY": 1}`
- required positive missing rate: `1.0`
- green gap rate: `1.0`
- distinct archetype count: `1`
- C05 share: `0.0`
- planner C05 top1 share: `0.015625`
...
- runtime proof counts: `{"NOT_PROVEN_BLOCKED_BY_MATERIAL_GAP": 4, "NOT_PROVEN_PLANNER_ONLY": 1, "NOT_PROVEN_REPLAY_ONLY": 2, "NOT_PROVEN_SCORE_PATH_ONLY": 1, "NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM": 25, "NOT_PROVEN_TARGET_MATERIALIZATION_REQUIRED": 3}`
- next runtime attempt plan rows: `36`
- next runtime source task shells: `111`
- next runtime seed events: `111`
- next runtime attempt types: `{"ARCHETYPE_TARGET_MATERIALIZATION": 3, "BLOCKED_CANDIDATE_GAP_CLOSURE": 4, "PLANNER_TO_SOURCE_TASK_MATERIALIZATION": 1, "PROMOTED_SCORE_PATH_GAP_CLOSURE": 1, "REPLAY_TO_PRODUCTION_RUNTIME_ATTEMPT": 2, "SOURCE_EXECUTION_REPAIR": 25}`
