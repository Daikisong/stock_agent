...
- full-thesis candidate attempts by archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 2, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 3, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 3, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 3, "C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY": 2, "C10_MEMORY_RECOVERY_EQUIPMENT_CYCLE": 1, "C15_MATERIAL_SPREAD_SUPERCYCLE": 1, "C17_CHEMICAL_COMMODITY_MARGIN_SPREAD": 1, "C31_POLICY_SUBSIDY_LEGISLATION_EVENT": 3}`
- promoted full-thesis rows by archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 1, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 1, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 1, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 1, "C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY": 1, "C15_MATERIAL_SPREAD_SUPERCYCLE": 1}`
- required positive missing rate: `1.0`
- green gap rate: `1.0`
- distinct archetype count: `6`
- C05 share: `0.166667`
- planner C05 top1 share: `0.028571`
- research memory follow-up task count: `35`
- research memory follow-up by archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 5, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 2, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 3, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 5, "C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY": 4, "C10_MEMORY_RECOVERY_EQUIPMENT_CYCLE": 10, "C17_CHEMICAL_COMMODITY_MARGIN_SPREAD": 3, "C31_POLICY_SUBSIDY_LEGISLATION_EVENT": 3}`
