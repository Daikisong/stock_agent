...
- research case count: `11395`
- source quality breakdown: `{"A1_URL_PENDING": 19, "A2_URL_BACKED": 3150, "EVIDENCE_URL_PENDING": 185, "PRICE_PATH_ONLY": 2204, "SHADOW_ONLY": 523, "SOURCE_PROXY_ONLY": 5314}`
...
- full-thesis candidate attempts by archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 2, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 3, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 3, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 3, "C15_MATERIAL_SPREAD_SUPERCYCLE": 1, "C17_CHEMICAL_COMMODITY_MARGIN_SPREAD": 1, "C24_BIO_TRIAL_DATA_EVENT_RISK": 1, "C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE": 2, "C31_POLICY_SUBSIDY_LEGISLATION_EVENT": 3}`
...
- C05 share: `0.166667`
- planner C05 top1 share: `0.027778`
- research memory follow-up task count: `24`
- research memory follow-up by archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 5, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 2, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 3, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 5, "C15_MATERIAL_SPREAD_SUPERCYCLE": 2, "C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE": 4, "C31_POLICY_SUBSIDY_LEGISLATION_EVENT": 3}`
...
- runtime proof counts: `{"NOT_PROVEN_BLOCKED_BY_MATERIAL_GAP": 3, "NOT_PROVEN_SCORE_PATH_ONLY": 5, "NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM": 24, "NOT_PROVEN_TARGET_MATERIALIZATION_REQUIRED": 3, "RUNTIME_PARITY_PROVEN": 1}`
- next runtime attempt plan rows: `35`
- next runtime source task shells: `105`
- next runtime seed events: `105`
- next runtime attempt types: `{"ARCHETYPE_TARGET_MATERIALIZATION": 3, "BLOCKED_CANDIDATE_GAP_CLOSURE": 3, "PROMOTED_SCORE_PATH_GAP_CLOSURE": 5, "SOURCE_EXECUTION_REPAIR": 24}`
