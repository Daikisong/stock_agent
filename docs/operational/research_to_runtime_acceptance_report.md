...
쉬운 예: 이제 C05 한 과목만 채점된 상태는 벗어났고 1개 아키타입의 score path는 닫혔다. 하지만 promoted row에 필수 증빙칸과 Green 증빙칸이 비어 있으면 최종 합격증은 아직 아니다.
...
- full-thesis candidate attempts by archetype: `{"C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 2, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 2, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 1, "C17_CHEMICAL_COMMODITY_MARGIN_SPREAD": 1}`
- promoted full-thesis rows by archetype: `{"C17_CHEMICAL_COMMODITY_MARGIN_SPREAD": 1}`
- required positive missing rate: `1.0`
- green gap rate: `1.0`
- distinct archetype count: `1`
- C05 share: `0.0`
- planner C05 top1 share: `0.027027`
- research memory follow-up task count: `11`
- research memory follow-up by archetype: `{"C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 4, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 2, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 5}`
...
- runtime proof counts: `{"NOT_PROVEN_ACCEPTED_CLAIM_NOT_CLOSED": 6, "NOT_PROVEN_BLOCKED_BY_MATERIAL_GAP": 3, "NOT_PROVEN_SCORE_PATH_ONLY": 1, "NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM": 23, "NOT_PROVEN_TARGET_MATERIALIZATION_REQUIRED": 3}`
- next runtime attempt plan rows: `36`
- next runtime source task shells: `111`
- next runtime seed events: `111`
- next runtime attempt types: `{"ACCEPTED_CLAIM_TO_FULL_THESIS_CLOSURE": 6, "ARCHETYPE_TARGET_MATERIALIZATION": 3, "BLOCKED_CANDIDATE_GAP_CLOSURE": 3, "PROMOTED_SCORE_PATH_GAP_CLOSURE": 1, "SOURCE_EXECUTION_REPAIR": 23}`
...
C06 remaining production blockers: `FULL_THESIS_BLOCKED_REQUIRED_OR_GREEN_GAP, MANDATORY_ARCHETYPE_NO_PRODUCTION_FULL_THESIS_ROW, SCORE_INELIGIBLE_CLAIM, SOURCE_PENDING_REQUIRED_OR_GREEN_PRIMITIVES`
