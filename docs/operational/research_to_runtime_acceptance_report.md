...
- research case count: `11400`
- source quality breakdown: `{"A1_URL_PENDING": 19, "A2_URL_BACKED": 3150, "EVIDENCE_URL_PENDING": 185, "PRICE_PATH_ONLY": 2204, "SHADOW_ONLY": 528, "SOURCE_PROXY_ONLY": 5314}`
...
- full-thesis candidate attempts by archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 3, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 2, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 3, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 3, "C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY": 1, "C10_MEMORY_RECOVERY_EQUIPMENT_CYCLE": 2, "C15_MATERIAL_SPREAD_SUPERCYCLE": 1, "C17_CHEMICAL_COMMODITY_MARGIN_SPREAD": 2, "C28_SOFTWARE_SECURITY_CONTRACT_RETENTION": 1, "C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE": 1, "C31_POLICY_SUBSIDY_LEGISLATION_EVENT": 3}`
...
- research memory follow-up task count: `43`
- research memory follow-up by archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 5, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 2, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 3, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 5, "C10_MEMORY_RECOVERY_EQUIPMENT_CYCLE": 10, "C15_MATERIAL_SPREAD_SUPERCYCLE": 4, "C17_CHEMICAL_COMMODITY_MARGIN_SPREAD": 3, "C28_SOFTWARE_SECURITY_CONTRACT_RETENTION": 4, "C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE": 4, "C31_POLICY_SUBSIDY_LEGISLATION_EVENT": 3}`
...
- runtime proof counts: `{"NOT_PROVEN_BLOCKED_BY_MATERIAL_GAP": 5, "NOT_PROVEN_SCORE_PATH_ONLY": 6, "NOT_PROVEN_SOURCE_EXECUTED_NO_ACCEPTED_CLAIM": 22, "NOT_PROVEN_TARGET_MATERIALIZATION_REQUIRED": 3}`
- next runtime attempt plan rows: `36`
- next runtime source task shells: `111`
- next runtime seed events: `111`
- next runtime attempt types: `{"ARCHETYPE_TARGET_MATERIALIZATION": 3, "BLOCKED_CANDIDATE_GAP_CLOSURE": 5, "PROMOTED_SCORE_PATH_GAP_CLOSURE": 6, "SOURCE_EXECUTION_REPAIR": 22}`
