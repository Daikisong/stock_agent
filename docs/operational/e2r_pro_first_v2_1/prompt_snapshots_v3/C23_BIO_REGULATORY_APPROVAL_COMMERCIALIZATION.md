...
- job_id: `PROMPT-V3-SNAPSHOT-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION`
- run_id: `PROMPT-V3-SNAPSHOT-RUN-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: 규제 승인·label·reimbursement·partner economics가 실제 launch·royalty·매출로 전환되는 메커니즘
- required_bridge_axes: bio_commercialization, guard_risk
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"FDA/EMA/MFDS 등 규제기관·payer/reimbursement·issuer/partner 계약·제조/launch·실적/royalty·특허","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다."]
- score_authority: `false`
- stage_authority: `false`

Mandatory question families:

1. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q01` — 승인 기관·국가·indication·label·조건부/정식 승인 상태는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, LIFECYCLE_SUPERSESSION
   - required_primitives: regulatory_approval_confirmed
   ...
   - false_positive_guards: ["신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다."]
2. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q02` — launch timeline·제조/공급·market access·reimbursement가 확인되는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, LIFECYCLE_SUPERSESSION
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다."]
3. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q03` — partner 계약·upfront/milestone/royalty·territory·cost share가 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, LIFECYCLE_SUPERSESSION
   - required_primitives: approval_to_revenue_bridge, royalty_route, partner_economics_visible
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다."]
4. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q04` — 환자/처방/수술 volume·초기 sales·repeat/consumable route는 무엇인가
   - mandatory_for_full_thesis: `true`
   ...
   - false_positive_guards: ["신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다."]
5. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q05` — 특허·경쟁약·safety·label restriction·post-marketing obligation counter는 무엇인가
   - mandatory_for_full_thesis: `true`
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다."]
6. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q06` — cash runway·상업화 비용·FCF/희석·revision·valuation은 무엇인가
   - mandatory_for_full_thesis: `true`
