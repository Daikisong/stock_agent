...
- job_id: `PROMPT-V3-SNAPSHOT-C24_BIO_TRIAL_DATA_EVENT_RISK`
- run_id: `PROMPT-V3-SNAPSHOT-RUN-C24_BIO_TRIAL_DATA_EVENT_RISK`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C24_BIO_TRIAL_DATA_EVENT_RISK]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C24_BIO_TRIAL_DATA_EVENT_RISK]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: 임상 데이터의 endpoint quality·안전성·규제경로·partner·runway가 binary event 위험을 넘어 상업화 옵션으로 이어지는 메커니즘
- required_bridge_axes: bio_commercialization, guard_risk
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"clinical trial registry·학회/논문·규제기관·issuer filing/IR·partner 공식자료·funding/cash·safety update","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
- score_authority: `false`
- stage_authority: `false`

Mandatory question families:

1. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q01` — trial design·population·endpoint·control·통계계획·sample size가 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: trial_quality_visible
   - required_source_roles: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING
   - preferred_source_families: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING
   ...
   - false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
2. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q02` — 효능 magnitude·p-value/CI·data maturity·subgroup·durability가 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
3. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q03` — safety·중단·사망·adverse event와 benefit-risk가 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK
   - required_primitives: safety_signal
   - required_source_roles: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING
   - preferred_source_families: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING
   - affected_component_ids: earnings_visibility, information_confidence
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
   ...
   - false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
4. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q04` — 규제기관 피드백·다음 단계·approval path·일정이 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, LIFECYCLE_SUPERSESSION
   - required_primitives: approval_not_confirmed
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
5. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q05` — partner/platform validation·경제조건·manufacturing/commercial route가 있는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: DIRECT_PREDICATE
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
6. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q06` — cash runway·추가 임상비·희석·funding risk는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK, FINANCIAL_CASH_CONVERSION
   - required_primitives: cash_runway_risk
   - required_source_roles: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING, ISSUER_EARNINGS, OFFICIAL_FILING
   - preferred_source_families: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING, ISSUER_EARNINGS, OFFICIAL_FILING
   - affected_component_ids: earnings_visibility, information_confidence
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
7. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q07` — binary event unresolved·실패·CRL·endpoint miss가 현재 OPEN/RESOLVED인지 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK, LIFECYCLE_SUPERSESSION
   - required_primitives: binary_event_unresolved
   - required_source_roles: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING
   - preferred_source_families: TRIAL_REGISTRY, REGULATOR_OFFICIAL, ISSUER_FILING
   - affected_component_ids: earnings_visibility, information_confidence
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["headline response·poster·price spike를 endpoint quality·approval·commercialization으로 확대하지 않는다."]
8. `C24_BIO_TRIAL_DATA_EVENT_RISK_Q08` — price reaction은 비점수이며 non-price bridge가 충분한가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: DIRECT_PREDICATE
   - required_source_roles: ISSUER_OFFICIAL, OFFICIAL_FILING
