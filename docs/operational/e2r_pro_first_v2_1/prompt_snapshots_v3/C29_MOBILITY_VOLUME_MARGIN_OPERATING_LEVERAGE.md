...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: 모빌리티 unit volume·mix·가격·utilization이 고정비 흡수와 FCF로 이어지는 메커니즘
- required_bridge_axes: margin, backlog, contract, customer, guard_risk
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"issuer/OEM unit·공장·계약·실적/quality·원재료/FCF·revision","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["산업 판매량·출시 뉴스만으로 대상 회사 volume/margin을 만들지 않는다."]
- score_authority: `false`
- stage_authority: `false`
...
1. `C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE_Q01` — 차종/제품/지역별 unit volume·shipment·backlog/customer schedule은 무엇인가
   ...
   - required_primitives: volume_growth_visible, operating_leverage_visible
...
2. `C29_MOBILITY_VOLUME_MARGIN_OPERATING_LEVERAGE_Q02` — ASP·mix·incentive·pricing power와 warranty/quality 비용은 무엇인가
   ...
   - required_primitives: mix_improvement, pricing_power_confirmed, fcf_quality_score
