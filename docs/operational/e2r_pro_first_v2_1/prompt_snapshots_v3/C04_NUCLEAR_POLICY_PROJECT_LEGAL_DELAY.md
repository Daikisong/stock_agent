...
- job_id: `PROMPT-V3-SNAPSHOT-C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY`
- run_id: `PROMPT-V3-SNAPSHOT-RUN-C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: 정책·규제·프로젝트 award가 허가·소송·공정·원가를 통과해 대상 회사 현금으로 이어지는 메커니즘
- required_bridge_axes: guard_risk, valuation_repricing, contract
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"법령/규제기관·법원/허가기관·발주처·issuer 공시/IR·consortium partner·프로젝트 금융·실적/FCF","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
- score_authority: `false`
- stage_authority: `false`

Mandatory question families:

1. `C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY_Q01` — 정책 발표·법안·규제 승인·실제 프로젝트 award를 분리했는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: policy_or_regulatory_confirmed, project_award_confirmed
   ...
   - false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
2. `C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY_Q02` — 대상 회사의 consortium 지분·공급 범위·계약 당사자·직접 cash route는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   - required_primitives: direct_company_cash_route
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
3. `C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY_Q03` — permit·환경심사·법원·행정소송·지역 승인 상태와 다음 milestone은 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK, LIFECYCLE_SUPERSESSION
   - required_primitives: permit_or_legal_delay
   - required_source_roles: REGULATOR_OFFICIAL, ISSUER_OFFICIAL
   - preferred_source_families: REGULATOR_OFFICIAL, ISSUER_OFFICIAL
   ...
   - false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
4. `C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY_Q04` — 공정·납품·수금 일정과 cost overrun·지연·보증 부담은 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK, LIFECYCLE_SUPERSESSION, FINANCIAL_CASH_CONVERSION
   - required_primitives: cost_overrun
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
5. `C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY_Q05` — 정부/프로젝트 금융·선수금·CAPEX·운전자본·FCF 경로는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
6. `C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY_Q06` — 취소·정책 reversal·사업자 변경·원가 초과·소송 장기화 counter는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK, LIFECYCLE_SUPERSESSION
   - required_primitives: DIRECT_PREDICATE
   - required_source_roles: REGULATOR_OFFICIAL, ISSUER_OFFICIAL
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
7. `C04_NUCLEAR_POLICY_PROJECT_LEGAL_DELAY_Q07` — revision·valuation이 정책 headline과 실제 cash route를 구분하는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION, EXPECTATION_VALUATION
   - required_primitives: DIRECT_PREDICATE
   - required_source_roles: REGULATOR_OFFICIAL, ISSUER_OFFICIAL, ISSUER_EARNINGS, OFFICIAL_FILING, CURRENT_MARKET_DATA, LAWFUL_REVISION_DATA
   - preferred_source_families: REGULATOR_OFFICIAL, ISSUER_OFFICIAL, ISSUER_EARNINGS, OFFICIAL_FILING, CURRENT_MARKET_DATA, LAWFUL_REVISION_DATA
   - affected_component_ids: eps_fcf_explosion, capital_allocation, information_confidence
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 수혜·원전 테마·협력 발표를 대상 회사의 award/현금으로 자동 연결하지 않는다."]
