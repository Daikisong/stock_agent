...
- job_id: `PROMPT-V3-SNAPSHOT-C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION`
- run_id: `PROMPT-V3-SNAPSHOT-RUN-C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: 뷰티/식품의 해외 유통 scale·고객 다변화·repeat order·고마진 mix가 cash로 전환되는 메커니즘
- required_bridge_axes: consumer_sell_through, margin, customer
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"issuer 지역/SKU/채널 실적·유통 플랫폼/파트너·통관/규제·재고/FCF·revision","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["해외 입점·viral headline을 반복 매출과 고마진 mix로 자동 확장하지 않는다."]
- score_authority: `false`
- stage_authority: `false`

Mandatory question families:

1. `C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION_Q01` — 국가·플랫폼·distributor·SKU별 수출/매출 growth가 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: export_growth_pct, platform_distribution_scale
   ...
   - false_positive_guards: ["해외 입점·viral headline을 반복 매출과 고마진 mix로 자동 확장하지 않는다."]
2. `C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION_Q02` — 초도 입점과 반복 주문·retention·sell-through를 분리했는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["해외 입점·viral headline을 반복 매출과 고마진 mix로 자동 확장하지 않는다."]
3. `C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION_Q03` — 고객/지역/브랜드 concentration과 diversification이 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: brand_customer_diversification
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["해외 입점·viral headline을 반복 매출과 고마진 mix로 자동 확장하지 않는다."]
4. `C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION_Q04` — 제품 mix·ASP·OEM/ODM·marketing·물류가 margin에 미치는 영향은 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   - required_primitives: high_margin_mix_improvement
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["해외 입점·viral headline을 반복 매출과 고마진 mix로 자동 확장하지 않는다."]
5. `C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION_Q05` — 규제 승인·통관·재고·반품·현지 파트너 risk는 무엇인가
   - mandatory_for_full_thesis: `true`
   ...
   - false_positive_guards: ["해외 입점·viral headline을 반복 매출과 고마진 mix로 자동 확장하지 않는다."]
6. `C20_BEAUTY_FOOD_GLOBAL_DISTRIBUTION_Q06` — 운전자본·CAPEX·FCF·revision·valuation은 무엇인가
   - mandatory_for_full_thesis: `true`
