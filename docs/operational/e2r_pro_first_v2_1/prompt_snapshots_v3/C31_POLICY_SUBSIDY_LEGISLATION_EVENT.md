...
- job_id: `PROMPT-V3-SNAPSHOT-C31_POLICY_SUBSIDY_LEGISLATION_EVENT`
- run_id: `PROMPT-V3-SNAPSHOT-RUN-C31_POLICY_SUBSIDY_LEGISLATION_EVENT`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C31_POLICY_SUBSIDY_LEGISLATION_EVENT]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C31_POLICY_SUBSIDY_LEGISLATION_EVENT]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: 정책·법률·보조금이 시행규칙·eligibility·예산을 통과해 대상 회사 현금/수요로 이어지는 메커니즘
- required_bridge_axes: guard_risk, valuation_repricing, contract
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"법률/정부/규제기관·예산/가이드라인·issuer eligibility/수취·고객/산업·실적/FCF","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
- score_authority: `false`
- stage_authority: `false`

Mandatory question families:

1. `C31_POLICY_SUBSIDY_LEGISLATION_EVENT_Q01` — 법안 제안·통과·공포·시행규칙·예산 배정을 분리했는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: policy_or_regulatory_confirmed, subsidy_capture_visible
   ...
   - false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
2. `C31_POLICY_SUBSIDY_LEGISLATION_EVENT_Q02` — 대상 회사/제품의 eligibility·지역/원산지·compliance 조건은 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
3. `C31_POLICY_SUBSIDY_LEGISLATION_EVENT_Q03` — 보조금 금액·수취시점·직접 cash route·고객 가격/수요 영향은 무엇인가
   - mandatory_for_full_thesis: `true`
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
4. `C31_POLICY_SUBSIDY_LEGISLATION_EVENT_Q04` — implementation timeline·기관·신청/승인 상태는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, LIFECYCLE_SUPERSESSION
   - required_primitives: implementation_timeline, policy_headline_only
   - required_source_roles: REGULATOR_OFFICIAL, ISSUER_OFFICIAL
   - preferred_source_families: REGULATOR_OFFICIAL, ISSUER_OFFICIAL
   - affected_component_ids: bottleneck_pricing, earnings_visibility, information_confidence, market_mispricing, valuation_rerating
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
   ...
   - false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
5. `C31_POLICY_SUBSIDY_LEGISLATION_EVENT_Q05` — 정권/법원/예산/무역·관세 reversal risk는 무엇인가
   - mandatory_for_full_thesis: `true`
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
6. `C31_POLICY_SUBSIDY_LEGISLATION_EVENT_Q06` — 정책 headline-only와 실제 issuer economics를 분리했는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: DIRECT_PREDICATE
   - required_source_roles: REGULATOR_OFFICIAL, ISSUER_OFFICIAL
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
7. `C31_POLICY_SUBSIDY_LEGISLATION_EVENT_Q07` — revision·valuation이 정책 기대를 선반영했는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, EXPECTATION_VALUATION
   - required_primitives: DIRECT_PREDICATE
   - required_source_roles: REGULATOR_OFFICIAL, ISSUER_OFFICIAL, CURRENT_MARKET_DATA, LAWFUL_REVISION_DATA
   - preferred_source_families: REGULATOR_OFFICIAL, ISSUER_OFFICIAL, CURRENT_MARKET_DATA, LAWFUL_REVISION_DATA
   - affected_component_ids: market_mispricing, valuation_rerating, information_confidence
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["정책 발표·테마를 대상 회사의 확정 보조금/매출로 만들지 않는다."]
