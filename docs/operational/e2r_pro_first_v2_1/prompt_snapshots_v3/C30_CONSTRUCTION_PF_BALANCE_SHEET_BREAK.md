...
- job_id: `PROMPT-V3-SNAPSHOT-C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK`
- run_id: `PROMPT-V3-SNAPSHOT-RUN-C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: PF 보증·미분양·자금조달 비용이 분양/회수·자산매각·부채축소를 거쳐 balance-sheet repair 또는 break로 이어지는 메커니즘
- required_bridge_axes: margin, contract, guard_risk
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"사업보고서/PF note·신용평가·대주단/법원·분양/사업장 자료·유동성/현금흐름·정정공시","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["PF 언급이나 건설업 일반 위험을 대상 회사의 현재 default로 자동 확대하지 않는다."]
- score_authority: `false`
- stage_authority: `false`

Mandatory question families:

1. `C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK_Q01` — PF exposure·우발채무·보증·maturity·상환순위·사업장별 위험은 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: pf_exposure_reduced, occupancy_or_presale_visible
   ...
   - false_positive_guards: ["PF 언급이나 건설업 일반 위험을 대상 회사의 현재 default로 자동 확대하지 않는다."]
2. `C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK_Q02` — 분양률·입주율·미분양·공정률·cash collection이 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   - required_primitives: cash_collection_visible
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["PF 언급이나 건설업 일반 위험을 대상 회사의 현재 default로 자동 확대하지 않는다."]
3. `C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK_Q03` — refinancing·금리·담보·credit rating·유동성 runway는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["PF 언급이나 건설업 일반 위험을 대상 회사의 현재 default로 자동 확대하지 않는다."]
4. `C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK_Q04` — 자산매각·유상증자·채무조정·보증 해소가 실제 repair인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, LIFECYCLE_SUPERSESSION
   - required_primitives: balance_sheet_repair
   - required_source_roles: ISSUER_OFFICIAL, OFFICIAL_FILING
   - preferred_source_families: ISSUER_OFFICIAL, OFFICIAL_FILING
   - affected_component_ids: bottleneck_pricing, earnings_visibility, information_confidence, market_mispricing, valuation_rerating
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
   ...
   - false_positive_guards: ["PF 언급이나 건설업 일반 위험을 대상 회사의 현재 default로 자동 확대하지 않는다."]
5. `C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK_Q05` — 프로젝트 margin·충당금·impairment·미청구/매출채권·FCF는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   - required_primitives: DIRECT_PREDICATE
   - required_source_roles: ISSUER_EARNINGS, OFFICIAL_FILING
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["PF 언급이나 건설업 일반 위험을 대상 회사의 현재 default로 자동 확대하지 않는다."]
6. `C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK_Q06` — default·워크아웃·법정관리·소송·추가 지원의무 counter는 무엇인가
   - mandatory_for_full_thesis: `true`
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`2`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["PF 언급이나 건설업 일반 위험을 대상 회사의 현재 default로 자동 확대하지 않는다."]
7. `C30_CONSTRUCTION_PF_BALANCE_SHEET_BREAK_Q07` — 과거 PF risk가 최신 자료에서 OPEN/RESOLVED/SUPERSEDED인지 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK, LIFECYCLE_SUPERSESSION
   - required_primitives: funding_cost_risk
   - required_source_roles: ISSUER_OFFICIAL, OFFICIAL_FILING
   - preferred_source_families: ISSUER_OFFICIAL, OFFICIAL_FILING
   - affected_component_ids: earnings_visibility, information_confidence
   - allowed_terminal_statuses: SUPPORTED_SCORING, PARTIALLY_SUPPORTED_SCORING, SUPPORTED_NON_SCORING, COUNTER_SUPPORTED, EVALUATED_ABSENT_AFTER_ADEQUATE_SEARCH, LIKELY_NONPUBLIC, FUTURE_EVENT_ONLY, NOT_APPLICABLE_WITH_REASON
