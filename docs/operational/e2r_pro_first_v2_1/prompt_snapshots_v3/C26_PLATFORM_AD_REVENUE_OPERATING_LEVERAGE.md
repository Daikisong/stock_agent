...
- job_id: `PROMPT-V3-SNAPSHOT-C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE`
- run_id: `PROMPT-V3-SNAPSHOT-RUN-C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-V3-SNAPSHOT-RUN-C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE]]`, `[[E2R_PRO_JOB_ID:PROMPT-V3-SNAPSHOT-C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE]]`, `[[E2R_PRO_PASS_ID:TO_BE_BOUND_BY_ORCHESTRATOR]]`, `[[E2R_PRO_PARENT_PASS_ID:NONE]]` marker를 각각 정확히 한 번 출력한다.
...
- economic_mechanism: 사용자 engagement·ARPU·광고수요·take rate가 비용 구조를 넘어 operating leverage와 cash로 이어지는 플랫폼 메커니즘
- required_bridge_axes: software_retention, customer, margin
- source_role_policy: `{"llm_only_inference_is_diagnostic":true,"official_first":true,"recommended_routes":"issuer KPI/실적·광고주/플랫폼 공식자료·규제기관·트래픽 보조자료·FCF/SBC·revision","source_proxy_is_non_scoring":true}`
- false_positive_guards: ["다운로드·MAU·AI/광고 테마만으로 ARPU·take rate·margin을 만들지 않는다."]
- score_authority: `false`
- stage_authority: `false`

Mandatory question families:

1. `C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_Q01` — MAU/DAU·time spent·retention·traffic source의 질은 무엇인가
   ...
   - false_positive_guards: ["다운로드·MAU·AI/광고 테마만으로 ARPU·take rate·margin을 만들지 않는다."]
2. `C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_Q02` — ARPU·ad load·CPM/CPC·광고주 수요·take rate가 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE
   - required_primitives: arpu_growth_pct, ad_revenue_growth_pct, take_rate_improvement
   - required_source_roles: ISSUER_OFFICIAL, OFFICIAL_FILING
   - preferred_source_families: ISSUER_OFFICIAL, OFFICIAL_FILING
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["다운로드·MAU·AI/광고 테마만으로 ARPU·take rate·margin을 만들지 않는다."]
3. `C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_Q03` — 광고/거래 매출 성장과 segment margin·operating leverage가 확인되는가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   - required_primitives: operating_leverage_visible
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["다운로드·MAU·AI/광고 테마만으로 ARPU·take rate·margin을 만들지 않는다."]
4. `C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_Q04` — 콘텐츠/traffic acquisition·sales/marketing·AI/infra 비용은 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION
   - required_primitives: DIRECT_PREDICATE
   - required_source_roles: ISSUER_OFFICIAL, OFFICIAL_FILING
   ...
   - adequate_search: official-first=`true`, minimum_distinct_source_routes=`1`, independent_no_new_route_confirmations=`2`
   - false_positive_guards: ["다운로드·MAU·AI/광고 테마만으로 ARPU·take rate·margin을 만들지 않는다."]
5. `C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_Q05` — privacy·규제·platform dependency·advertiser concentration·경기 둔화 counter는 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, COUNTER_HARD_BREAK
   - required_primitives: regulatory_risk
   ...
   - false_positive_guards: ["다운로드·MAU·AI/광고 테마만으로 ARPU·take rate·margin을 만들지 않는다."]
6. `C26_PLATFORM_AD_REVENUE_OPERATING_LEVERAGE_Q06` — FCF·SBC·CAPEX·revision·valuation은 무엇인가
   - mandatory_for_full_thesis: `true`
   - question_roles: ECONOMIC_BRIDGE, FINANCIAL_CASH_CONVERSION, EXPECTATION_VALUATION, LIFECYCLE_SUPERSESSION
   - required_primitives: DIRECT_PREDICATE
