...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-SNAPSHOT-RUN-C01_ORDER_BACKLOG_MARGIN_BRIDGE]]`와 `[[E2R_PRO_JOB_ID:PROMPT-SNAPSHOT-C01_ORDER_BACKLOG_MARGIN_BRIDGE]]` marker를 각각 정확히 한 번 출력한다.
