...
- job_id: `PROMPT-SNAPSHOT-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION`
- run_id: `PROMPT-SNAPSHOT-RUN-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION`
...
최종 응답에는 `[[E2R_PRO_RUN_ID:PROMPT-SNAPSHOT-RUN-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION]]`와 `[[E2R_PRO_JOB_ID:PROMPT-SNAPSHOT-C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION]]` marker를 각각 정확히 한 번 출력한다.
...
- role: `PRIMARY`
- mechanism: 규제 승인·label·reimbursement·partner economics가 실제 launch·royalty·매출로 전환되는 메커니즘
- required_bridge_axes: bio_commercialization, guard_risk
- source roles: FDA/EMA/MFDS 등 규제기관·payer/reimbursement·issuer/partner 계약·제조/launch·실적/royalty·특허
- false-positive guard: 신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다.
- score_authority: `false`
- stage_authority: `false`
...
1. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q01` — 승인 기관·국가·indication·label·조건부/정식 승인 상태는 무엇인가
   ...
   - primitives: regulatory_approval_confirmed
   ...
   - guard: 신청·심사·우선심사·회의·논문을 승인과 매출로 승격하지 않는다.
...
3. `C23_BIO_REGULATORY_APPROVAL_COMMERCIALIZATION_Q03` — partner 계약·upfront/milestone/royalty·territory·cost share가 무엇인가
   - roles: ECONOMIC_BRIDGE, LIFECYCLE_SUPERSESSION
   - primitives: approval_to_revenue_bridge, royalty_route, partner_economics_visible
