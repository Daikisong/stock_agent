...
- status: RUN_COMPLETE_WITH_UNRESOLVED_FAILURES
- final_status: NOT_READY
- target_gate: full_thesis
- max_iterations: 1
- loop_executed: True
- completion_eligible: False
- resolved_failures: KNOWN_BAD_REGRESSION_NOT_RUN_OR_FAILED, CLAIM_TO_STAGE_FORENSIC_CRITICAL, SOURCE_TASK_REALNESS_AUDIT_FAILED
- unresolved_failures: RUNTIME_PLAUSIBILITY_AUDIT_FAILED
