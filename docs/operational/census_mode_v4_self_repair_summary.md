...
- deferred_goal_blockers: brain_web_evidence_pass_false, full_thesis_smoke_pending, full_thesis_production_pass_false, full_thesis_seed_materialization_not_promoted, source_backed_replay_parity_all_archetypes_pending
