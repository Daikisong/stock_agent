...
- full_thesis_by_archetype: `{"C01_ORDER_BACKLOG_MARGIN_BRIDGE": 1, "C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG": 1, "C05_EPC_MEGA_CONTRACT_MARGIN_GAP": 1, "C06_HBM_MEMORY_CUSTOMER_CAPACITY": 1, "C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY": 1, "C15_MATERIAL_SPREAD_SUPERCYCLE": 1}`
...
1. 왜 예전 production FULL_THESIS 10개가 전부 C05였고, 현재는 어떻게 바뀌었나?
   - 예전 seed target은 UNKNOWN이었고 source_primary/planner top1 경로가 C05로 쏠렸다. 현재 promoted row는 C01_ORDER_BACKLOG_MARGIN_BRIDGE/C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG/C05_EPC_MEGA_CONTRACT_MARGIN_GAP/C06_HBM_MEMORY_CUSTOMER_CAPACITY/C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY/C15_MATERIAL_SPREAD_SUPERCYCLE 경로로 분산됐다.
...
4. C05가 아닌 후보는 왜 0개인가?
   - 이 질문은 예전 C05-only 산출물에 대한 질문이다. 현재 non-C05 score-path row는 C01_ORDER_BACKLOG_MARGIN_BRIDGE/C03_DEFENSE_EXPORT_FRAMEWORK_BACKLOG/C06_HBM_MEMORY_CUSTOMER_CAPACITY/C08_SEMI_TEST_SOCKET_CUSTOMER_QUALITY/C15_MATERIAL_SPREAD_SUPERCYCLE이고, mandatory missing prefix는 C17/C24/C28다.
