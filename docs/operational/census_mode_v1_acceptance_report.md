...
2. Commit SHA at report generation: d9d162c9e676bab0dad67f88ba333efa180fe66f
...
3. Test command: PYTHONPATH=src python -m unittest discover -s tests -v
   Test result: not_run_by_census_runner
...
7. Config/source/candidate/evidence/scoring/stage hashes: config=c92337e73a0c3734b65d4882178f11c1fcf843ba48a0afba2105ae4973f9680d, source=85fbe264a497ad4f90ffd97fa67e607161dc717e94271c87ecbe8676661c7712, candidate=c4349c96ea7f3d677b433bb1fcac7aadf0e3d879a1cc30f39451df93205c9a08, evidence_os=e2r-agentic-evidence-os-v2, scoring=e2r-deterministic-scorer-v2, stage=e2r-stage-court-v2
...
24. Runtime/SLA summary: {'status': 'COMPLETE', 'total_runtime_seconds': 7.815, 'deep_count': 0, 'llm_calls': 0, 'source_task_count': 0, 'provider_failure_count': 0, 'runtime_pending_count': 0, 'unbounded_fetch_config_count': 0}
