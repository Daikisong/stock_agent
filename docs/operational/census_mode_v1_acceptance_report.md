...
1. Final status: IMPLEMENTATION_MERGED, CENSUS_LIGHT_PASS, FULL_UNIVERSE_STAGE_MAP_PASS, WATCHLIST_SEED_PASS, CENSUS_STATIC_AUDIT_PASS, CENSUS_SLA_PASS, READY_FOR_DEEP_BACKFILL_DESIGN
2. Commit SHA at report generation: 698b3b132f4d91e405e64cb0dd608be77743a30c
...
3. Test command: PYTHONPATH=src python -m unittest discover -s tests -v
   Test result: Ran 4764 tests in 97.600s OK
...
7. Config/source/candidate/evidence/scoring/stage hashes: config=da8db5912dfc5e996d404f1cadb876d99815bc97dc7d0fe4e54a9dae60d67085, source=85fbe264a497ad4f90ffd97fa67e607161dc717e94271c87ecbe8676661c7712, candidate=c4349c96ea7f3d677b433bb1fcac7aadf0e3d879a1cc30f39451df93205c9a08, evidence_os=e2r-agentic-evidence-os-v2, scoring=e2r-deterministic-scorer-v2, stage=e2r-stage-court-v2
...
12. Stage distribution: {'Unknown': 3391}
...
22. NoCurrentCatalyst count: 0
23. Watchlist seed count: 0
24. Runtime/SLA summary: {'status': 'PARTIAL_WITH_PENDING', 'total_runtime_seconds': 7.8062, 'deep_count': 0, 'llm_calls': 0, 'source_task_count': 0, 'provider_failure_count': 3391, 'provider_circuit_open': True, 'runtime_pending_count': 0, 'unbounded_fetch_config_count': 0}
...
26. Census readiness verdict: READY_FOR_DEEP_BACKFILL_DESIGN
27. Deep backfill readiness: READY_FOR_DEEP_BACKFILL_DESIGN
28. Daily trigger integration readiness: BLOCKED_BY_PROVIDER_OR_EMPTY_SEED
