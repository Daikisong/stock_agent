...
2. Commit SHA / message / push status / working tree: report_generation_sha=99e612ffbd8b1e9bcd4ded65a01ab9ad8053e454; push_status=not_pushed_by_runner
...
9. Base/display stage distribution: {'Stage0': 3300, 'Stage1': 52, '0': 8, 'Stage2-Watch': 29, 'Red': 1, '2': 1}
10. Stage signal distribution: {'NO_CURRENT_CATALYST': 3300, 'OFFICIAL_EVENT_WATCH': 34, 'FULL_THESIS_PRODUCTION_STAGE': 6, 'EVIDENCE_INSUFFICIENT': 10, 'MATERIAL_CLAIM_WATCH': 29, 'SOURCE_PENDING': 8, 'BRAIN_WEB_CLAIM_BACKED_STAGE': 2, 'RISK_REVIEW': 1, 'BRAIN_OFFICIAL_CLAIM_BACKED_STAGE': 1}
11. Score scale distribution: {'NO_SCORE': 3318, 'EVENT_WEIGHTED_PARTIAL': 67, 'FULL_E2R_100': 6}
12. Stage scope distribution: {'CENSUS_EVENT_BOARD': 3382, 'FULL_THESIS': 6, 'BRAIN_WEB_PARTIAL': 2, 'BRAIN_OFFICIAL_PARTIAL': 1}
13. Score scope distribution: {'NO_SCORE': 3318, 'EVENT_WEIGHTED_PARTIAL': 64, 'FULL_E2R_100': 6, 'BRAIN_WEB_CLAIM_BACKED_PARTIAL': 2, 'BRAIN_OFFICIAL_CLAIM_BACKED_PARTIAL': 1}
...
18. Candidate event scope distribution: {'ASSESSMENT_ONLY': 3300, 'CANDIDATE_EVENTS_PRESENT': 91}
19. Candidate event count: 246
20. Score eligible candidate event count: 98
21. Planner rows: 452; real LLM planner calls=105; real_success=105; not_attempted=347
22. LLM planner real-provider success: 105
23. Brain/Web attempt verdict: ATTEMPTED_WITH_SOURCE_TASKS; source_tasks=738; accepted_claims=126
24. Brain Stage promotion verdict: PROMOTION_APPLIED; promoted=9; unsafe_promoted=0; snapshot_docs=0
...
26. Web search tasks: 132
27. Claim extractor runs: 107
28. Evidence claim payload rows: 164
29. Non-representative claim audit: PASS; critical_count=0; warning_count=61; representative_claims=83; non_representative_claims=81; reason_distribution={'accepted_claim_without_atomic_decision': 61, 'non_representative_atomic_decision': 20}
...
33. Source task satisfaction audit: PASS_LEDGER_REFRESH_SOURCE_TASK_SATISFACTION; scope=LEDGER_REFRESH_SOURCE_TASK_SATISFACTION_PASS; live_source_task_satisfaction_pass_allowed=False; critical_count=0; warning_count=81; representative_score_claims=83; chain_closed_to_representative_stage=124; non_representative_source_task_claims=81; baseline_only_score_claims=32
34. Primitive state chain audit: PASS; critical_count=0; representative_score_claims=83; representative_score_claims_with_primitive=83; primitive_states=247; primitive_mappings=116; mapping_leaf_resolution_supported=True
35. Existing ledger reuse audit: PASS; reused_claims=92; new_brain_web_claims=72
...
38. Runtime plausibility audit: PASS_LIVE_RUNTIME_PLAUSIBILITY; runtime_mode=BRAIN_AND_WEB_ACQUISITION_ENABLED; provider_calls=24; llm_calls=105
...
43. Output root: output/census_v4/2026-07-05-research-to-runtime-parity-self-repair-01-20260707T173522Z
44. runtime_seconds: 10864.39
