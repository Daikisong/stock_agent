...
2. Commit SHA / message / push status / working tree: report_generation_sha=1833cf5559bbbee861c38a04c65078d74543f76b; push_status=not_pushed_by_runner
...
9. Base/display stage distribution: {'Stage0': 3305, 'Stage1': 52, 'Stage2-Watch': 29, '0': 3, '1': 1, 'Red': 1}
10. Stage signal distribution: {'NO_CURRENT_CATALYST': 3305, 'OFFICIAL_EVENT_WATCH': 34, 'EVIDENCE_INSUFFICIENT': 10, 'MATERIAL_CLAIM_WATCH': 29, 'SOURCE_PENDING': 8, 'FULL_THESIS_PRODUCTION_STAGE': 4, 'RISK_REVIEW': 1}
11. Score scale distribution: {'NO_SCORE': 3323, 'EVENT_WEIGHTED_PARTIAL': 64, 'FULL_E2R_100': 4}
12. Stage scope distribution: {'CENSUS_EVENT_BOARD': 3387, 'FULL_THESIS': 4}
13. Score scope distribution: {'NO_SCORE': 3323, 'EVENT_WEIGHTED_PARTIAL': 64, 'FULL_E2R_100': 4}
...
21. Planner rows: 458; real LLM planner calls=111; real_success=81; not_attempted=347
22. LLM planner real-provider success: 81
23. Brain/Web attempt verdict: ATTEMPTED_NOT_CUTOVER_READY; source_tasks=570; accepted_claims=47
24. Brain Stage promotion verdict: FAIL_UNSAFE_PROMOTION; promoted=4; unsafe_promoted=4; snapshot_docs=3
...
26. Web search tasks: 72
27. Claim extractor runs: 34
28. Evidence claim payload rows: 102
29. Non-representative claim audit: PASS; critical_count=0; warning_count=11; representative_claims=71; non_representative_claims=31; reason_distribution={'accepted_claim_without_atomic_decision': 11, 'non_representative_atomic_decision': 20}
...
32. Source task realness audit: LIVE_SOURCE_PASS; scope=LEDGER_REFRESH_REALNESS_PASS; live_source_pass_allowed=True; claim_producing=76; real_fetch=16; fresh_cache=60; lifecycle_refresh=32
33. Source task satisfaction audit: PASS_LEDGER_REFRESH_SOURCE_TASK_SATISFACTION; scope=LEDGER_REFRESH_SOURCE_TASK_SATISFACTION_PASS; live_source_task_satisfaction_pass_allowed=False; critical_count=0; warning_count=31; representative_score_claims=71; chain_closed_to_representative_stage=97; non_representative_source_task_claims=31; baseline_only_score_claims=32
34. Primitive state chain audit: PASS; critical_count=0; representative_score_claims=71; representative_score_claims_with_primitive=71; primitive_states=190; primitive_mappings=100; mapping_leaf_resolution_supported=True
...
38. Runtime plausibility audit: PASS_LIVE_RUNTIME_PLAUSIBILITY; runtime_mode=BRAIN_AND_WEB_ACQUISITION_ENABLED; provider_calls=16; llm_calls=81
...
43. Output root: output/census_v4/2026-07-05-goal4-all-archetype-next-runtime-attempt-materialized-v1
44. runtime_seconds: 5024.88
