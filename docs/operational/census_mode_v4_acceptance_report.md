...
2. Commit SHA / message / push status / working tree: report_generation_sha=2e2acea1d67e698895bdfa37f3aa21982da0631a; push_status=not_pushed_by_runner
...
9. Base/display stage distribution: {'Stage0': 3299, '3-Green': 1, 'Stage1': 51, '0': 8, 'Stage2-Watch': 29, 'Red': 1, '1': 1, '2': 1}
10. Stage signal distribution: {'NO_CURRENT_CATALYST': 3299, 'FULL_THESIS_PRODUCTION_STAGE': 6, 'OFFICIAL_EVENT_WATCH': 33, 'BRAIN_WEB_CLAIM_BACKED_STAGE': 4, 'EVIDENCE_INSUFFICIENT': 10, 'MATERIAL_CLAIM_WATCH': 29, 'SOURCE_PENDING': 8, 'RISK_REVIEW': 1, 'BRAIN_OFFICIAL_CLAIM_BACKED_STAGE': 1}
11. Score scale distribution: {'NO_SCORE': 3317, 'FULL_E2R_100': 6, 'EVENT_WEIGHTED_PARTIAL': 68}
12. Stage scope distribution: {'CENSUS_EVENT_BOARD': 3380, 'FULL_THESIS': 6, 'BRAIN_WEB_PARTIAL': 4, 'BRAIN_OFFICIAL_PARTIAL': 1}
13. Score scope distribution: {'NO_SCORE': 3317, 'FULL_E2R_100': 6, 'EVENT_WEIGHTED_PARTIAL': 63, 'BRAIN_WEB_CLAIM_BACKED_PARTIAL': 4, 'BRAIN_OFFICIAL_CLAIM_BACKED_PARTIAL': 1}
...
23. Brain/Web attempt verdict: ATTEMPTED_WITH_SOURCE_TASKS; source_tasks=805; accepted_claims=110
24. Brain Stage promotion verdict: PROMOTION_APPLIED; promoted=11; unsafe_promoted=0; snapshot_docs=6
...
26. Web search tasks: 140
27. Claim extractor runs: 141
28. Evidence claim payload rows: 162
29. Non-representative claim audit: PASS; critical_count=0; warning_count=61; representative_claims=80; non_representative_claims=82; reason_distribution={'accepted_claim_without_atomic_decision': 61, 'non_representative_atomic_decision': 21}
...
33. Source task satisfaction audit: PASS_LEDGER_REFRESH_SOURCE_TASK_SATISFACTION; scope=LEDGER_REFRESH_SOURCE_TASK_SATISFACTION_PASS; live_source_task_satisfaction_pass_allowed=False; critical_count=0; warning_count=82; representative_score_claims=80; chain_closed_to_representative_stage=107; non_representative_source_task_claims=82; baseline_only_score_claims=32
34. Primitive state chain audit: PASS; critical_count=0; representative_score_claims=80; representative_score_claims_with_primitive=80; primitive_states=253; primitive_mappings=112; mapping_leaf_resolution_supported=True
35. Existing ledger reuse audit: PASS; reused_claims=92; new_brain_web_claims=70
...
38. Runtime plausibility audit: PASS_LIVE_RUNTIME_PLAUSIBILITY; runtime_mode=BRAIN_AND_WEB_ACQUISITION_ENABLED; provider_calls=27; llm_calls=111
...
43. Output root: output/census_v4/2026-07-07-goal4-all-archetype-next-runtime-attempt-retry-mapping-status
44. runtime_seconds: 12772.68
