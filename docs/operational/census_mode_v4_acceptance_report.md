...
2. Commit SHA / message / push status / working tree: report_generation_sha=e0e9399c17ac921f1ee1b40b421c3fe7ba23c2b3; push_status=not_pushed_by_runner
...
9. Base/display stage distribution: {'Stage0': 3299, 'Stage1': 51, '0': 10, 'Stage2-Watch': 29, 'Red': 1, '1': 1}
10. Stage signal distribution: {'NO_CURRENT_CATALYST': 3299, 'OFFICIAL_EVENT_WATCH': 33, 'BRAIN_WEB_CLAIM_BACKED_STAGE': 4, 'EVIDENCE_INSUFFICIENT': 10, 'MATERIAL_CLAIM_WATCH': 29, 'SOURCE_PENDING': 8, 'FULL_THESIS_PRODUCTION_STAGE': 6, 'RISK_REVIEW': 1, 'BRAIN_OFFICIAL_CLAIM_BACKED_STAGE': 1}
11. Score scale distribution: {'NO_SCORE': 3317, 'EVENT_WEIGHTED_PARTIAL': 68, 'FULL_E2R_100': 6}
12. Stage scope distribution: {'CENSUS_EVENT_BOARD': 3380, 'BRAIN_WEB_PARTIAL': 4, 'FULL_THESIS': 6, 'BRAIN_OFFICIAL_PARTIAL': 1}
13. Score scope distribution: {'NO_SCORE': 3317, 'EVENT_WEIGHTED_PARTIAL': 63, 'BRAIN_WEB_CLAIM_BACKED_PARTIAL': 4, 'FULL_E2R_100': 6, 'BRAIN_OFFICIAL_CLAIM_BACKED_PARTIAL': 1}
...
18. Candidate event scope distribution: {'ASSESSMENT_ONLY': 3299, 'CANDIDATE_EVENTS_PRESENT': 92}
19. Candidate event count: 250
...
23. Brain/Web attempt verdict: ATTEMPTED_WITH_SOURCE_TASKS; source_tasks=789; accepted_claims=101
24. Brain Stage promotion verdict: PROMOTION_APPLIED; promoted=11; unsafe_promoted=0; snapshot_docs=0
25. Brain/Web readiness gate: BLOCKED; pass_allowed=False; minimum_gate_applies=True; operational_minimum_count_gate_applies=True; minimum_required_counts={'llm_claim_extractor_attempt_count': 10, 'llm_planner_call_count': 30, 'official_first_violation_count': 0, 'web_fetched_document_count': 10, 'web_or_llm_accepted_claim_count': 3, 'web_search_call_count': 20, 'web_search_task_count': 20}; blockers=1; connectivity_missing=0
26. Web search tasks: 158
27. Claim extractor runs: 113
28. Evidence claim payload rows: 139
29. Non-representative claim audit: PASS; critical_count=0; warning_count=39; representative_claims=79; non_representative_claims=60; reason_distribution={'accepted_claim_without_atomic_decision': 39, 'non_representative_atomic_decision': 21}
30. Research Brain bridge verdict: SHADOW_OR_IMPORT_ONLY; usable_for_census_cutover=False; snapshot_url_count=255
31. Claim-to-stage forensic audit: PASS; critical_count=0; scored_rows=74
32. Source task realness audit: LIVE_SOURCE_PASS; scope=LEDGER_REFRESH_REALNESS_PASS; live_source_pass_allowed=True; claim_producing=86; real_fetch=26; fresh_cache=60; lifecycle_refresh=32
33. Source task satisfaction audit: PASS_LEDGER_REFRESH_SOURCE_TASK_SATISFACTION; scope=LEDGER_REFRESH_SOURCE_TASK_SATISFACTION_PASS; live_source_task_satisfaction_pass_allowed=False; critical_count=0; warning_count=60; representative_score_claims=79; chain_closed_to_representative_stage=121; non_representative_source_task_claims=60; baseline_only_score_claims=32
34. Primitive state chain audit: PASS; critical_count=0; representative_score_claims=79; representative_score_claims_with_primitive=79; primitive_states=280; primitive_mappings=115; mapping_leaf_resolution_supported=True
35. Existing ledger reuse audit: PASS; reused_claims=92; new_brain_web_claims=47
...
38. Runtime plausibility audit: PASS_LIVE_RUNTIME_PLAUSIBILITY; runtime_mode=BRAIN_AND_WEB_ACQUISITION_ENABLED; provider_calls=26; llm_calls=111
39. Sample leaf bundle rows: 74
...
43. Output root: output/census_v4/2026-07-05-goal4-all-archetype-next-runtime-attempt-e0e9399
44. runtime_seconds: 11241.64
