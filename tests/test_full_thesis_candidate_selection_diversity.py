...
class FullThesisCandidateSelectionDiversityTests(unittest.TestCase):
    def test_candidate_selection_audit_requires_diverse_next_attempts(self) -> None:
        ...
        self.assertEqual(audit["current_full_thesis_row_count"], 7)
        self.assertEqual(audit["current_distinct_full_thesis_archetype_count"], 7)
        self.assertEqual(audit["current_c05_full_thesis_share"], 0.142857)
