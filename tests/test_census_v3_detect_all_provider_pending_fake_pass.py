...
class CensusV3DetectAllProviderPendingFakePassTests(unittest.TestCase):
    def test_all_provider_pending_stage_map_cannot_pass(self):
        ...
        self.assertGreater(audit["critical_counts"]["provider_pending_over_30pct_count"], 0)
