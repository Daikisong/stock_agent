...
class AllArchetypeNextAttemptPlanTests(unittest.TestCase):
    ...
    def test_attempt_types_reflect_current_runtime_failure_modes(self) -> None:
        ...
        self.assertEqual(self.by_prefix["C15"]["attempt_type"], "ACCEPTED_CLAIM_TO_FULL_THESIS_CLOSURE")
        self.assertEqual(self.by_prefix["C17"]["attempt_type"], "ACCEPTED_CLAIM_TO_FULL_THESIS_CLOSURE")
