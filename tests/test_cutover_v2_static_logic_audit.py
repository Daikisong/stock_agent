...
class CutoverV2StaticLogicAuditTests(unittest.TestCase):
    def test_provider_gap_is_blocker_not_critical_ready_overclaim(self):
        ...
        self.assertIn("blocking source provider gaps remain", audit["summary"]["production_blockers"])
