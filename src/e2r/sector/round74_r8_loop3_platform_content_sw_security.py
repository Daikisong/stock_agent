"""Round-74 R8 Loop-3 platform/content/software/security pack.

Round 74 tightens the Round-48 R8 pack. It separates user-count, AI-feature,
...
ROUND74_SOURCE_ROUND_PATH = "docs/round/round_74.md"
ROUND74_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round74_r8_loop3_platform_content_sw_security"
ROUND74_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r8_loop3_round74.jsonl"
ROUND74_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round74_r8_loop3_v3.csv"


@dataclass(frozen=True)
class Round74ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round74ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round74ScoreWeightDraft
...
GATE_WEIGHT = Round74ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND74_SCORE_TARGETS: tuple[Round74ScoreTarget, ...] = (
    Round74ScoreTarget(
        "PLATFORM_SOFTWARE_INTERNET",
        E2RArchetype.PLATFORM_SOFTWARE_INTERNET,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(18, 18, 7, 15, 13, 1, 5),
    ...
    Round74ScoreTarget(
        ...
        Round74ScoreWeightDraft(20, 23, 7, 15, 13, 1, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round74ScoreWeightDraft(22, 23, 9, 16, 12, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(20, 19, 9, 15, 12, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(21, 22, 8, 15, 12, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(19, 20, 8, 14, 13, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(18, 16, 6, 13, 10, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(17, 14, 5, 12, 9, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(16, 14, 6, 12, 9, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(18, 18, 7, 14, 10, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(20, 21, 8, 14, 12, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round74ScoreWeightDraft(20, 20, 10, 14, 12, 0, 5),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round74ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", 6),
    ...
    Round74ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round74ScoreWeightDraft(5, 5, 5, 6, 5, 0, 3),
...
ROUND74_CASE_CANDIDATES: tuple[Round74CaseCandidate, ...] = (
    Round74CaseCandidate(
        ...
        ("round_74.md Reuters EQT Douzone Bizon",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md MarketWatch Palantir Q4 2025",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md MarketWatch Palantir Q1 2026",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Barrons Datadog observability",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Barrons Fortinet billings",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md The Verge Netflix ad ambitions",),
    ...
    Round74CaseCandidate(
        ...
        "adtech_premium_miss",
        "needs_price_backfill",
        ("round_74.md Barron's Trade Desk revenue miss",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters CrowdStrike shareholder lawsuit",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters Delta sues CrowdStrike",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters Kakao founder legal case",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters Roblox safety forecast cut",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md GTA VI preorder rumor",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters WPP ad forecast cut",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Guardian WPP profits",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters Netflix Texas privacy lawsuit",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters Meta scam ads lawsuit",),
    ...
    Round74CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_74.md Reuters Meta youth safety trial",),
...
ROUND74_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
ROUND74_RISK_OVERLAYS: tuple[str, ...] = (
    "AI_SOFTWARE_REVENUE_ALIGNED",
    "AI_SOFTWARE_4B_VALUATION",
...
def target_for(target_id: str) -> Round74ScoreTarget | None:
...
def round74_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND74_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round74 R8 Loop-3 case for {candidate.target_id}; "
...
def round74_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round74_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND74_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round74_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round74_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round74_backfill": "true"} for field in ROUND74_PRICE_FIELDS)


def round74_summary() -> dict[str, int | bool]:
    records = round74_case_records()
    return {
        "target_count": len(ROUND74_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND74_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND74_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND74_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND74_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round74_r8_loop3_reports(
    *,
    output_directory: str | Path = ROUND74_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND74_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND74_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round74_r8_loop3_platform_content_sw_security_summary.md",
        "case_matrix": output / "round74_r8_loop3_case_matrix.csv",
        "stage_date_plan": output / "round74_r8_loop3_stage_date_plan.csv",
        "green_guardrails": output / "round74_r8_loop3_green_guardrails.md",
        "risk_overlays": output / "round74_r8_loop3_risk_overlays.md",
        "price_validation_plan": output / "round74_r8_loop3_price_validation_plan.md",
        "price_fields": output / "round74_r8_loop3_price_fields.csv",
    }
    _write_case_jsonl(round74_case_records(), cases)
    _write_rows(round74_score_profile_rows(), score_profiles)
    _write_rows(round74_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round74_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round74_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round74_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round74_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round74_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round74_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round74_summary_markdown() -> str:
    summary = round74_summary()
    lines = [
        "# Round 74 R8 Loop-3 Platform/Content/SW/Security Summary",
        "",
        "Round 74 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round74_green_guardrail_markdown() -> str:
    lines = [
        "# Round 74 R8 Loop-3 Green Guardrails",
        "",
        "- Do not apply R8 Loop-3 v3.0 weights to production scoring yet.",
...
def render_round74_risk_overlay_markdown() -> str:
    lines = ["# Round 74 R8 Loop-3 Risk Overlays", ""]
    for overlay in ROUND74_RISK_OVERLAYS:
...
def render_round74_price_validation_plan_markdown() -> str:
    lines = [
        "# Round 74 R8 Loop-3 Price Validation Plan",
        "",
        "For every case, backfill stage prices and forward MFE/MAE before applying score-weight changes.",
        "",
        "## Priority Cases",
    ]
    for row in round74_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND74_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round74CaseCandidate) -> str:
...
def _rerating_result(candidate: Round74CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round74ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
