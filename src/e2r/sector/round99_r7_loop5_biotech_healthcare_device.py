"""Round-99 R7 Loop-5 biotech, healthcare, and medical-device pack.

Round 99 tightens the R7 healthcare pack. It separates approvals, clinical
...
ROUND99_SOURCE_ROUND_PATH = "docs/round/round_99.md"
ROUND99_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round99_r7_loop5_biotech_healthcare_device"
ROUND99_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r7_loop5_round99.jsonl"
ROUND99_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round99_r7_loop5_v5.csv"


@dataclass(frozen=True)
class Round99ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round99ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round99ScoreWeightDraft
...
GATE_WEIGHT = Round99ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")
CAP_WEIGHT = Round99ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+")


ROUND99_SCORE_TARGETS: tuple[Round99ScoreTarget, ...] = (
    Round99ScoreTarget(
        "CDMO_HEALTHCARE_CONTRACT",
        E2RArchetype.CDMO_HEALTHCARE_CONTRACT,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round99ScoreWeightDraft(20, 24, 12, 12, 12, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round99ScoreWeightDraft(19, 21, 12, 12, 11, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(19, 20, 11, 12, 10, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(16, 17, 7, 11, 9, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(18, 18, 6, 12, 9, 0, 6),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(16, 15, 5, 11, 8, 0, 6),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round99ScoreWeightDraft(22, 20, 12, 13, 8, 0, 6),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(21, 19, 11, 13, 9, 0, 6),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(18, 15, 5, 13, 7, 0, 6),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round99ScoreWeightDraft(7, 10, 8, 9, 5, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round99ScoreWeightDraft(6, 10, 7, 12, 6, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(18, 17, 8, 13, 12, 0, 7),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(16, 16, 8, 13, 11, 0, 7),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(16, 16, 7, 12, 9, 1, 6),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round99ScoreWeightDraft(15, 13, 5, 10, 8, 0, 6),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round99ScoreWeightDraft(20, 22, 13, 14, 12, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round99ScoreWeightDraft(21, 23, 13, 14, 12, 1, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round99ScoreWeightDraft(19, 20, 12, 13, 11, 0, 5),
    ...
    Round99ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round99ScoreWeightDraft(20, 5, 5, 5, 5, 0, 5),
...
ROUND99_CASE_CANDIDATES: tuple[Round99CaseCandidate, ...] = (
    Round99CaseCandidate(
        ...
        ("round_99.md Reuters Samsung Biologics GSK US facility",),
    ...
    Round99CaseCandidate(
        ...
        ("round_99.md Samsung Biologics CDMO structure reference",),
    ...
    Round99CaseCandidate(
        ...
        ("round_99.md Investors Intuitive Surgical Q1 2026",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Straumann dental implant growth",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Lilly oral GLP-1 approval",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Foundayo switch maintenance",),
    ...
    Round99CaseCandidate(
        ...
        ("round_99.md Reuters Humira biosimilar GoodRx access",),
    ...
    Round99CaseCandidate(
        ...
        "glp1_4b_to_4c",
        "needs_price_backfill",
        ("round_99.md Reuters Novo 2026 outlook warning",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Hims GLP-1 revenue miss",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Hims compounded GLP-1 crackdown",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters bluebird bio take-private cash crunch",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Charles River forecast cut",),
        "CRO is service revenue, but funding-cycle cuts can break backlog and forecast visibility.",
    ),
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Teladoc record low",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md Reuters Recursion Exscientia merger",),
    ...
    Round99CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_99.md arXiv Lunit DBT subgroup performance",),
    ...
    Round99CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_99.md Reuters Amgen Samsung Bioepis patent litigation",),
    ...
    Round99CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_99.md AP FDA unapproved Botox warning",),
...
ROUND99_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def round99_target_for(target_id: str) -> Round99ScoreTarget | None:
    for target in ROUND99_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round99_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND99_CASE_CANDIDATES:
        target = round99_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round99 R7 Loop-5 case for {candidate.target_id}; "
...
def round99_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round99_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND99_CASE_CANDIDATES:
        target = round99_target_for(candidate.target_id)
...
def round99_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round99_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round99_backfill": "true"} for field in ROUND99_PRICE_FIELDS)


def round99_summary() -> dict[str, int | bool]:
    records = round99_case_records()
    return {
        "target_count": len(ROUND99_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND99_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND99_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND99_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND99_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round99_r7_loop5_reports(
    *,
    output_directory: str | Path = ROUND99_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND99_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND99_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round99_r7_loop5_biotech_healthcare_device_summary.md",
        "case_matrix": output / "round99_r7_loop5_case_matrix.csv",
        "stage_date_plan": output / "round99_r7_loop5_stage_date_plan.csv",
        "green_guardrails": output / "round99_r7_loop5_green_guardrails.md",
        "risk_overlays": output / "round99_r7_loop5_risk_overlays.md",
        "price_validation_plan": output / "round99_r7_loop5_price_validation_plan.md",
        "price_fields": output / "round99_r7_loop5_price_fields.csv",
    }
    _write_case_jsonl(round99_case_records(), cases)
    _write_rows(round99_score_profile_rows(), score_profiles)
    _write_rows(round99_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round99_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round99_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round99_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round99_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round99_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round99_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round99_summary_markdown() -> str:
    summary = round99_summary()
    lines = [
        "# Round-99 R7 Loop-5 Biotech / Healthcare / Medical Device Summary",
        "",
        f"- source_round: `{ROUND99_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R7 Loop 5 says approval, clinical success, AI papers, and TAM are not commercialization by themselves.",
...
def render_round99_green_guardrail_markdown() -> str:
    lines = [
        "# Round-99 R7 Loop-5 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R7 Loop-5 v5.0 weights to production scoring yet.",
...
def render_round99_risk_overlay_markdown() -> str:
    lines = [
        "# Round-99 R7 Loop-5 Risk Overlays",
        "",
...
def render_round99_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-99 R7 Loop-5 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round99_case_candidate_rows():
...
def _score_price_alignment(candidate: Round99CaseCandidate) -> str:
...
def _rerating_result(candidate: Round99CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round99ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND99_CASE_CANDIDATES",
    "ROUND99_DEFAULT_CASES_PATH",
    "ROUND99_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND99_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND99_PRICE_FIELDS",
    "ROUND99_SCORE_TARGETS",
    "Round99CaseCandidate",
    "Round99ScoreTarget",
    "Round99ScoreWeightDraft",
    "render_round99_green_guardrail_markdown",
    "render_round99_price_validation_plan_markdown",
    "render_round99_risk_overlay_markdown",
    "render_round99_summary_markdown",
    "round99_case_candidate_rows",
    "round99_case_records",
    "round99_price_field_rows",
    "round99_score_profile_rows",
    "round99_stage_date_rows",
    "round99_summary",
    "round99_target_for",
    "write_round99_r7_loop5_reports",
]
