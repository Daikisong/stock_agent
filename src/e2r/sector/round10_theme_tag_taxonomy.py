...
ROUND10_THEME_ARCHETYPES: tuple[Round10ThemeArchetype, ...] = (
    ...
    _theme("REIT_DEVELOPMENT_TRUST", Round10LargeSector.CONSTRUCTION_REAL_ESTATE_MATERIALS, E2RArchetype.VALUE_UP_SHAREHOLDER_RETURN, ("부동산 개발신탁리츠", "리츠", "부동산 자산 보유"), Round10ThemePosture.WATCH_YELLOW_FIRST, ("nav_discount", "cash_yield", "debt_cost"), "REITs need NAV, yield, and debt-cost evidence."),
    _theme("BUILDING_MATERIALS_CYCLE", Round10LargeSector.CONSTRUCTION_REAL_ESTATE_MATERIALS, E2RArchetype.COMMODITY_SPREAD, ("건자재", "시멘트", "레미콘", "콘크리트", "철근", "거푸집", "가구"), Round10ThemePosture.WATCH_YELLOW_FIRST, ("price_hike", "volume", "cost_spread", "housing_cycle"), "Building materials are cycle/spread sensitive."),
    _theme("INFRA_RECONSTRUCTION_POLICY", Round10LargeSector.CONSTRUCTION_REAL_ESTATE_MATERIALS, E2RArchetype.CONTRACT_BACKLOG_INDUSTRIAL, ("우크라 재건", "네옴시티", "세종시", "철도"), Round10ThemePosture.REDTEAM_FIRST, ("funded_order", "contract_economics", "delivery_schedule"), "Reconstruction policy themes need confirmed orders."),
