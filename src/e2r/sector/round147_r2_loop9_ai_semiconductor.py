"""Round-147 R2 Loop-9 AI, semiconductor, and electronics pack.

Round 147 returns to R2 after the R1 Loop-9 pass. It separates HBM leaders,
...
ROUND147_SOURCE_ROUND_PATH = "docs/round/round_147.md"
ROUND147_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round147_r2_loop9_ai_semiconductor"
ROUND147_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r2_loop9_round147.jsonl"
ROUND147_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round147_r2_loop9_v9.csv"


@dataclass(frozen=True)
class Round147ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round147ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round147ScoreWeightDraft
...
@dataclass(frozen=True)
class Round147ScoreStagePriceAlignment:
    case_id: str
    detected_stage: str
...
) -> Round147ScoreWeightDraft:
    return Round147ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)


ROUND147_BASE_SCORE_WEIGHTS: tuple[Round147BaseScoreWeight, ...] = (
    Round147BaseScoreWeight("eps_fcf_revision", 25, "up", "SK Hynix, Applied Materials, and Broadcom show price paths follow OP/EPS/FCF evidence."),
    Round147BaseScoreWeight("customer_shipment_revenue_visibility", 22, "up", "Customer names, shipments, AI orders, and guidance create Stage 2 signal."),
    Round147BaseScoreWeight("bottleneck_pricing_power", 19, "hold_up", "HBM, NAND, TSMC capacity, optical PCB, and photonics bottlenecks still matter."),
    Round147BaseScoreWeight("market_mispricing_gap", 10, "cap_after_recognition", "The old memory/cyclical or generic server frame must still be wrong, but SK Hynix/Kioxia-like rerating quickly reduces the gap."),
    Round147BaseScoreWeight("valuation_room_4b_runway", 8, "cap_after_rerating", "SK Hynix, Kioxia, and IPO cases show good structures can already be 4B."),
    Round147BaseScoreWeight("capital_discipline_fcf_stability", 8, "up", "CoreWeave, Cerebras, and Ecolab-CoolIT make FCF, debt, circular financing, and M&A price central."),
    Round147BaseScoreWeight("information_confidence_disclosure_detail", 8, "up", "Supermicro and list-only AI disclosures require accounting, customer, amount, period, and parser confidence checks."),
)


ROUND147_STAGE_CAPS: tuple[Round147StageCap, ...] = (
    Round147StageCap(
        "Stage 1",
        "45",
...
ROUND147_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round147ScoreStagePriceAlignment, ...] = (
    Round147ScoreStagePriceAlignment(
...
ROUND147_SCORE_TARGETS: tuple[Round147ScoreTarget, ...] = (
    Round147ScoreTarget(
        "MEMORY_HBM_CAPACITY",
        ...
        "Loop 9 keeps HBM Green-capable, but valuation credit is reduced because successful HBM cases can already be 4B-watch.",
    ),
    Round147ScoreTarget(
        ...
        "Loop 9 splits HBM LTA/prepayment from general HBM because price bands, prepayment, and reserved capacity are stronger visibility than headlines.",
    ),
    Round147ScoreTarget(
    ...
    Round147ScoreTarget(
        ...
        "Loop 9 separates supply reallocation from simple memory price rebound: consumer exit must become AI/HBM/enterprise mix and EPS evidence.",
    ),
    Round147ScoreTarget(
    ...
    Round147ScoreTarget(
        ...
        "Loop 9 splits hyperscaler custom ASICs from generic AI chips because named customer, capacity, margin, and repeat revenue matter.",
    ),
    Round147ScoreTarget(
...
ROUND147_CASE_CANDIDATES: tuple[Round147CaseCandidate, ...] = (
    Round147CaseCandidate(
        "sk_hynix_hbm_trillion_case",
        "MEMORY_HBM_CAPACITY",
        "000660",
        ...
        ("round_147.md Reuters SK Hynix AI boom market value",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters SK Hynix record profit and buyback",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Samsung HBM4 shipment",),
    ...
    Round147CaseCandidate(
        ...
        "hbm_catchup_execution_candidate",
        "needs_price_backfill",
        ("round_147.md Reuters Samsung AMD AI memory MOU",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Samsung labor strike plan",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Micron consumer memory exit",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Kioxia AI profit", "round_147.md FT Kioxia profit surge"),
    ...
    Round147CaseCandidate(
        ...
        "semi_capex_aligned",
        "needs_price_backfill",
        ("round_147.md Reuters Applied Materials guidance",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Broadcom custom AI chip demand",),
    ...
    Round147CaseCandidate(
        ...
        "missing_price_data",
        ("round_147.md custom ASIC margin concentration guardrail",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Nvidia CoWoS-L reference",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Broadcom supply constraints",),
        "Optical networking/PCB bottleneck becomes stronger in Loop 9 because lead time expanded from weeks to months.",
        (E2RArchetype.ADVANCED_PACKAGING_PCB,),
    ),
    Round147CaseCandidate(
        "cisco_ai_networking_orders_case",
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Cisco AI orders",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Tower Semiconductor AI chip deals",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Foxconn Q1 profit",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Ecolab CoolIT acquisition",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md FT OpenAI CoreWeave contract",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters CoreWeave OpenAI expanded pact",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters CoreWeave circular financing watch",),
    ...
    Round147CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_147.md Reuters Supermicro EY resignation",),
    ...
    Round147CaseCandidate(
        ...
        "missing_price_data",
        ("round_147.md CXL/glass substrate guardrail",),
    ...
    Round147CaseCandidate(
        ...
        "theme_without_revenue",
        "missing_price_data",
        ("round_147.md FuriosaAI related stock watch",),
    ...
    Round147CaseCandidate(
        ...
        "missing_price_data",
        ("round_147.md AI CAPEX crowding overlay",),
...
ROUND147_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def round147_target_for(target_id: str) -> Round147ScoreTarget | None:
    for target in ROUND147_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round147_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND147_CASE_CANDIDATES:
        target = round147_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round147 R2 Loop-9 case for {candidate.target_id}; "
...
def round147_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round147_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND147_CASE_CANDIDATES:
        target = round147_target_for(candidate.target_id)
...
def round147_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round147_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round147_backfill": "true"} for field in ROUND147_PRICE_FIELDS)


def round147_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(weight.as_row() for weight in ROUND147_BASE_SCORE_WEIGHTS)


def round147_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_row() for cap in ROUND147_STAGE_CAPS)


def round147_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(alignment.as_row() for alignment in ROUND147_SCORE_STAGE_PRICE_ALIGNMENT)


def round147_summary() -> dict[str, int | bool]:
    records = round147_case_records()
    return {
        "target_count": len(ROUND147_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND147_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND147_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND147_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND147_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND147_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND147_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "hard_gate_target_count": sum(1 for target in ROUND147_SCORE_TARGETS if target.hard_gate),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round147_r2_loop9_reports(
    *,
    output_directory: str | Path = ROUND147_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND147_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND147_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round147_r2_loop9_ai_semiconductor_summary.md",
        "case_matrix": output / "round147_r2_loop9_case_matrix.csv",
        "stage_date_plan": output / "round147_r2_loop9_stage_date_plan.csv",
        "green_guardrails": output / "round147_r2_loop9_green_guardrails.md",
        "loop9_risk_overlays": output / "round147_r2_loop9_risk_overlays.md",
        "price_validation_plan": output / "round147_r2_loop9_price_validation_plan.md",
        "price_fields": output / "round147_r2_loop9_price_fields.csv",
        "base_score_weights": output / "round147_r2_loop9_base_score_weights.csv",
        "stage_caps": output / "round147_r2_loop9_stage_caps.csv",
        "score_stage_price_alignment": output / "round147_r2_loop9_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round147_r2_loop9_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round147_case_records(), cases)
    _write_rows(round147_score_profile_rows(), score_profiles)
    _write_rows(round147_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round147_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round147_price_field_rows(), paths["price_fields"])
    _write_rows(round147_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round147_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round147_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round147_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round147_green_guardrail_markdown(), encoding="utf-8")
    paths["loop9_risk_overlays"].write_text(render_round147_loop9_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round147_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(render_round147_score_stage_price_alignment_markdown(), encoding="utf-8")
    return paths


def render_round147_summary_markdown() -> str:
    summary = round147_summary()
    lines = [
        "# Round-147 R2 Loop-9 AI / Semiconductor / Electronics Summary",
        "",
        f"- source_round: `{ROUND147_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R2 Loop 9 says `AI 수혜` is not a score bucket.",
...
def render_round147_green_guardrail_markdown() -> str:
    lines = [
        "# Round-147 R2 Loop-9 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R2 Loop-9 v9.0 weights to production scoring yet.",
...
def render_round147_loop9_risk_overlay_markdown() -> str:
    lines = [
        "# Round-147 R2 Loop-9 Risk Overlays",
        "",
...
def render_round147_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-147 R2 Loop-9 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round147_case_candidate_rows():
...
def render_round147_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-147 R2 Loop-9 Score -> Stage -> Price Alignment",
        "",
        "Round 147 uses the R2 v9 score table to test whether AI/semiconductor evidence produced the right stage and whether that stage matched the observed price path in the source note.",
        "",
        "## R2 v9 Base Score Weights",
        "",
        "| component | points | direction | reason |",
        "| --- | ---: | --- | --- |",
    ]
    for row in round147_base_score_weight_rows():
    ...
    for row in round147_stage_cap_rows():
        lines.append(
            "| "
    ...
    for row in round147_score_stage_price_alignment_rows():
        lines.append(
            "| "
...
def _score_price_alignment(candidate: Round147CaseCandidate) -> str:
...
def _rerating_result(candidate: Round147CaseCandidate) -> str:
...
def _score_weight_hint(target: Round147ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
