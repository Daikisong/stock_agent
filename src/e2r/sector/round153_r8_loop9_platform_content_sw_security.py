"""Round-153 R8 Loop-9 platform/content/software/security pack.

Round 153 tightens the R8 platform/content/software/security pack. It separates
...
ROUND153_SOURCE_ROUND_PATH = "docs/round/round_153.md"
ROUND153_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round153_r8_loop9_platform_content_sw_security"
ROUND153_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r8_loop9_round153.jsonl"
ROUND153_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round153_r8_loop9_v9.csv"


@dataclass(frozen=True)
class Round153ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round153ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round153ScoreWeightDraft
...
GATE_WEIGHT = Round153ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")
GATE_INFO5_WEIGHT = Round153ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", 5)
CAP_WEIGHT = Round153ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+")


ROUND153_BASE_SCORE_AXES: tuple[Round153BaseScoreAxis, ...] = (
    Round153BaseScoreAxis(
    ...
    Round153BaseScoreAxis(
        ...
        "Rerating room exists only when the market still uses the old frame while repeat economics are improving; Loop 9 shifts weight from narrative rerating to evidence quality.",
    ),
    Round153BaseScoreAxis(
    ...
    Round153BaseScoreAxis(
        ...
        "Operational trust and legal/data quality are hard Loop 9 gates; CrowdStrike, Roblox, Meta, and Netflix-style events can cap or break Stage 3.",
    ),
)


ROUND153_SCORE_TARGETS: tuple[Round153ScoreTarget, ...] = (
    Round153ScoreTarget(
        "PLATFORM_SOFTWARE_INTERNET",
        E2RArchetype.PLATFORM_SOFTWARE_INTERNET,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(18, 18, 7, 15, 13, 1, 5),
    ...
    Round153ScoreTarget(
        ...
        Round153ScoreWeightDraft(20, 23, 7, 15, 13, 1, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round153ScoreWeightDraft(23, 23, 10, 16, 9, 0, 6),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(23, 24, 11, 15, 10, 0, 6),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round153ScoreWeightDraft(22, 23, 9, 16, 10, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(20, 21, 12, 14, 9, 2, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(20, 19, 9, 15, 12, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(20, 21, 8, 14, 11, 0, 6),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(21, 22, 8, 15, 10, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(19, 20, 8, 14, 13, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(18, 16, 6, 13, 10, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(10, 8, 4, 10, 6, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(17, 14, 5, 12, 8, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(16, 14, 6, 12, 9, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(18, 18, 7, 14, 8, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(20, 21, 8, 14, 11, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(21, 21, 10, 14, 11, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(21, 21, 13, 13, 9, 2, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round153ScoreWeightDraft(20, 20, 10, 14, 11, 0, 5),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round153ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", 6),
    ...
    Round153ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round153ScoreWeightDraft(5, 5, 5, 6, 5, 0, 3),
...
ROUND153_CASE_CANDIDATES: tuple[Round153CaseCandidate, ...] = (
    Round153CaseCandidate(
        ...
        ("round_153.md Reuters EQT Douzone Bizon",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md MarketWatch Palantir Q4 2025",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md MarketWatch Palantir Q1 2026",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Barrons Akamai frontier model AI cloud deal",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Barrons Akamai AI cloud revenue contribution",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Barrons Datadog observability",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Barrons Dynatrace ARR guidance risk",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Barrons Fortinet billings",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters Cisco AI infrastructure orders",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md The Verge Netflix ad ambitions",),
    ...
    Round153CaseCandidate(
        ...
        "adtech_premium_miss",
        "needs_price_backfill",
        ("round_153.md Barron's Trade Desk revenue miss",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters CrowdStrike shareholder lawsuit",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters Kakao founder legal case",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters Roblox safety forecast cut",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md GTA VI preorder rumor",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters WPP ad forecast cut",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters Netflix Texas privacy lawsuit",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters Meta scam ads lawsuit",),
    ...
    Round153CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_153.md Reuters Meta youth safety trial",),
    ...
    Round153CaseCandidate(
        ...
        ("round_153.md Reuters Breakingviews SaaSpocalypse",),
...
ROUND153_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
ROUND153_RISK_OVERLAYS: tuple[str, ...] = (
...
def round153_target_for(target_id: str) -> Round153ScoreTarget | None:
    for target in ROUND153_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round153_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND153_CASE_CANDIDATES:
        target = round153_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round153 R8 Loop-9 case for {candidate.target_id}; "
...
def round153_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round153_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for axis in ROUND153_BASE_SCORE_AXES
    )


def round153_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND153_CASE_CANDIDATES:
        target = round153_target_for(candidate.target_id)
...
def round153_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round153_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round153_backfill": "true"} for field in ROUND153_PRICE_FIELDS)


def round153_summary() -> dict[str, int | bool]:
    records = round153_case_records()
    return {
        "target_count": len(ROUND153_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND153_BASE_SCORE_AXES),
        ...
        "green_possible_count": sum(1 for target in ROUND153_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND153_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND153_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND153_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round153_r8_loop9_reports(
    *,
    output_directory: str | Path = ROUND153_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND153_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND153_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round153_r8_loop9_platform_content_sw_security_summary.md",
        "case_matrix": output / "round153_r8_loop9_case_matrix.csv",
        "stage_date_plan": output / "round153_r8_loop9_stage_date_plan.csv",
        "base_score_axes": output / "round153_r8_loop9_base_score_axes.csv",
        "green_guardrails": output / "round153_r8_loop9_green_guardrails.md",
        "risk_overlays": output / "round153_r8_loop9_risk_overlays.md",
        "price_validation_plan": output / "round153_r8_loop9_price_validation_plan.md",
        "price_fields": output / "round153_r8_loop9_price_fields.csv",
    }
    _write_case_jsonl(round153_case_records(), cases)
    _write_rows(round153_score_profile_rows(), score_profiles)
    _write_rows(round153_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round153_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round153_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round153_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round153_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round153_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round153_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round153_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round153_summary_markdown() -> str:
    summary = round153_summary()
    lines = [
        "# Round 153 R8 Loop-9 Platform/Content/SW/Security Summary",
        "",
        "Round 153 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round153_green_guardrail_markdown() -> str:
    lines = [
        "# Round 153 R8 Loop-9 Green Guardrails",
        "",
        "- Do not apply R8 Loop-9 v9.0 weights to production scoring yet.",
...
def render_round153_risk_overlay_markdown() -> str:
    lines = ["# Round 153 R8 Loop-9 Risk Overlays", ""]
    for overlay in ROUND153_RISK_OVERLAYS:
...
def render_round153_price_validation_plan_markdown() -> str:
    lines = [
        "# Round 153 R8 Loop-9 Price Validation Plan",
        "",
        "For every case, backfill stage prices and forward MFE/MAE before applying score-weight changes.",
        "",
        "## Priority Cases",
    ]
    for row in round153_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND153_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round153CaseCandidate) -> str:
...
def _rerating_result(candidate: Round153CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round153ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
