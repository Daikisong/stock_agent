"""Round-157 R12 Loop-9 agriculture, life services, and miscellaneous pack.

Round 157 tightens the R12 unit-economics pack from Round 104. Agriculture,
...
Loop 9 reinforces the cycle and regulation splitters from the prior R12 pass:
...
ROUND157_SOURCE_ROUND_PATH = "docs/round/round_157.md"
ROUND157_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round157_r12_loop9_agri_life_misc"
ROUND157_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r12_loop9_round157.jsonl"
ROUND157_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round157_r12_loop9_v9.csv"


@dataclass(frozen=True)
class Round157ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round157ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round157ScoreWeightDraft
...
ROUND157_BASE_SCORE_AXES: tuple[Round157BaseScoreAxis, ...] = (
    Round157BaseScoreAxis(
...
ROUND157_STAGE_CAPS: tuple[Round157StageCap, ...] = (
    Round157StageCap(
...
ROUND157_SCORE_TARGETS: tuple[Round157ScoreTarget, ...] = (
    Round157ScoreTarget(
        "SMART_FARM_AGRI_TECH",
        E2RArchetype.SMART_FARM_AGRI_TECH,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(17, 13, 12, 9, 8, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round157ScoreWeightDraft(8, 6, 5, 7, 5, 0, 4),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(16, 13, 10, 10, 9, 1, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(14, 11, 8, 9, 7, 1, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(16, 14, 9, 11, 9, 1, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round157ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(18, 16, 11, 12, 10, 1, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(18, 11, 14, 9, 8, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(16, 12, 13, 10, 8, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round157ScoreWeightDraft(18, 8, 14, 8, 7, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(18, 16, 8, 11, 9, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(14, 12, 8, 10, 8, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(17, 16, 5, 12, 10, 2, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(16, 15, 5, 12, 9, 1, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round157ScoreWeightDraft(10, 8, 4, 8, 5, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(14, 10, 5, 8, 6, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(15, 13, 7, 10, 8, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(18, 15, 8, 12, 10, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(16, 13, 8, 10, 8, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round157ScoreWeightDraft(16, 14, 8, 11, 8, 0, 5),
    ...
    Round157ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round157ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND157_CASE_CANDIDATES: tuple[Round157CaseCandidate, ...] = (
    Round157CaseCandidate(
    ...
    Round157CaseCandidate(
        ...
        "needs_price_backfill",
        ("Round 157 Chegg AI search disintermediation synthesis",),
...
ROUND157_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round157ScoreTarget | None:
    for target in ROUND157_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round157_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND157_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round157 R12 Loop-9 case for {candidate.target_id}; "
...
def round157_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round157_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND157_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round157_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round157_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round157_backfill": "true"} for field in ROUND157_PRICE_FIELDS)


def round157_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_csv_dict() for axis in ROUND157_BASE_SCORE_AXES)


def round157_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND157_STAGE_CAPS)


def round157_summary() -> dict[str, int | bool]:
    records = round157_case_records()
    return {
        "target_count": len(ROUND157_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND157_BASE_SCORE_AXES),
        "stage_cap_count": len(ROUND157_STAGE_CAPS),
        ...
        "green_possible_count": sum(1 for target in ROUND157_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND157_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND157_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND157_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round157_r12_loop9_reports(
    *,
    output_directory: str | Path = ROUND157_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND157_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND157_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round157_r12_loop9_agri_life_misc_summary.md",
        "case_matrix": output / "round157_r12_loop9_case_matrix.csv",
        "stage_date_plan": output / "round157_r12_loop9_stage_date_plan.csv",
        "green_guardrails": output / "round157_r12_loop9_green_guardrails.md",
        "unit_economics_caps": output / "round157_r12_loop9_unit_economics_caps.md",
        "price_validation_plan": output / "round157_r12_loop9_price_validation_plan.md",
        "price_fields": output / "round157_r12_loop9_price_fields.csv",
        "base_score_axes": output / "round157_r12_loop9_base_score_axes.csv",
        "stage_caps": output / "round157_r12_loop9_stage_caps.csv",
    }
    _write_case_jsonl(round157_case_records(), cases)
    _write_rows(round157_score_profile_rows(), score_profiles)
    _write_rows(round157_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round157_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round157_price_field_rows(), paths["price_fields"])
    _write_rows(round157_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round157_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round157_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round157_green_guardrail_markdown(), encoding="utf-8")
    paths["unit_economics_caps"].write_text(render_round157_unit_economics_cap_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round157_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round157_summary_markdown() -> str:
    summary = round157_summary()
    lines = [
        "# Round-157 R12 Loop-9 Agriculture / Life Services / Misc Summary",
        "",
        f"- source_round: `{ROUND157_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R12 Loop-9 separates recurring FCF from disease, weather, policy, AI, hardware, and regulation headlines.",
        ...
        "",
        "## R12 v9 Base Score Axes",
        "",
    ]
    for axis in ROUND157_BASE_SCORE_AXES:
    ...
    for cap in ROUND157_STAGE_CAPS:
...
def render_round157_green_guardrail_markdown() -> str:
    lines = [
        "# Round-157 R12 Loop-9 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply these R12 Loop-9 v9 weights to production scoring yet.",
...
def render_round157_unit_economics_cap_markdown() -> str:
    lines = [
        "# Round-157 R12 Loop-9 Unit-Economics / Cycle Caps",
        "",
...
def render_round157_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-157 R12 Loop-9 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round157_case_candidate_rows():
...
def _score_price_alignment(candidate: Round157CaseCandidate) -> str:
...
def _rerating_result(candidate: Round157CaseCandidate) -> str:
...
__all__ = [
    "ROUND157_BASE_SCORE_AXES",
    "ROUND157_CASE_CANDIDATES",
    "ROUND157_DEFAULT_CASES_PATH",
    "ROUND157_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND157_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND157_PRICE_FIELDS",
    "ROUND157_SCORE_TARGETS",
    "ROUND157_SOURCE_ROUND_PATH",
    "ROUND157_STAGE_CAPS",
    "Round157BaseScoreAxis",
    "Round157CaseCandidate",
    "Round157ScoreTarget",
    "Round157ScoreWeightDraft",
    "Round157StageCap",
    "render_round157_green_guardrail_markdown",
    "render_round157_price_validation_plan_markdown",
    "render_round157_summary_markdown",
    "render_round157_unit_economics_cap_markdown",
    "round157_base_score_axis_rows",
    "round157_case_candidate_rows",
    "round157_case_records",
    "round157_price_field_rows",
    "round157_score_profile_rows",
    "round157_stage_date_rows",
    "round157_stage_cap_rows",
    "round157_summary",
    "target_for",
    "write_round157_r12_loop9_reports",
]
