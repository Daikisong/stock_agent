"""Round-60 R7 Loop-2 biotech, healthcare, and medical-device pack.

Round 60 tightens the Round-47 healthcare pack. It separates approvals,
...
ROUND60_SOURCE_ROUND_PATH = "docs/round/round_60.md"
ROUND60_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round60_r7_loop2_biotech_healthcare_device"
ROUND60_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r7_loop2_round60.jsonl"
ROUND60_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round60_r7_loop2_v2.csv"


@dataclass(frozen=True)
class Round60ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round60ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round60ScoreWeightDraft
...
GATE_WEIGHT = Round60ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND60_SCORE_TARGETS: tuple[Round60ScoreTarget, ...] = (
    Round60ScoreTarget(
        "CDMO_HEALTHCARE_CONTRACT",
        E2RArchetype.CDMO_HEALTHCARE_CONTRACT,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round60ScoreWeightDraft(20, 24, 12, 12, 12, 0, 5),
    ...
    Round60ScoreTarget(
        ...
        Round60ScoreWeightDraft(17, 18, 7, 11, 10, 0, 5),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round60ScoreWeightDraft(18, 19, 6, 12, 10, 0, 6),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round60ScoreWeightDraft(19, 18, 8, 13, 11, 2, 6),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round60ScoreWeightDraft(22, 20, 12, 13, 11, 0, 6),
    ...
    Round60ScoreTarget(
        ...
        Round60ScoreWeightDraft(7, 11, 8, 9, 5, 0, 5),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round60ScoreWeightDraft(6, 10, 7, 12, 6, 0, 5),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round60ScoreWeightDraft(18, 17, 8, 13, 12, 0, 7),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round60ScoreWeightDraft(17, 17, 7, 12, 10, 1, 6),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round60ScoreWeightDraft(16, 14, 5, 11, 8, 0, 6),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round60ScoreWeightDraft(20, 22, 13, 14, 12, 0, 5),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round60ScoreWeightDraft(19, 20, 12, 13, 11, 0, 5),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round60ScoreWeightDraft(20, 5, 5, 5, 5, 0, 5),
    ...
    Round60ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round60ScoreWeightDraft(16, 14, 8, 10, 8, 0, 5),
        ...
        ("policy_budget", "recurring_prevention", "inventory"),
        "Animal health is Watch unless recurring prevention demand survives after the disease event.",
    ),
)


ROUND60_CASE_CANDIDATES: tuple[Round60CaseCandidate, ...] = (
    Round60CaseCandidate(
        ...
        ("round_60.md Reuters Samsung Biologics GSK US facility",),
    ...
    Round60CaseCandidate(
        ...
        ("round_60.md Samsung Biologics CDMO structure reference",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Straumann dental implant growth",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Lilly oral GLP-1 approval",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Foundayo scripts uptake",),
    ...
    Round60CaseCandidate(
        ...
        ("round_60.md Reuters Humira biosimilar GoodRx access",),
    ...
    Round60CaseCandidate(
        ...
        "glp1_4b_to_4c",
        "needs_price_backfill",
        ("round_60.md Reuters Novo 2026 outlook warning",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Hims GLP-1 revenue miss",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Hims Novo partnership",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Hims compounded GLP-1 crackdown",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters bluebird bio take-private cash crunch",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Charles River forecast cut",),
        "CRO is service revenue, but funding-cycle cuts can break backlog and forecast visibility.",
    ),
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Teladoc record low",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md Reuters Recursion Exscientia merger",),
    ...
    Round60CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_60.md arXiv Lunit DBT subgroup performance",),
...
def target_for(target_id: str) -> Round60ScoreTarget | None:
...
def round60_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND60_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round60 R7 Loop-2 case for {candidate.target_id}; "
...
def round60_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round60_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND60_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round60_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round60_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round60_backfill": "true"} for field in ROUND60_PRICE_FIELDS)


def round60_summary() -> dict[str, int | bool]:
    records = round60_case_records()
    return {
        "target_count": len(ROUND60_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND60_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND60_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND60_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND60_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round60_r7_loop2_reports(
    *,
    output_directory: str | Path = ROUND60_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND60_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND60_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round60_r7_loop2_biotech_healthcare_device_summary.md",
        "case_matrix": output / "round60_r7_loop2_case_matrix.csv",
        "stage_date_plan": output / "round60_r7_loop2_stage_date_plan.csv",
        "green_guardrails": output / "round60_r7_loop2_green_guardrails.md",
        "risk_overlays": output / "round60_r7_loop2_risk_overlays.md",
        "price_validation_plan": output / "round60_r7_loop2_price_validation_plan.md",
        "price_fields": output / "round60_r7_loop2_price_fields.csv",
    }
    _write_case_jsonl(round60_case_records(), cases)
    _write_rows(round60_score_profile_rows(), score_profiles)
    _write_rows(round60_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round60_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round60_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round60_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round60_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round60_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round60_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round60_summary_markdown() -> str:
    summary = round60_summary()
    lines = [
        "# Round-60 R7 Loop-2 Biotech / Healthcare / Medical Device Summary",
        "",
        f"- source_round: `{ROUND60_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R7 Loop 2 says approval, clinical success, AI papers, and TAM are not commercialization by themselves.",
...
def render_round60_green_guardrail_markdown() -> str:
    lines = [
...
def render_round60_risk_overlay_markdown() -> str:
    lines = [
        "# Round-60 R7 Loop-2 Risk Overlays",
        "",
...
def render_round60_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round60_case_candidate_rows():
...
def _score_price_alignment(candidate: Round60CaseCandidate) -> str:
...
def _rerating_result(candidate: Round60CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round60ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    ...
    "ROUND60_DEFAULT_CASES_PATH",
    "ROUND60_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND60_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND60_PRICE_FIELDS",
    "ROUND60_SCORE_TARGETS",
    "Round60CaseCandidate",
    "Round60ScoreTarget",
    "Round60ScoreWeightDraft",
