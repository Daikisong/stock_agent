"""Round-113 R8 Loop-6 platform/content/software/security pack.

Round 113 tightens the R8 platform/content/software/security pack. It separates
...
ROUND113_SOURCE_ROUND_PATH = "docs/round/round_113.md"
ROUND113_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round113_r8_loop6_platform_content_sw_security"
ROUND113_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r8_loop6_round113.jsonl"
ROUND113_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round113_r8_loop6_v6.csv"


@dataclass(frozen=True)
class Round113ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round113ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round113ScoreWeightDraft
...
GATE_WEIGHT = Round113ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")
GATE_INFO5_WEIGHT = Round113ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", 5)
CAP_WEIGHT = Round113ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+")


ROUND113_SCORE_TARGETS: tuple[Round113ScoreTarget, ...] = (
    Round113ScoreTarget(
        "PLATFORM_SOFTWARE_INTERNET",
        E2RArchetype.PLATFORM_SOFTWARE_INTERNET,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(18, 18, 7, 15, 13, 1, 5),
    ...
    Round113ScoreTarget(
        ...
        Round113ScoreWeightDraft(20, 23, 7, 15, 13, 1, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round113ScoreWeightDraft(23, 23, 10, 16, 9, 0, 6),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(23, 24, 11, 15, 10, 0, 6),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round113ScoreWeightDraft(22, 23, 9, 16, 10, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(20, 21, 12, 14, 9, 2, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(20, 19, 9, 15, 12, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(20, 21, 8, 14, 11, 0, 6),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(21, 22, 8, 15, 10, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(19, 20, 8, 14, 13, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(18, 16, 6, 13, 10, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(10, 8, 4, 10, 6, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(17, 14, 5, 12, 8, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(16, 14, 6, 12, 9, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(18, 18, 7, 14, 8, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(20, 21, 8, 14, 11, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(21, 21, 10, 14, 11, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round113ScoreWeightDraft(20, 20, 10, 14, 11, 0, 5),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round113ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", 6),
    ...
    Round113ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round113ScoreWeightDraft(5, 5, 5, 6, 5, 0, 3),
...
ROUND113_CASE_CANDIDATES: tuple[Round113CaseCandidate, ...] = (
    Round113CaseCandidate(
        ...
        ("round_113.md Reuters EQT Douzone Bizon",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md MarketWatch Palantir Q4 2025",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md MarketWatch Palantir Q1 2026",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Barrons Akamai frontier model AI cloud deal",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Barrons Akamai AI cloud revenue contribution",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Barrons Datadog observability",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Barrons Dynatrace ARR guidance risk",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Barrons Fortinet billings",),
    ...
    Round113CaseCandidate(
        ...
        None,
        None,
        ("ai_infrastructure_orders", "hyperscaler_ai_orders", "data_center_switching_orders", "guidance_raise"),
        ("restructuring_cost", "workforce_reduction", "legacy_networking_mix", "margin_conversion_unverified"),
        "ai_networking_infra_stage2_restructuring_watch",
        "needs_price_backfill",
        ("round_113.md Reuters Cisco AI infrastructure orders",),
        "AI networking orders support Stage 2 only when orders convert into revenue, margin, and FCF after restructuring costs.",
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md The Verge Netflix ad ambitions",),
    ...
    Round113CaseCandidate(
        ...
        "adtech_premium_miss",
        "needs_price_backfill",
        ("round_113.md Barron's Trade Desk revenue miss",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Reuters CrowdStrike shareholder lawsuit",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Reuters Kakao founder legal case",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Reuters Roblox safety forecast cut",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md GTA VI preorder rumor",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Reuters WPP ad forecast cut",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Reuters Netflix Texas privacy lawsuit",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Reuters Meta scam ads lawsuit",),
    ...
    Round113CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_113.md Reuters Meta youth safety trial",),
    ...
    Round113CaseCandidate(
        ...
        ("round_113.md Reuters Breakingviews SaaSpocalypse",),
...
ROUND113_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
ROUND113_RISK_OVERLAYS: tuple[str, ...] = (
...
def round113_target_for(target_id: str) -> Round113ScoreTarget | None:
    for target in ROUND113_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round113_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND113_CASE_CANDIDATES:
        target = round113_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round113 R8 Loop-6 case for {candidate.target_id}; "
...
def round113_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round113_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND113_CASE_CANDIDATES:
        target = round113_target_for(candidate.target_id)
...
def round113_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round113_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round113_backfill": "true"} for field in ROUND113_PRICE_FIELDS)


def round113_summary() -> dict[str, int | bool]:
    records = round113_case_records()
    return {
        "target_count": len(ROUND113_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND113_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND113_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND113_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND113_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round113_r8_loop6_reports(
    *,
    output_directory: str | Path = ROUND113_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND113_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND113_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round113_r8_loop6_platform_content_sw_security_summary.md",
        "case_matrix": output / "round113_r8_loop6_case_matrix.csv",
        "stage_date_plan": output / "round113_r8_loop6_stage_date_plan.csv",
        "green_guardrails": output / "round113_r8_loop6_green_guardrails.md",
        "risk_overlays": output / "round113_r8_loop6_risk_overlays.md",
        "price_validation_plan": output / "round113_r8_loop6_price_validation_plan.md",
        "price_fields": output / "round113_r8_loop6_price_fields.csv",
    }
    _write_case_jsonl(round113_case_records(), cases)
    _write_rows(round113_score_profile_rows(), score_profiles)
    _write_rows(round113_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round113_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round113_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round113_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round113_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round113_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round113_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round113_summary_markdown() -> str:
    summary = round113_summary()
    lines = [
        "# Round 113 R8 Loop-6 Platform/Content/SW/Security Summary",
        "",
        "Round 113 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
...
def render_round113_green_guardrail_markdown() -> str:
    lines = [
        "# Round 113 R8 Loop-6 Green Guardrails",
        "",
        "- Do not apply R8 Loop-6 v6.0 weights to production scoring yet.",
...
def render_round113_risk_overlay_markdown() -> str:
    lines = ["# Round 113 R8 Loop-6 Risk Overlays", ""]
    for overlay in ROUND113_RISK_OVERLAYS:
...
def render_round113_price_validation_plan_markdown() -> str:
    lines = [
        "# Round 113 R8 Loop-6 Price Validation Plan",
        "",
        "For every case, backfill stage prices and forward MFE/MAE before applying score-weight changes.",
        "",
        "## Priority Cases",
    ]
    for row in round113_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "",
            ", ".join(ROUND113_PRICE_FIELDS),
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round113CaseCandidate) -> str:
...
def _rerating_result(candidate: Round113CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round113ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
