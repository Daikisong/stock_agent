"""Round-135 R3 Loop-8 battery, EV, and green-energy pack.

Round 135 turns the R3 battery/EV/green-energy pack into a score-stage-price
...
ROUND135_SOURCE_ROUND_PATH = "docs/round/round_135.md"
ROUND135_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round135_r3_loop8_battery_ev_green"
ROUND135_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r3_loop8_round135.jsonl"
ROUND135_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round135_r3_loop8_v8.csv"


@dataclass(frozen=True)
class Round135ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round135ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round135ScoreWeightDraft
...
@dataclass(frozen=True)
class Round135ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
) -> Round135ScoreWeightDraft:
    return Round135ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round135ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND135_BASE_SCORE_WEIGHTS: tuple[Round135BaseScoreWeight, ...] = (
    Round135BaseScoreWeight(
...
ROUND135_STAGE_CAPS: tuple[Round135StageCap, ...] = (
    Round135StageCap(
        "narrative_only_cap",
        "Stage 1",
...
ROUND135_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round135ScoreStagePriceAlignment, ...] = (
    Round135ScoreStagePriceAlignment(
...
ROUND135_SCORE_TARGETS: tuple[Round135ScoreTarget, ...] = (
    _target(
        ...
        note="Loop 8 lowers battery-material scores because EV CAPA, idle plants, and contract cancellations can quickly become 4C.",
    ),
    _target(
...
ROUND135_CASE_CANDIDATES: tuple[Round135CaseCandidate, ...] = (
    Round135CaseCandidate(
        ...
        ("round_135.md Reuters LGES $4.3B LFP contract",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters Tesla-LGES Megapack 3 Lansing confirmation",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters SK On Flatiron ESS deal",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters GM-LG Ohio battery plant",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters SK On Ford JV dissolution",),
    ...
    Round135CaseCandidate(
        ...
        ("round_135.md Financial Times Ford Energy storage pivot",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters Ford LGES contract cancellation",),
    ...
    Round135CaseCandidate(
        ...
        "ev_battery_contract_cancellation_hard_4c",
        "needs_price_backfill",
        ("round_135.md LGES-Freudenberg contract cancellation",),
    ...
    Round135CaseCandidate(
        ...
        ("round_135.md Reuters Redwood recycling funding",),
    ...
    Round135CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_135.md second-life battery grid storage SOH guardrail",),
    ...
    Round135CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_135.md arXiv graphite battery supply security",),
    ...
    Round135CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_135.md Reuters EQT KJ Environment platform",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters Hyundai hydrogen fuel-cell plant",),
    ...
    Round135CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_135.md Reuters Qcells customs detention",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters Orsted Sunrise Wind impairment",),
    ...
    Round135CaseCandidate(
        ...
        "missing_price_data",
        ("round_135.md Reuters lithium prices after crash",),
    ...
    Round135CaseCandidate(
        ...
        "missing_price_data",
        ("round_135.md Reuters energy storage lithium demand",),
    ...
    Round135CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_135.md Reuters lithium ESS demand sodium-ion risk",),
    ...
    Round135CaseCandidate(
        ...
        "missing_price_data",
        ("round_135.md Reuters Korea EV battery certification",),
    ...
    Round135CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_135.md Guardian Moss Landing battery storage fire",),
    ...
    Round135CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_135.md arXiv battery health validation",),
    ...
    Round135CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_135.md Reuters Volkswagen QuantumScape solid-state license",),
    ...
    Round135CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_135.md speculative battery technology guardrail",),
...
ROUND135_PRICE_FIELDS: tuple[str, ...] = (
...
def round135_target_for(target_id: str) -> Round135ScoreTarget | None:
    for target in ROUND135_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round135_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND135_CASE_CANDIDATES:
        target = round135_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round135 R3 Loop-8 case for {candidate.target_id}; "
...
def round135_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round135_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND135_CASE_CANDIDATES:
        target = round135_target_for(candidate.target_id)
...
def round135_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round135_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round135_backfill": "true"} for field in ROUND135_PRICE_FIELDS)


def round135_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND135_BASE_SCORE_WEIGHTS
    )


def round135_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND135_STAGE_CAPS
    )


def round135_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND135_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round135_summary() -> dict[str, int | bool]:
    records = round135_case_records()
    return {
        "target_count": len(ROUND135_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND135_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND135_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND135_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND135_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND135_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND135_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND135_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round135_r3_loop8_reports(
    *,
    output_directory: str | Path = ROUND135_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND135_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND135_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round135_r3_loop8_battery_ev_green_summary.md",
        "case_matrix": output / "round135_r3_loop8_case_matrix.csv",
        "stage_date_plan": output / "round135_r3_loop8_stage_date_plan.csv",
        "green_guardrails": output / "round135_r3_loop8_green_guardrails.md",
        "risk_overlays": output / "round135_r3_loop8_risk_overlays.md",
        "price_validation_plan": output / "round135_r3_loop8_price_validation_plan.md",
        "price_fields": output / "round135_r3_loop8_price_fields.csv",
        "base_score_weights": output / "round135_r3_loop8_base_score_weights.csv",
        "stage_caps": output / "round135_r3_loop8_stage_caps.csv",
        "score_stage_price_alignment": output / "round135_r3_loop8_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round135_r3_loop8_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round135_case_records(), cases)
    _write_rows(round135_score_profile_rows(), score_profiles)
    _write_rows(round135_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round135_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round135_price_field_rows(), paths["price_fields"])
    _write_rows(round135_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round135_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round135_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round135_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round135_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round135_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round135_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round135_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round135_summary_markdown() -> str:
    summary = round135_summary()
    lines = [
        "# Round-135 R3 Loop-8 Battery / EV / Green-Energy Summary",
        "",
        f"- source_round: `{ROUND135_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R3 Loop 8 says Stage 2 visibility and Stage 3 operating confirmation are different things.",
...
def render_round135_green_guardrail_markdown() -> str:
    lines = [
        "# Round-135 R3 Loop-8 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R3 Loop-8 v8.0 weights to production scoring yet.",
...
def render_round135_risk_overlay_markdown() -> str:
    lines = [
        "# Round-135 R3 Loop-8 Risk Overlays",
        "",
...
def render_round135_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round135_case_candidate_rows():
...
def render_round135_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-135 R3 Loop-8 Score / Stage / Price Alignment",
        "",
        "Round 135 checks whether the score table's stage interpretation matches the observed operating and price path.",
...
def _score_price_alignment(candidate: Round135CaseCandidate) -> str:
...
def _rerating_result(candidate: Round135CaseCandidate) -> str:
...
def _score_weight_hint(target: Round135ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
