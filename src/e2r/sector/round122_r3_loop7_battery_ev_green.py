"""Round-122 R3 Loop-7 battery, EV, and green-energy pack.

Round 122 turns the R3 battery/EV/green-energy pack into a score-stage-price
...
ROUND122_SOURCE_ROUND_PATH = "docs/round/round_122.md"
ROUND122_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round122_r3_loop7_battery_ev_green"
ROUND122_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r3_loop7_round122.jsonl"
ROUND122_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round122_r3_loop7_v7.csv"


@dataclass(frozen=True)
class Round122ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round122ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round122ScoreWeightDraft
...
@dataclass(frozen=True)
class Round122ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
) -> Round122ScoreWeightDraft:
    return Round122ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round122ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND122_BASE_SCORE_WEIGHTS: tuple[Round122BaseScoreWeight, ...] = (
    Round122BaseScoreWeight(
    ...
    Round122BaseScoreWeight(
        ...
        10,
        "계약취소, 고객/용도 비공개, UFLPA, BESS fire, SOH opacity 같은 정보·규제 리스크를 별도 축으로 본다.",
    ),
)


ROUND122_STAGE_CAPS: tuple[Round122StageCap, ...] = (
    Round122StageCap(
        "narrative_only_cap",
        "Stage 1",
...
ROUND122_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round122ScoreStagePriceAlignment, ...] = (
    Round122ScoreStagePriceAlignment(
...
ROUND122_SCORE_TARGETS: tuple[Round122ScoreTarget, ...] = (
    _target(
        ...
        note="Loop 7 lowers battery-material scores because EV CAPA, idle plants, and contract cancellations can quickly become 4C.",
    ),
    _target(
...
ROUND122_CASE_CANDIDATES: tuple[Round122CaseCandidate, ...] = (
    Round122CaseCandidate(
        ...
        ("round_122.md Reuters LGES $4.3B LFP contract",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters Tesla-LGES Megapack 3 Lansing confirmation",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters SK On Flatiron ESS deal",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters GM-LG Ohio battery plant",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters SK On Ford JV dissolution",),
    ...
    Round122CaseCandidate(
        ...
        ("round_122.md Financial Times Ford Energy storage pivot",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters Ford LGES contract cancellation",),
    ...
    Round122CaseCandidate(
        ...
        "ev_battery_contract_cancellation_hard_4c",
        "needs_price_backfill",
        ("round_122.md LGES-Freudenberg contract cancellation",),
    ...
    Round122CaseCandidate(
        ...
        ("round_122.md Reuters Redwood recycling funding",),
    ...
    Round122CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_122.md second-life battery grid storage SOH guardrail",),
    ...
    Round122CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_122.md arXiv graphite battery supply security",),
    ...
    Round122CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_122.md Reuters EQT KJ Environment platform",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters Hyundai hydrogen fuel-cell plant",),
    ...
    Round122CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_122.md Reuters Qcells customs detention",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters Orsted Sunrise Wind impairment",),
    ...
    Round122CaseCandidate(
        ...
        "missing_price_data",
        ("round_122.md Reuters lithium prices after crash",),
    ...
    Round122CaseCandidate(
        ...
        "missing_price_data",
        ("round_122.md Reuters energy storage lithium demand",),
    ...
    Round122CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_122.md Reuters lithium ESS demand sodium-ion risk",),
    ...
    Round122CaseCandidate(
        ...
        "missing_price_data",
        ("round_122.md Reuters Korea EV battery certification",),
    ...
    Round122CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_122.md Guardian Moss Landing battery storage fire",),
    ...
    Round122CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_122.md arXiv battery health validation",),
    ...
    Round122CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_122.md Reuters Volkswagen QuantumScape solid-state license",),
    ...
    Round122CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_122.md speculative battery technology guardrail",),
...
ROUND122_PRICE_FIELDS: tuple[str, ...] = (
...
def round122_target_for(target_id: str) -> Round122ScoreTarget | None:
    for target in ROUND122_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round122_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND122_CASE_CANDIDATES:
        target = round122_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round122 R3 Loop-7 case for {candidate.target_id}; "
...
def round122_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round122_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND122_CASE_CANDIDATES:
        target = round122_target_for(candidate.target_id)
...
def round122_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round122_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round122_backfill": "true"} for field in ROUND122_PRICE_FIELDS)


def round122_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND122_BASE_SCORE_WEIGHTS
    )


def round122_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND122_STAGE_CAPS
    )


def round122_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND122_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round122_summary() -> dict[str, int | bool]:
    records = round122_case_records()
    return {
        "target_count": len(ROUND122_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND122_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND122_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND122_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND122_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND122_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND122_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND122_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round122_r3_loop7_reports(
    *,
    output_directory: str | Path = ROUND122_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND122_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND122_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round122_r3_loop7_battery_ev_green_summary.md",
        "case_matrix": output / "round122_r3_loop7_case_matrix.csv",
        "stage_date_plan": output / "round122_r3_loop7_stage_date_plan.csv",
        "green_guardrails": output / "round122_r3_loop7_green_guardrails.md",
        "risk_overlays": output / "round122_r3_loop7_risk_overlays.md",
        "price_validation_plan": output / "round122_r3_loop7_price_validation_plan.md",
        "price_fields": output / "round122_r3_loop7_price_fields.csv",
        "base_score_weights": output / "round122_r3_loop7_base_score_weights.csv",
        "stage_caps": output / "round122_r3_loop7_stage_caps.csv",
        "score_stage_price_alignment": output / "round122_r3_loop7_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round122_r3_loop7_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round122_case_records(), cases)
    _write_rows(round122_score_profile_rows(), score_profiles)
    _write_rows(round122_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round122_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round122_price_field_rows(), paths["price_fields"])
    _write_rows(round122_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round122_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round122_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round122_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round122_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round122_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round122_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round122_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round122_summary_markdown() -> str:
    summary = round122_summary()
    lines = [
        "# Round-122 R3 Loop-7 Battery / EV / Green-Energy Summary",
        "",
        f"- source_round: `{ROUND122_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R3 Loop 7 says Stage 2 visibility and Stage 3 operating confirmation are different things.",
...
def render_round122_green_guardrail_markdown() -> str:
    lines = [
        "# Round-122 R3 Loop-7 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R3 Loop-7 v7.0 weights to production scoring yet.",
...
def render_round122_risk_overlay_markdown() -> str:
    lines = [
        "# Round-122 R3 Loop-7 Risk Overlays",
        "",
...
def render_round122_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-122 R3 Loop-7 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round122_case_candidate_rows():
...
def render_round122_score_stage_price_alignment_markdown() -> str:
    lines = [
...
def _score_price_alignment(candidate: Round122CaseCandidate) -> str:
...
def _rerating_result(candidate: Round122CaseCandidate) -> str:
...
def _score_weight_hint(target: Round122ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
