"""Round-136 R4 Loop-8 materials, spread, and strategic-resources pack.

Round 136 turns R4 into a score-stage-price alignment layer for chemicals,
...
ROUND136_SOURCE_ROUND_PATH = "docs/round/round_136.md"
ROUND136_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round136_r4_loop8_materials_spread_strategic"
ROUND136_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r4_loop8_round136.jsonl"
ROUND136_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round136_r4_loop8_v8.csv"


@dataclass(frozen=True)
class Round136ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round136ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round136ScoreWeightDraft
...
@dataclass(frozen=True)
class Round136ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
) -> Round136ScoreWeightDraft:
    return Round136ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round136ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND136_BASE_SCORE_WEIGHTS: tuple[Round136BaseScoreWeight, ...] = (
    Round136BaseScoreWeight(
        "eps_fcf_transition",
        22,
    ...
    Round136BaseScoreWeight(
        ...
        12,
        "Capital raise, share issuance, all-stock dilution, CAPEX burden, dividend cut, and buyback quality are stronger Loop-8 score axes.",
    ),
    Round136BaseScoreWeight(
...
ROUND136_STAGE_CAPS: tuple[Round136StageCap, ...] = (
    Round136StageCap(
...
ROUND136_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round136ScoreStagePriceAlignment, ...] = (
    Round136ScoreStagePriceAlignment(
...
ROUND136_SCORE_TARGETS: tuple[Round136ScoreTarget, ...] = (
    _target(
        "REFINING_OIL_SPREAD",
...
ROUND136_CASE_CANDIDATES: tuple[Round136CaseCandidate, ...] = (
    Round136CaseCandidate(
        "mp_materials_dod_price_floor_case",
        "RARE_METALS_PRICE_FLOOR_OFFTAKE",
        "MP",
        ...
        ("round_136.md AP MP Materials Pentagon agreement",),
    ...
    Round136CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_136.md AP MP Materials Apple magnet agreement",),
    ...
    Round136CaseCandidate(
        ...
        ("round_136.md Reuters MP Materials $500M offering",),
    ...
    Round136CaseCandidate(
        ...
        ("round_136.md Reuters rare-earth export controls",),
    ...
    Round136CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_136.md Reuters rare-earth approval delay",),
    ...
    Round136CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_136.md WSJ copper record high",),
    ...
    Round136CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_136.md Reuters sulfur squeeze Indonesian nickel sector",),
    ...
    Round136CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_136.md Reuters Barrick Q1 profit and buyback",),
    ...
    Round136CaseCandidate(
        ...
        "gold_miner_jurisdiction_rerating",
        "missing_direct_symbol_mapping",
        ("round_136.md Reuters Equinox Orla gold producer merger",),
    ...
    Round136CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_136.md Reuters POSCO Alaska LNG deal",),
    ...
    Round136CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_136.md Reuters SK Innovation Q1 profit",),
    ...
    Round136CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_136.md Reuters Korean petrochemical oversupply",),
    ...
    Round136CaseCandidate(
        ...
        "missing_price_data",
        ("round_136.md Reuters lithium prices after crash",),
    ...
    Round136CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_136.md FT BHP dividend cut",),
    ...
    Round136CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_136.md Reuters Korea Zinc tender offer",),
    ...
    Round136CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_136.md Reuters Korea Zinc share issuance probe",),
    ...
    Round136CaseCandidate(
        ...
        ("round_136.md Reuters International Paper DS Smith divestment",),
    ...
    Round136CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_136.md packaging consolidation remedy calibration",),
    ...
    Round136CaseCandidate(
        ...
        "missing_price_data",
        ("round_136.md advanced material speculative theme note",),
...
ROUND136_PRICE_FIELDS: tuple[str, ...] = (
...
def round136_target_for(target_id: str) -> Round136ScoreTarget | None:
    for target in ROUND136_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round136_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND136_CASE_CANDIDATES:
        target = round136_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round136 R4 Loop-8 case for {candidate.target_id}; "
...
def round136_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round136_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND136_CASE_CANDIDATES:
        target = round136_target_for(candidate.target_id)
...
def round136_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round136_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round136_backfill": "true"} for field in ROUND136_PRICE_FIELDS)


def round136_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND136_BASE_SCORE_WEIGHTS
    )


def round136_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND136_STAGE_CAPS
    )


def round136_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND136_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round136_summary() -> dict[str, int | bool]:
    records = round136_case_records()
    return {
        "target_count": len(ROUND136_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND136_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND136_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND136_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND136_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND136_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND136_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND136_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round136_r4_loop8_reports(
    *,
    output_directory: str | Path = ROUND136_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND136_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND136_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round136_r4_loop8_materials_spread_strategic_summary.md",
        "case_matrix": output / "round136_r4_loop8_case_matrix.csv",
        "stage_date_plan": output / "round136_r4_loop8_stage_date_plan.csv",
        "green_guardrails": output / "round136_r4_loop8_green_guardrails.md",
        "risk_overlays": output / "round136_r4_loop8_risk_overlays.md",
        "price_validation_plan": output / "round136_r4_loop8_price_validation_plan.md",
        "price_fields": output / "round136_r4_loop8_price_fields.csv",
        "base_score_weights": output / "round136_r4_loop8_base_score_weights.csv",
        "stage_caps": output / "round136_r4_loop8_stage_caps.csv",
        "score_stage_price_alignment": output / "round136_r4_loop8_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round136_r4_loop8_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round136_case_records(), cases)
    _write_rows(round136_score_profile_rows(), score_profiles)
    _write_rows(round136_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round136_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round136_price_field_rows(), paths["price_fields"])
    _write_rows(round136_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round136_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round136_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round136_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round136_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round136_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round136_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round136_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round136_summary_markdown() -> str:
    summary = round136_summary()
    lines = [
        "# Round-136 R4 Loop-8 Materials / Spread / Strategic Resources Summary",
        "",
        f"- source_round: `{ROUND136_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R4 Loop 8 says price increase and structural rerating are different things.",
...
def render_round136_green_guardrail_markdown() -> str:
    lines = [
        "# Round-136 R4 Loop-8 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R4 Loop-8 v8.0 weights to production scoring yet.",
...
def render_round136_risk_overlay_markdown() -> str:
    lines = [
        "# Round-136 R4 Loop-8 Risk Overlays",
        "",
...
def render_round136_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-136 R4 Loop-8 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round136_case_candidate_rows():
...
def render_round136_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-136 R4 Loop-8 Score / Stage / Price Alignment",
        "",
        "Round 136 checks whether R4 score interpretation matches the observed price, operating, and capital path.",
...
def _score_price_alignment(candidate: Round136CaseCandidate) -> str:
...
def _rerating_result(candidate: Round136CaseCandidate) -> str:
...
def _score_weight_hint(target: Round136ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND136_CASE_CANDIDATES",
    "ROUND136_DEFAULT_CASES_PATH",
    "ROUND136_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND136_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND136_PRICE_FIELDS",
    "ROUND136_BASE_SCORE_WEIGHTS",
    "ROUND136_SCORE_TARGETS",
    "ROUND136_SCORE_STAGE_PRICE_ALIGNMENT",
    "ROUND136_STAGE_CAPS",
    "Round136BaseScoreWeight",
    "Round136CaseCandidate",
    "Round136ScoreStagePriceAlignment",
    ...
    "Round136ScoreWeightDraft",
    "Round136StageCap",
    "render_round136_green_guardrail_markdown",
    "render_round136_price_validation_plan_markdown",
    "render_round136_risk_overlay_markdown",
    "render_round136_score_stage_price_alignment_markdown",
    "render_round136_summary_markdown",
    "round136_base_score_weight_rows",
    "round136_case_candidate_rows",
    "round136_case_records",
    "round136_price_field_rows",
    "round136_score_stage_price_alignment_rows",
    "round136_score_profile_rows",
    "round136_stage_cap_rows",
    "round136_stage_date_rows",
    "round136_summary",
    "round136_target_for",
    "write_round136_r4_loop8_reports",
]
