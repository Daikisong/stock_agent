"""Round-86 R7 Loop-4 biotech, healthcare, and medical-device pack.

Round 86 tightens the R7 healthcare pack. It separates approvals, clinical
...
ROUND86_SOURCE_ROUND_PATH = "docs/round/round_86.md"
ROUND86_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round86_r7_loop4_biotech_healthcare_device"
ROUND86_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r7_loop4_round86.jsonl"
ROUND86_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round86_r7_loop4_v4.csv"


@dataclass(frozen=True)
class Round86ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round86ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round86ScoreWeightDraft
...
GATE_WEIGHT = Round86ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND86_SCORE_TARGETS: tuple[Round86ScoreTarget, ...] = (
    Round86ScoreTarget(
        "CDMO_HEALTHCARE_CONTRACT",
        E2RArchetype.CDMO_HEALTHCARE_CONTRACT,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round86ScoreWeightDraft(20, 24, 12, 12, 12, 0, 5),
    ...
    Round86ScoreTarget(
        ...
        Round86ScoreWeightDraft(19, 21, 12, 12, 11, 0, 5),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(16, 17, 7, 11, 9, 0, 5),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(18, 18, 6, 12, 9, 0, 6),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round86ScoreWeightDraft(22, 20, 12, 13, 9, 0, 6),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(21, 19, 11, 13, 10, 0, 6),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(18, 15, 5, 13, 8, 0, 6),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round86ScoreWeightDraft(7, 10, 8, 9, 5, 0, 5),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round86ScoreWeightDraft(6, 10, 7, 12, 6, 0, 5),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(18, 17, 8, 13, 12, 0, 7),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(16, 16, 8, 13, 11, 0, 7),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(16, 16, 7, 12, 9, 1, 6),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round86ScoreWeightDraft(15, 13, 5, 10, 8, 0, 6),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round86ScoreWeightDraft(20, 22, 13, 14, 12, 0, 5),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round86ScoreWeightDraft(21, 23, 13, 14, 12, 1, 5),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round86ScoreWeightDraft(19, 20, 12, 13, 11, 0, 5),
    ...
    Round86ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round86ScoreWeightDraft(20, 5, 5, 5, 5, 0, 5),
...
ROUND86_CASE_CANDIDATES: tuple[Round86CaseCandidate, ...] = (
    Round86CaseCandidate(
        ...
        ("round_86.md Reuters Samsung Biologics GSK US facility",),
    ...
    Round86CaseCandidate(
        ...
        ("round_86.md Samsung Biologics CDMO structure reference",),
    ...
    Round86CaseCandidate(
        ...
        ("round_86.md Investors Intuitive Surgical Q1 2026",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Straumann dental implant growth",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Lilly oral GLP-1 approval",),
    ...
    Round86CaseCandidate(
        ...
        None,
        None,
        ("weekly_scripts", "prescriber_count", "sales_consensus_gap", "oral_glp1_flag", "real_world_adherence_signal"),
        ("slow_uptake", "coverage_unverified", "consensus_gap", "competition"),
        "approval_without_uptake_watch",
        "needs_price_backfill",
        ("round_86.md Reuters Foundayo scripts uptake",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Foundayo switch maintenance",),
    ...
    Round86CaseCandidate(
        ...
        ("round_86.md Reuters Humira biosimilar GoodRx access",),
    ...
    Round86CaseCandidate(
        ...
        "glp1_4b_to_4c",
        "needs_price_backfill",
        ("round_86.md Reuters Novo 2026 outlook warning",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Hims GLP-1 revenue miss",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Hims Novo partnership",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Hims compounded GLP-1 crackdown",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters bluebird bio take-private cash crunch",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Charles River forecast cut",),
        "CRO is service revenue, but funding-cycle cuts can break backlog and forecast visibility.",
    ),
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Teladoc record low",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md Reuters Recursion Exscientia merger",),
    ...
    Round86CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_86.md arXiv Lunit DBT subgroup performance",),
    ...
    Round86CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_86.md Reuters Amgen Samsung Bioepis patent litigation",),
    ...
    Round86CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_86.md AP FDA unapproved Botox warning",),
...
ROUND86_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round86ScoreTarget | None:
    for target in ROUND86_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round86_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND86_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round86 R7 Loop-4 case for {candidate.target_id}; "
...
def round86_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round86_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND86_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round86_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round86_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round86_backfill": "true"} for field in ROUND86_PRICE_FIELDS)


def round86_summary() -> dict[str, int | bool]:
    records = round86_case_records()
    return {
        "target_count": len(ROUND86_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND86_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND86_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND86_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND86_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round86_r7_loop4_reports(
    *,
    output_directory: str | Path = ROUND86_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND86_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND86_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round86_r7_loop4_biotech_healthcare_device_summary.md",
        "case_matrix": output / "round86_r7_loop4_case_matrix.csv",
        "stage_date_plan": output / "round86_r7_loop4_stage_date_plan.csv",
        "green_guardrails": output / "round86_r7_loop4_green_guardrails.md",
        "risk_overlays": output / "round86_r7_loop4_risk_overlays.md",
        "price_validation_plan": output / "round86_r7_loop4_price_validation_plan.md",
        "price_fields": output / "round86_r7_loop4_price_fields.csv",
    }
    _write_case_jsonl(round86_case_records(), cases)
    _write_rows(round86_score_profile_rows(), score_profiles)
    _write_rows(round86_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round86_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round86_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round86_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round86_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round86_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round86_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round86_summary_markdown() -> str:
    summary = round86_summary()
    lines = [
        "# Round-86 R7 Loop-4 Biotech / Healthcare / Medical Device Summary",
        "",
        f"- source_round: `{ROUND86_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R7 Loop 4 says approval, clinical success, AI papers, and TAM are not commercialization by themselves.",
...
def render_round86_green_guardrail_markdown() -> str:
    lines = [
        "# Round-86 R7 Loop-4 Green Guardrails",
        "",
    ...
    for target in ROUND86_SCORE_TARGETS:
        lines.append(
            ...
            f"{', '.join(target.green_conditions)} | {', '.join(target.loop4_penalty_axes)} |"
        )
    lines.extend(
        [
            "",
            "## What Not To Change",
            "",
            "- Do not apply R7 Loop-4 v4.0 weights to production scoring yet.",
...
def render_round86_risk_overlay_markdown() -> str:
    lines = [
        "# Round-86 R7 Loop-4 Risk Overlays",
        "",
...
def render_round86_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-86 R7 Loop-4 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round86_case_candidate_rows():
...
def _score_price_alignment(candidate: Round86CaseCandidate) -> str:
...
def _rerating_result(candidate: Round86CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round86ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND86_CASE_CANDIDATES",
    "ROUND86_DEFAULT_CASES_PATH",
    "ROUND86_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND86_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND86_PRICE_FIELDS",
    "ROUND86_SCORE_TARGETS",
    "Round86CaseCandidate",
    "Round86ScoreTarget",
    "Round86ScoreWeightDraft",
    "render_round86_green_guardrail_markdown",
    "render_round86_price_validation_plan_markdown",
    "render_round86_risk_overlay_markdown",
    "render_round86_summary_markdown",
    "round86_case_candidate_rows",
    "round86_case_records",
    "round86_price_field_rows",
    "round86_score_profile_rows",
    "round86_stage_date_rows",
    "round86_summary",
    "target_for",
