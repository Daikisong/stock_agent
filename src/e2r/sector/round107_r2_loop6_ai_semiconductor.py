"""Round-107 R2 Loop-6 AI, semiconductor, and electronics pack.

Round 107 returns to R2 after the R1 Loop-6 pass. It separates HBM leaders,
...
ROUND107_SOURCE_ROUND_PATH = "docs/round/round_107.md"
ROUND107_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round107_r2_loop6_ai_semiconductor"
ROUND107_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r2_loop6_round107.jsonl"
ROUND107_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round107_r2_loop6_v6.csv"


@dataclass(frozen=True)
class Round107ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round107ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round107ScoreWeightDraft
...
) -> Round107ScoreWeightDraft:
    return Round107ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)


ROUND107_SCORE_TARGETS: tuple[Round107ScoreTarget, ...] = (
    Round107ScoreTarget(
        "MEMORY_HBM_CAPACITY",
        E2RArchetype.MEMORY_HBM_CAPACITY,
        Round10ThemePosture.GREEN_POSSIBLE,
        _weights(24, 22, 20, 13, 7, 1),
        ...
        "Loop 6 keeps HBM Green-capable, but valuation credit is reduced because successful HBM cases can already be 4B-watch.",
    ),
    Round107ScoreTarget(
        "MEMORY_HBM_LTA_PREPAYMENT",
        E2RArchetype.MEMORY_HBM_LTA_PREPAYMENT,
        Round10ThemePosture.GREEN_POSSIBLE,
        _weights(24, 24, 21, 14, 9, 2, 6),
        ...
        "Loop 6 splits HBM LTA/prepayment from general HBM because price bands, prepayment, and reserved capacity are stronger visibility than headlines.",
    ),
    Round107ScoreTarget(
    ...
    Round107ScoreTarget(
        ...
        "Loop 6 separates supply reallocation from simple memory price rebound: consumer exit must become AI/HBM/enterprise mix and EPS evidence.",
    ),
    Round107ScoreTarget(
        "AI_STORAGE_NAND_SHORTAGE",
        E2RArchetype.AI_STORAGE_NAND_SHORTAGE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        _weights(23, 17, 18, 12, 6),
    ...
    Round107ScoreTarget(
        ...
        "Loop 6 splits hyperscaler custom ASICs from generic AI chips because named customer, capacity, margin, and repeat revenue matter.",
    ),
    Round107ScoreTarget(
...
ROUND107_CASE_CANDIDATES: tuple[Round107CaseCandidate, ...] = (
    Round107CaseCandidate(
        ...
        ("round_107.md Reuters SK Hynix AI boom market value",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters SK Hynix record profit and buyback",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Samsung HBM4 shipment",),
    ...
    Round107CaseCandidate(
        ...
        "hbm_catchup_execution_candidate",
        "needs_price_backfill",
        ("round_107.md Reuters Samsung AMD AI memory MOU",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Samsung labor strike plan",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Micron consumer memory exit",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Kioxia AI profit", "round_107.md FT Kioxia profit surge"),
    ...
    Round107CaseCandidate(
        ...
        "semi_capex_aligned",
        "needs_price_backfill",
        ("round_107.md Reuters Applied Materials guidance",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Broadcom custom AI chip demand",),
    ...
    Round107CaseCandidate(
        ...
        "missing_price_data",
        ("round_107.md custom ASIC margin concentration guardrail",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Nvidia CoWoS-L reference",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Broadcom supply constraints",),
        "Optical networking/PCB bottleneck becomes stronger in Loop 6 because lead time expanded from weeks to months.",
        (E2RArchetype.ADVANCED_PACKAGING_PCB,),
    ),
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Cisco AI orders",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Tower Semiconductor AI chip deals",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Foxconn Q1 profit",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Ecolab CoolIT acquisition",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md FT OpenAI CoreWeave contract",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters CoreWeave OpenAI expanded pact",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters CoreWeave circular financing watch",),
    ...
    Round107CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_107.md Reuters Supermicro EY resignation",),
    ...
    Round107CaseCandidate(
        ...
        "missing_price_data",
        ("round_107.md CXL/glass substrate guardrail",),
    ...
    Round107CaseCandidate(
        ...
        "theme_without_revenue",
        "missing_price_data",
        ("round_107.md FuriosaAI related stock watch",),
    ...
    Round107CaseCandidate(
        ...
        "missing_price_data",
        ("round_107.md AI CAPEX crowding overlay",),
...
ROUND107_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def round107_target_for(target_id: str) -> Round107ScoreTarget | None:
    for target in ROUND107_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round107_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND107_CASE_CANDIDATES:
        target = round107_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round107 R2 Loop-6 case for {candidate.target_id}; "
...
def round107_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round107_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND107_CASE_CANDIDATES:
        target = round107_target_for(candidate.target_id)
...
def round107_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round107_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round107_backfill": "true"} for field in ROUND107_PRICE_FIELDS)


def round107_summary() -> dict[str, int | bool]:
    records = round107_case_records()
    return {
        "target_count": len(ROUND107_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND107_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND107_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND107_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "hard_gate_target_count": sum(1 for target in ROUND107_SCORE_TARGETS if target.hard_gate),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round107_r2_loop6_reports(
    *,
    output_directory: str | Path = ROUND107_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND107_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND107_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round107_r2_loop6_ai_semiconductor_summary.md",
        "case_matrix": output / "round107_r2_loop6_case_matrix.csv",
        "stage_date_plan": output / "round107_r2_loop6_stage_date_plan.csv",
        "green_guardrails": output / "round107_r2_loop6_green_guardrails.md",
        "loop6_risk_overlays": output / "round107_r2_loop6_risk_overlays.md",
        "price_validation_plan": output / "round107_r2_loop6_price_validation_plan.md",
        "price_fields": output / "round107_r2_loop6_price_fields.csv",
    }
    _write_case_jsonl(round107_case_records(), cases)
    _write_rows(round107_score_profile_rows(), score_profiles)
    _write_rows(round107_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round107_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round107_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round107_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round107_green_guardrail_markdown(), encoding="utf-8")
    paths["loop6_risk_overlays"].write_text(render_round107_loop6_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round107_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round107_summary_markdown() -> str:
    summary = round107_summary()
    lines = [
        "# Round-107 R2 Loop-6 AI / Semiconductor / Electronics Summary",
        "",
        f"- source_round: `{ROUND107_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R2 Loop 6 says `AI 수혜` is not a score bucket.",
...
def render_round107_green_guardrail_markdown() -> str:
    lines = [
        "# Round-107 R2 Loop-6 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R2 Loop-6 v6.0 weights to production scoring yet.",
...
def render_round107_loop6_risk_overlay_markdown() -> str:
    lines = [
        "# Round-107 R2 Loop-6 Risk Overlays",
        "",
...
def render_round107_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-107 R2 Loop-6 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round107_case_candidate_rows():
...
def _score_price_alignment(candidate: Round107CaseCandidate) -> str:
...
def _rerating_result(candidate: Round107CaseCandidate) -> str:
...
def _score_weight_hint(target: Round107ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
