"""Round-117 R12 Loop-6 agriculture, life services, and miscellaneous pack.

Round 117 tightens the R12 unit-economics pack from Round 104. Agriculture,
...
Loop 6 adds stronger cycle and regulation splitters: right-to-repair expansion
...
ROUND117_SOURCE_ROUND_PATH = "docs/round/round_117.md"
ROUND117_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round117_r12_loop6_agri_life_misc"
ROUND117_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r12_loop6_round117.jsonl"
ROUND117_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round117_r12_loop6_v6.csv"


@dataclass(frozen=True)
class Round117ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round117ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round117ScoreWeightDraft
...
ROUND117_SCORE_TARGETS: tuple[Round117ScoreTarget, ...] = (
    Round117ScoreTarget(
        "SMART_FARM_AGRI_TECH",
        E2RArchetype.SMART_FARM_AGRI_TECH,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(17, 13, 12, 9, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round117ScoreWeightDraft(8, 6, 5, 7, 5, 0, 4),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(16, 13, 10, 10, 9, 1, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(14, 11, 8, 9, 7, 1, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(16, 14, 9, 11, 9, 1, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round117ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(18, 16, 11, 12, 10, 1, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(18, 11, 14, 9, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(16, 12, 13, 10, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round117ScoreWeightDraft(18, 8, 14, 8, 7, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(18, 16, 8, 11, 9, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(14, 12, 8, 10, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(17, 16, 5, 12, 10, 2, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(16, 15, 5, 12, 9, 1, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round117ScoreWeightDraft(10, 8, 4, 8, 5, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round117ScoreWeightDraft(15, 11, 5, 10, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(18, 16, 6, 12, 11, 2, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(14, 10, 5, 8, 6, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(15, 13, 7, 10, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(18, 15, 8, 12, 10, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(16, 13, 8, 10, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(16, 14, 8, 11, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round117ScoreWeightDraft(17, 11, 12, 8, 8, 0, 5),
    ...
    Round117ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round117ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND117_CASE_CANDIDATES: tuple[Round117CaseCandidate, ...] = (
    Round117CaseCandidate(
    ...
    Round117CaseCandidate(
        ...
        "needs_price_backfill",
        ("Round 117 Chegg AI search disintermediation synthesis",),
...
ROUND117_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round117ScoreTarget | None:
    for target in ROUND117_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round117_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND117_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round117 R12 Loop-6 case for {candidate.target_id}; "
...
def round117_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round117_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND117_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round117_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round117_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round117_backfill": "true"} for field in ROUND117_PRICE_FIELDS)


def round117_summary() -> dict[str, int | bool]:
    records = round117_case_records()
    return {
        "target_count": len(ROUND117_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND117_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND117_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND117_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND117_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round117_r12_loop6_reports(
    *,
    output_directory: str | Path = ROUND117_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND117_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND117_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round117_r12_loop6_agri_life_misc_summary.md",
        "case_matrix": output / "round117_r12_loop6_case_matrix.csv",
        "stage_date_plan": output / "round117_r12_loop6_stage_date_plan.csv",
        "green_guardrails": output / "round117_r12_loop6_green_guardrails.md",
        "unit_economics_caps": output / "round117_r12_loop6_unit_economics_caps.md",
        "price_validation_plan": output / "round117_r12_loop6_price_validation_plan.md",
        "price_fields": output / "round117_r12_loop6_price_fields.csv",
    }
    _write_case_jsonl(round117_case_records(), cases)
    _write_rows(round117_score_profile_rows(), score_profiles)
    _write_rows(round117_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round117_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round117_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round117_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round117_green_guardrail_markdown(), encoding="utf-8")
    paths["unit_economics_caps"].write_text(render_round117_unit_economics_cap_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round117_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round117_summary_markdown() -> str:
    summary = round117_summary()
    lines = [
        "# Round-117 R12 Loop-6 Agriculture / Life Services / Misc Summary",
        "",
        f"- source_round: `{ROUND117_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R12 Loop-6 separates recurring FCF from disease, weather, policy, AI, hardware, and regulation headlines.",
...
def render_round117_green_guardrail_markdown() -> str:
    lines = [
        "# Round-117 R12 Loop-6 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply these R12 Loop-6 v6 weights to production scoring yet.",
...
def render_round117_unit_economics_cap_markdown() -> str:
    lines = [
        "# Round-117 R12 Loop-6 Unit-Economics / Cycle Caps",
        "",
...
def render_round117_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-117 R12 Loop-6 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round117_case_candidate_rows():
...
def _score_price_alignment(candidate: Round117CaseCandidate) -> str:
...
def _rerating_result(candidate: Round117CaseCandidate) -> str:
...
__all__ = [
    "ROUND117_CASE_CANDIDATES",
    "ROUND117_DEFAULT_CASES_PATH",
    "ROUND117_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND117_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND117_PRICE_FIELDS",
    "ROUND117_SCORE_TARGETS",
    "ROUND117_SOURCE_ROUND_PATH",
    "Round117CaseCandidate",
    "Round117ScoreTarget",
    "Round117ScoreWeightDraft",
    "render_round117_green_guardrail_markdown",
    "render_round117_price_validation_plan_markdown",
    "render_round117_summary_markdown",
    "render_round117_unit_economics_cap_markdown",
    "round117_case_candidate_rows",
    "round117_case_records",
    "round117_price_field_rows",
    "round117_score_profile_rows",
    "round117_stage_date_rows",
    "round117_summary",
    "target_for",
    "write_round117_r12_loop6_reports",
]
