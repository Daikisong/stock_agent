"""Round-116 R11 Loop-6 policy/geopolitical/disaster/event pack.

Round 116 tightens the R11 event-risk pack from Round 103. The rule stays
...
Loop 6 adds explicit export-control, tourism-policy, and AI policy-shock gates.
...
ROUND116_SOURCE_ROUND_PATH = "docs/round/round_116.md"
ROUND116_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round116_r11_loop6_policy_geopolitical_event"
ROUND116_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r11_loop6_round116.jsonl"
ROUND116_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round116_r11_loop6_v6.csv"


@dataclass(frozen=True)
class Round116ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round116ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round116ScoreWeightDraft
...
ROUND116_SCORE_TARGETS: tuple[Round116ScoreTarget, ...] = (
    Round116ScoreTarget(
        "NORTH_KOREA_POLICY_EVENT",
        E2RArchetype.NORTH_KOREA_POLICY_EVENT,
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft(4, 3, 5, 8, 4, 0, 3),
    ...
    Round116ScoreTarget(
        ...
        Round116ScoreWeightDraft(12, 11, 8, 10, 8, 0, 4),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(14, 15, 9, 11, 9, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(15, 16, 10, 12, 9, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(12, 12, 17, 12, 8, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(16, 17, 17, 13, 10, 1, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(10, 6, 7, 8, 6, 0, 4),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(13, 14, 11, 10, 8, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(15, 16, 13, 11, 9, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft(13, 9, 8, 8, 6, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(16, 15, 8, 11, 8, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft(19, 5, 5, 5, 5, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft(5, 4, 5, 5, 5, 0, 3),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft(7, 6, 6, 8, 6, 0, 3),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft(5, 5, 5, 8, 5, 0, 3),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(8, 7, 4, 10, 6, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(10, 10, 8, 10, 7, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft(8, 5, 5, 6, 5, 0, 4),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round116ScoreWeightDraft(15, 14, 8, 10, 8, 0, 5),
    ...
    Round116ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round116ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND116_CASE_CANDIDATES: tuple[Round116CaseCandidate, ...] = (
    Round116CaseCandidate(
...
ROUND116_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round116ScoreTarget | None:
    for target in ROUND116_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round116_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND116_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round116 R11 Loop-6 case for {candidate.target_id}; "
...
def round116_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round116_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND116_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round116_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round116_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round116_backfill": "true"} for field in ROUND116_PRICE_FIELDS)


def round116_summary() -> dict[str, int | bool]:
    records = round116_case_records()
    return {
        "target_count": len(ROUND116_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND116_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND116_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND116_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND116_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round116_r11_loop6_reports(
    *,
    output_directory: str | Path = ROUND116_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND116_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND116_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round116_r11_loop6_policy_geopolitical_event_summary.md",
        "case_matrix": output / "round116_r11_loop6_case_matrix.csv",
        "stage_date_plan": output / "round116_r11_loop6_stage_date_plan.csv",
        "green_guardrails": output / "round116_r11_loop6_green_guardrails.md",
        "event_false_positive_caps": output / "round116_r11_loop6_event_false_positive_caps.md",
        "price_validation_plan": output / "round116_r11_loop6_price_validation_plan.md",
        "price_fields": output / "round116_r11_loop6_price_fields.csv",
    }
    _write_case_jsonl(round116_case_records(), cases)
    _write_rows(round116_score_profile_rows(), score_profiles)
    _write_rows(round116_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round116_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round116_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round116_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round116_green_guardrail_markdown(), encoding="utf-8")
    paths["event_false_positive_caps"].write_text(render_round116_event_false_positive_caps_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round116_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round116_summary_markdown() -> str:
    summary = round116_summary()
    lines = [
        "# Round-116 R11 Loop-6 Policy / Geopolitical / Disaster / Event Summary",
        "",
        f"- source_round: `{ROUND116_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R11 Loop-6 is mostly a false-positive defense pack.",
...
def render_round116_green_guardrail_markdown() -> str:
    lines = [
        "# Round-116 R11 Loop-6 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply these R11 Loop-6 v6 weights to production scoring yet.",
...
def render_round116_event_false_positive_caps_markdown() -> str:
    lines = [
        "# Round-116 R11 Loop-6 Event False-Positive Caps",
        "",
...
def render_round116_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-116 R11 Loop-6 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round116_case_candidate_rows():
...
def _score_price_alignment(candidate: Round116CaseCandidate) -> str:
...
def _rerating_result(candidate: Round116CaseCandidate) -> str:
...
__all__ = [
    "ROUND116_CASE_CANDIDATES",
    "ROUND116_DEFAULT_CASES_PATH",
    "ROUND116_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND116_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND116_PRICE_FIELDS",
    "ROUND116_SCORE_TARGETS",
    "ROUND116_SOURCE_ROUND_PATH",
    "Round116CaseCandidate",
    "Round116ScoreTarget",
    "Round116ScoreWeightDraft",
    "render_round116_event_false_positive_caps_markdown",
    "render_round116_green_guardrail_markdown",
    "render_round116_price_validation_plan_markdown",
    "render_round116_summary_markdown",
    "round116_case_candidate_rows",
    "round116_case_records",
    "round116_price_field_rows",
    "round116_score_profile_rows",
    "round116_stage_date_rows",
    "round116_summary",
    "target_for",
    "write_round116_r11_loop6_reports",
]
