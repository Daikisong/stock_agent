"""Round-129 R10 Loop-7 construction, real-estate, and building-materials pack.

Round 129 tightens the Round-50 R10 pack. It separates PF relief rallies,
...
Loop 7 adds sponsor-premium, no-revenue/no-tenant, water-rights,
...
ROUND129_SOURCE_ROUND_PATH = "docs/round/round_129.md"
ROUND129_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round129_r10_loop7_construction_real_estate_materials"
ROUND129_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r10_loop7_round129.jsonl"
ROUND129_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round129_r10_loop7_v7.csv"


@dataclass(frozen=True)
class Round129ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round129ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round129ScoreWeightDraft
...
GATE_WEIGHT = Round129ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND129_BASE_SCORE_AXES: tuple[Round129BaseScoreAxis, ...] = (
    Round129BaseScoreAxis(
    ...
    Round129BaseScoreAxis(
        "cost_ratio_price_volume_mna_synergy",
        14,
...
ROUND129_SCORE_TARGETS: tuple[Round129ScoreTarget, ...] = (
    Round129ScoreTarget(
        "CONSTRUCTION_REAL_ESTATE_CREDIT",
        E2RArchetype.CONSTRUCTION_REAL_ESTATE_CREDIT,
        Round10ThemePosture.REDTEAM_FIRST,
        Round129ScoreWeightDraft(12, 8, 5, 11, 7, 0, 5),
    ...
    Round129ScoreTarget(
        ...
        Round129ScoreWeightDraft(10, 8, 4, 10, 7, 0, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round129ScoreWeightDraft(11, 9, 4, 10, 7, 0, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round129ScoreWeightDraft(15, 12, 5, 12, 9, 1, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round129ScoreWeightDraft(15, 16, 5, 13, 11, 5, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round129ScoreWeightDraft(10, 7, 4, 11, 6, 0, 5),
    ...
    Round129ScoreTarget(
        ...
        Round129ScoreWeightDraft(18, 22, 18, 13, 11, 5, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round129ScoreWeightDraft(11, 12, 13, 12, 7, 1, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round129ScoreWeightDraft(12, 13, 13, 12, 8, 1, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round129ScoreWeightDraft(13, 15, 18, 13, 7, 2, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round129ScoreWeightDraft(17, 19, 12, 12, 10, 5, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round129ScoreWeightDraft(18, 15, 12, 11, 10, 3, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round129ScoreWeightDraft(13, 9, 8, 8, 6, 1, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round129ScoreWeightDraft(16, 14, 11, 12, 9, 2, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round129ScoreWeightDraft(17, 16, 9, 12, 10, 3, 5),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round129ScoreWeightDraft(10, 8, 8, 10, 7, 0, 4),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round129ScoreWeightDraft(5, 5, 4, 8, 5, 0, 3),
    ...
    Round129ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round129ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND129_CASE_CANDIDATES: tuple[Round129CaseCandidate, ...] = (
    Round129CaseCandidate(
    ...
    Round129CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_129.md Reuters Equinix annual sales forecast above estimates on AI data-center demand",),
    ...
    Round129CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_129.md Reuters Blackstone data center REIT raises $1.75 billion in US IPO",),
    ...
    Round129CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_129.md Reuters Fermi data center REIT Nasdaq debut after IPO",),
    ...
    Round129CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_129.md FT Fermi shares plunge on net loss",),
    ...
    Round129CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_129.md Guardian Seattle large data center moratorium watch",),
    ...
    Round129CaseCandidate(
        ...
        "data_center_local_moratorium",
        "needs_price_backfill",
        ("round_129.md Indianapolis data center moratorium resolution",),
    ...
    Round129CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_129.md Reuters Cemex core earnings increase but volumes weak",),
    ...
    Round129CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_129.md Reuters Holcim acquires French precast concrete maker Alkern",),
...
ROUND129_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round129ScoreTarget | None:
    for target in ROUND129_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round129_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND129_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round129 R10 case for {candidate.target_id}; "
...
def round129_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round129_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND129_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round129_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round129_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round129_backfill": "true"} for field in ROUND129_PRICE_FIELDS)


def round129_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_dict() for axis in ROUND129_BASE_SCORE_AXES)


def round129_summary() -> dict[str, int | bool]:
    records = round129_case_records()
    return {
        "target_count": len(ROUND129_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND129_BASE_SCORE_AXES),
        ...
        "green_possible_count": sum(1 for target in ROUND129_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND129_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND129_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND129_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round129_r10_reports(
    *,
    output_directory: str | Path = ROUND129_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND129_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND129_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round129_r10_loop7_construction_real_estate_materials_summary.md",
        "case_matrix": output / "round129_r10_loop7_case_matrix.csv",
        "stage_date_plan": output / "round129_r10_loop7_stage_date_plan.csv",
        "green_guardrails": output / "round129_r10_loop7_green_guardrails.md",
        "risk_overlays": output / "round129_r10_loop7_risk_overlays.md",
        "price_validation_plan": output / "round129_r10_loop7_price_validation_plan.md",
        "price_fields": output / "round129_r10_loop7_price_fields.csv",
        "base_score_axes": output / "round129_r10_loop7_base_score_axes.csv",
    }
    _write_case_jsonl(round129_case_records(), cases)
    _write_rows(round129_score_profile_rows(), score_profiles)
    _write_rows(round129_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round129_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round129_price_field_rows(), paths["price_fields"])
    _write_rows(round129_base_score_axis_rows(), paths["base_score_axes"])
    paths["summary"].write_text(render_round129_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round129_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round129_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round129_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round129_summary_markdown() -> str:
    summary = round129_summary()
    lines = [
        "# Round 129 R10 Loop-7 Construction / Real Estate / Building Materials Summary",
        "",
        "Round 129 is calibration material only. It does not change production scoring.",
        "",
        "## Counts",
    ]
    ...
    lines.extend(
        [
            ...
            "",
            "## R10 v7 Base Score Axes",
            "",
            "These axes are calibration material only. They document how Round 129 weighs cash-flow conversion before real-estate, data-center, or building-material headlines can become higher-conviction evidence.",
        ]
    )
    for axis in ROUND129_BASE_SCORE_AXES:
        lines.append(f"- {axis.axis_id}: {axis.score_weight}")
    return "\n".join(lines) + "\n"


def render_round129_green_guardrail_markdown() -> str:
    lines = [
        "# Round 129 R10 Loop-7 Green Guardrails",
        "",
        "- Do not apply R10 Loop-7 v7.0 weights to production scoring yet.",
...
def render_round129_risk_overlay_markdown() -> str:
    lines = [
        "# Round 129 R10 Loop-7 Risk Overlays",
        "",
...
def render_round129_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-129 R10 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round129_case_candidate_rows():
...
def _score_price_alignment(candidate: Round129CaseCandidate) -> str:
...
def _rerating_result(candidate: Round129CaseCandidate) -> str:
...
def _score_weight_hint(target: Round129ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND129_CASE_CANDIDATES",
    "ROUND129_BASE_SCORE_AXES",
    "ROUND129_DEFAULT_CASES_PATH",
    "ROUND129_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND129_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND129_PRICE_FIELDS",
    "ROUND129_SCORE_TARGETS",
    "ROUND129_SOURCE_ROUND_PATH",
    "Round129CaseCandidate",
    "Round129BaseScoreAxis",
    "Round129ScoreTarget",
    "Round129ScoreWeightDraft",
    "render_round129_green_guardrail_markdown",
    "render_round129_price_validation_plan_markdown",
    "render_round129_risk_overlay_markdown",
    "render_round129_summary_markdown",
    "round129_case_candidate_rows",
    "round129_base_score_axis_rows",
    "round129_case_records",
    "round129_price_field_rows",
    "round129_score_profile_rows",
    "round129_stage_date_rows",
    "round129_summary",
    "target_for",
    "write_round129_r10_reports",
]
