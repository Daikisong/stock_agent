"""Round-130 R11 Loop-7 policy/geopolitical/disaster/event pack.

Round 130 tightens the R11 event-risk pack from Round 116. The rule stays
...
Loop 7 adds explicit export-control, tourism-policy, and AI policy-shock gates.
...
ROUND130_SOURCE_ROUND_PATH = "docs/round/round_130.md"
ROUND130_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round130_r11_loop7_policy_geopolitical_event"
ROUND130_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r11_loop7_round130.jsonl"
ROUND130_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round130_r11_loop7_v7.csv"


@dataclass(frozen=True)
class Round130ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round130ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round130ScoreWeightDraft
...
ROUND130_BASE_SCORE_AXES: tuple[Round130BaseScoreAxis, ...] = (
    Round130BaseScoreAxis(
...
ROUND130_SCORE_TARGETS: tuple[Round130ScoreTarget, ...] = (
    Round130ScoreTarget(
        "NORTH_KOREA_POLICY_EVENT",
        E2RArchetype.NORTH_KOREA_POLICY_EVENT,
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft(4, 3, 5, 8, 4, 0, 3),
    ...
    Round130ScoreTarget(
        ...
        Round130ScoreWeightDraft(12, 11, 8, 10, 8, 0, 4),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(14, 15, 9, 11, 9, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(15, 16, 10, 12, 9, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(12, 12, 17, 12, 8, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(16, 17, 17, 13, 10, 1, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(10, 6, 7, 8, 6, 0, 4),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(13, 14, 11, 10, 8, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(15, 16, 13, 11, 9, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft(13, 9, 8, 8, 6, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(16, 15, 8, 11, 8, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate"),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft(19, 5, 5, 5, 5, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft(5, 4, 5, 5, 5, 0, 3),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft(7, 6, 6, 8, 6, 0, 3),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft(5, 5, 5, 8, 5, 0, 3),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(8, 7, 4, 10, 6, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(10, 10, 8, 10, 7, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft(8, 5, 5, 6, 5, 0, 4),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round130ScoreWeightDraft(15, 14, 8, 10, 8, 0, 5),
    ...
    Round130ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round130ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND130_CASE_CANDIDATES: tuple[Round130CaseCandidate, ...] = (
    Round130CaseCandidate(
...
ROUND130_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round130ScoreTarget | None:
    for target in ROUND130_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round130_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND130_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round130 R11 Loop-7 case for {candidate.target_id}; "
...
def round130_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round130_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND130_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round130_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round130_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round130_backfill": "true"} for field in ROUND130_PRICE_FIELDS)


def round130_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_dict() for axis in ROUND130_BASE_SCORE_AXES)


def round130_summary() -> dict[str, int | bool]:
    records = round130_case_records()
    return {
        "target_count": len(ROUND130_SCORE_TARGETS),
        "base_score_axis_count": len(ROUND130_BASE_SCORE_AXES),
        ...
        "green_possible_count": sum(1 for target in ROUND130_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND130_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND130_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND130_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round130_r11_loop7_reports(
    *,
    output_directory: str | Path = ROUND130_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND130_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND130_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round130_r11_loop7_policy_geopolitical_event_summary.md",
        "case_matrix": output / "round130_r11_loop7_case_matrix.csv",
        "stage_date_plan": output / "round130_r11_loop7_stage_date_plan.csv",
        "green_guardrails": output / "round130_r11_loop7_green_guardrails.md",
        "event_false_positive_caps": output / "round130_r11_loop7_event_false_positive_caps.md",
        "price_validation_plan": output / "round130_r11_loop7_price_validation_plan.md",
        "price_fields": output / "round130_r11_loop7_price_fields.csv",
        "base_score_axes": output / "round130_r11_loop7_base_score_axes.csv",
    }
    _write_case_jsonl(round130_case_records(), cases)
    _write_rows(round130_score_profile_rows(), score_profiles)
    _write_rows(round130_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round130_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round130_price_field_rows(), paths["price_fields"])
    _write_rows(round130_base_score_axis_rows(), paths["base_score_axes"])
    paths["summary"].write_text(render_round130_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round130_green_guardrail_markdown(), encoding="utf-8")
    paths["event_false_positive_caps"].write_text(render_round130_event_false_positive_caps_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round130_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round130_summary_markdown() -> str:
    summary = round130_summary()
    lines = [
        "# Round-130 R11 Loop-7 Policy / Geopolitical / Disaster / Event Summary",
        "",
        f"- source_round: `{ROUND130_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R11 Loop-7 is mostly a false-positive defense pack.",
        ...
        "",
        "## R11 v7 Base Score Axes",
        "",
        "These axes are calibration material only. They document how Round 130 separates policy/event headlines from actual orders, budgets, financing, guidance, recurrence, and RedTeam detail checks.",
    ]
    for axis in ROUND130_BASE_SCORE_AXES:
        lines.append(f"- {axis.axis_id}: {axis.score_weight}")
    return "\n".join(lines) + "\n"


def render_round130_green_guardrail_markdown() -> str:
    lines = [
        "# Round-130 R11 Loop-7 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply these R11 Loop-7 v7 weights to production scoring yet.",
...
def render_round130_event_false_positive_caps_markdown() -> str:
    lines = [
        "# Round-130 R11 Loop-7 Event False-Positive Caps",
        "",
...
def render_round130_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-130 R11 Loop-7 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round130_case_candidate_rows():
...
def _score_price_alignment(candidate: Round130CaseCandidate) -> str:
...
def _rerating_result(candidate: Round130CaseCandidate) -> str:
...
__all__ = [
    "ROUND130_BASE_SCORE_AXES",
    "ROUND130_CASE_CANDIDATES",
    "ROUND130_DEFAULT_CASES_PATH",
    "ROUND130_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND130_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND130_PRICE_FIELDS",
    "ROUND130_SCORE_TARGETS",
    "ROUND130_SOURCE_ROUND_PATH",
    "Round130BaseScoreAxis",
    "Round130CaseCandidate",
    "Round130ScoreTarget",
    "Round130ScoreWeightDraft",
    "render_round130_event_false_positive_caps_markdown",
    "render_round130_green_guardrail_markdown",
    "render_round130_price_validation_plan_markdown",
    "render_round130_summary_markdown",
    "round130_base_score_axis_rows",
    "round130_case_candidate_rows",
    "round130_case_records",
    "round130_price_field_rows",
    "round130_score_profile_rows",
    "round130_stage_date_rows",
    "round130_summary",
    "target_for",
    "write_round130_r11_loop7_reports",
]
