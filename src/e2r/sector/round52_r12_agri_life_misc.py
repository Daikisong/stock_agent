"""Round-52 R12 agriculture, life services, and miscellaneous pack.

Round 52 turns R12 into a unit-economics and recurring-revenue calibration
pack. The core rule is simple: essential-life labels, weather, disease,
grain prices, education demand, rental devices, or regulation headlines are
not enough for Stage 3-Green. Repeat contracts, repeat revenue, price
pass-through, retention, regulatory approval, and FCF conversion must be
source-backed first.
...
ROUND52_SOURCE_ROUND_PATH = "docs/round/round_52.md"
ROUND52_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round52_r12_agri_life_misc"
ROUND52_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r12_round52.jsonl"
ROUND52_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round52_r12_v1.csv"


@dataclass(frozen=True)
class Round52ScoreWeightDraft:
    eps_fcf: int
...
@dataclass(frozen=True)
class Round52ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round52ScoreWeightDraft
...
ROUND52_SCORE_TARGETS: tuple[Round52ScoreTarget, ...] = (
    Round52ScoreTarget(
        "SMART_FARM_AGRI_TECH",
        E2RArchetype.SMART_FARM_AGRI_TECH,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(18, 14, 12, 9, 9, 0, 5),
        ...
        ("chapter11", "energy_cost_spike", "premium_pricing_failure", "capex_burden"),
        ...
        "Smart-farm labels need orders, operations contracts, unit economics, and FCF.",
    ),
    Round52ScoreTarget(
        "AGRI_MACHINERY_PRECISION_CYCLE",
        E2RArchetype.AGRI_MACHINERY_PRECISION_CYCLE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(18, 13, 10, 10, 9, 1, 5),
        ...
        ("equipment_sales_growth", "farmer_roi", "software_attach_rate", "service_revenue"),
        ("farm_income", "financing_cost", "replacement_cycle", "dealer_inventory"),
        "Precision-agri technology is promising, but machinery remains tied to farm capex cycles.",
    ),
    Round52ScoreTarget(
        "AGRI_LIVESTOCK_FOOD_COMMODITY",
        E2RArchetype.AGRI_LIVESTOCK_FOOD_COMMODITY,
        Round10ThemePosture.REDTEAM_FIRST,
        Round52ScoreWeightDraft(18, 10, 14, 8, 8, 0, 5),
        ...
        ("price_normalization", "feed_cost_spike", "government_inquiry", "disease_normalization"),
    ...
    Round52ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(16, 14, 8, 10, 8, 0, 5),
        ...
        ("government_purchase_end", "disease_normalization", "vaccine_unused"),
        ("government_purchase_contract", "repeat_vaccination", "recurring_revenue", "fcf_conversion"),
        ("emergency_license", "one_off_stockpile", "government_policy_uncertain"),
    ...
    Round52ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(18, 17, 5, 12, 12, 2, 5),
        ("ai_training", "adult_education", "job_training", "b2b_education_contract"),
        ("repeat_enrollment", "enterprise_contract", "completion_rate", "opm_improvement"),
        ("b2b_b2g_recurring_revenue", "student_roi", "low_cac", "fcf_conversion"),
        ("ai_education_narrative_crowded", "valuation_before_profitability"),
        ("ai_substitutes_core_service", "subscriber_decline", "cac_spike", "bankruptcy"),
        ("enterprise_contract", "completion_rate", "student_roi", "opm_improvement", "fcf_conversion"),
        ("ai_disruption", "cac", "completion_rate", "student_roi", "debt"),
    ...
    Round52ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round52ScoreWeightDraft(16, 12, 5, 10, 8, 0, 5),
    ...
    Round52ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(17, 15, 6, 12, 10, 2, 5),
    ...
    Round52ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(17, 15, 7, 12, 10, 0, 5),
        ...
        ("retailer_retreat", "theft_shrink", "customer_friction", "one_off_hardware_sales"),
        ("maintenance_revenue", "payment_fee_revenue", "loss_prevention_effect", "recurring_service_revenue"),
        ("theft", "customer_friction", "retailer_retreat", "one_off_hardware"),
    ...
    Round52ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(18, 14, 8, 12, 10, 0, 5),
        ...
        ("approval_revoked", "sales_ban", "legal_conflict", "youth_usage_controversy"),
        ("sales_authorization", "channel_access", "repeat_consumption", "regulatory_stability"),
        ("public_health", "social_backlash", "legal_conflict", "license_scope"),
        "Regulated consumer products can rerate on approval, but reversal and public-health risks stay high.",
    ),
    Round52ScoreTarget(
        "FOOD_INPUT_REGULATED_CYCLE",
        E2RArchetype.FOOD_INPUT_REGULATED_CYCLE,
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round52ScoreWeightDraft(17, 11, 12, 8, 8, 0, 5),
    ...
    Round52ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round52ScoreWeightDraft(5, 5, 5, 8, 5, 0, 3),
...
ROUND52_CASE_CANDIDATES: tuple[Round52CaseCandidate, ...] = (
    Round52CaseCandidate(
        "john_deere_autonomous_agri_stage1_case",
        "AGRI_MACHINERY_PRECISION_CYCLE",
        "DE",
        "John Deere autonomous agriculture technology",
        "US",
        "success_candidate",
        date(2025, 1, 7),
        None,
        ...
        None,
        None,
        ("autonomous_tractor", "precision_agriculture", "labor_shortage_solution", "input_precision"),
        ("farm_income", "financing_cost", "adoption_rate_unverified"),
        "precision_agri_stage1_success_candidate",
        "needs_price_backfill",
        ("Round52 analyst matrix",),
        "Autonomous agriculture technology is useful Stage 1 evidence, but equipment sales, ROI, and software attachment must verify it.",
        (E2RArchetype.SMART_FARM_AGRI_TECH,),
    ),
    Round52CaseCandidate(
        ...
        None,
        date(2025, 2, 13),
        ("equipment_sales_decline", "farm_income_weakness", "high_borrowing_cost"),
        ("farm_income_weakness", "high_borrowing_cost", "equipment_sales_decline"),
    ...
    Round52CaseCandidate(
        ...
        ("emergency_license", "government_policy_uncertain", "one_off_stockpile"),
    ...
    Round52CaseCandidate(
        ...
        ("price_normalization", "disease_normalization", "government_inquiry"),
        "cyclical_success_candidate_regulatory_watch",
        "needs_price_backfill",
        ("Round52 analyst matrix",),
        "Egg-price profit spikes can be real cyclical success, but price normalization and investigations cap Green.",
    ),
    Round52CaseCandidate(
        "multiverse_ai_training_case",
        "EDUCATION_SPECIALTY_SERVICES",
        "MULTIVERSE_PRIVATE",
        "Multiverse AI workforce training",
        "UK",
        "success_candidate",
        date(2026, 5, 1),
        date(2026, 5, 1),
        ...
        None,
        None,
        ("ai_training", "enterprise_contract", "apprenticeship_platform", "cash_positive_quarter"),
        ("loss_expansion", "completion_rate", "education_budget_cycle"),
        "adult_ai_training_success_candidate_but_profitability_watch",
        "needs_price_backfill",
        ("Round52 analyst matrix",),
        "B2B AI workforce training can become a candidate, but losses and completion rates must be verified.",
    ),
    Round52CaseCandidate(
    ...
    Round52CaseCandidate(
        ...
        ("rental_churn", "competition", "overseas_margin"),
    ...
    Round52CaseCandidate(
        ...
        None,
        None,
        ("fda_approval", "sales_authorization", "repeat_consumption"),
        ("youth_usage_controversy", "policy_reversal", "license_scope"),
    ...
    Round52CaseCandidate(
        ...
        None,
        date(2024, 11, 5),
        ("vertical_farming", "premium_pricing_failure", "unit_economics_failure"),
    ...
    Round52CaseCandidate(
        ...
        "needs_price_backfill",
        ("Round52 analyst matrix",),
        "Hydroponics/greenhouse capex without unit economics can become hard 4C.",
    ),
    Round52CaseCandidate(
        ...
        ("ai_disruption", "traffic_decline", "subscriber_decline", "strategic_review"),
    ...
    Round52CaseCandidate(
        ...
        ("chapter11", "student_roi", "debt", "partner_concentration"),
        "online_education_hard_4c",
        "needs_price_backfill",
        ("Round52 analyst matrix",),
    ...
    Round52CaseCandidate(
        ...
        None,
        date(2026, 5, 7),
        ("home_appliance_hardware", "dividend_suspension", "replacement_demand_collapse"),
        ("replacement_demand_collapse", "dividend_suspension", "housing_turnover_weakness"),
    ...
    Round52CaseCandidate(
        ...
        None,
        None,
        ("self_checkout_rollout", "retailer_limit", "customer_friction"),
    ...
    Round52CaseCandidate(
        ...
        "regulatory_watch_not_full_legalization",
        "needs_price_backfill",
        ("Round52 analyst matrix",),
...
ROUND52_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round52ScoreTarget | None:
    for target in ROUND52_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round52_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND52_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round52 R12 case for {candidate.target_id}; "
            ...
            green_guardrails=(
                ...
                "life_essential_label_is_not_green_evidence_alone",
                "repeat_contract_repeat_revenue_unit_economics_or_regulatory_approval_required",
...
def round52_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round52_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND52_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round52_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round52_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round52_backfill": "true"} for field in ROUND52_PRICE_FIELDS)


def round52_summary() -> dict[str, int | bool]:
    records = round52_case_records()
    return {
        "target_count": len(ROUND52_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND52_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND52_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND52_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round52_r12_reports(
    *,
    output_directory: str | Path = ROUND52_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND52_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND52_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round52_r12_agri_life_misc_summary.md",
        "case_matrix": output / "round52_r12_case_matrix.csv",
        "stage_date_plan": output / "round52_r12_stage_date_plan.csv",
        "green_guardrails": output / "round52_r12_green_guardrails.md",
        "unit_economics_caps": output / "round52_r12_unit_economics_caps.md",
        "price_validation_plan": output / "round52_r12_price_validation_plan.md",
        "price_fields": output / "round52_r12_price_fields.csv",
    }
    _write_case_jsonl(round52_case_records(), cases)
    _write_rows(round52_score_profile_rows(), score_profiles)
    _write_rows(round52_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round52_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round52_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round52_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round52_green_guardrail_markdown(), encoding="utf-8")
    paths["unit_economics_caps"].write_text(render_round52_unit_economics_cap_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round52_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round52_summary_markdown() -> str:
    summary = round52_summary()
    lines = [
        "# Round-52 R12 Agriculture / Life Services / Misc Summary",
        "",
        f"- source_round: `{ROUND52_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R12 is not a small-theme bucket; it is a false-positive control bucket for disease, weather, grain, education, rental, and regulation stories.",
        "- Example: smart farming news is Stage 1 until actual orders, unit economics, energy cost, and FCF are visible.",
        "- Example: education apps need bookings and monetization, not user growth alone.",
        "- Example: rental appliances can improve quality only if recurring care revenue and churn data beat the hardware cycle.",
    ]
    return "\n".join(lines) + "\n"


def render_round52_green_guardrail_markdown() -> str:
    lines = [
...
def render_round52_unit_economics_cap_markdown() -> str:
    lines = [
        "# Round-52 R12 Unit-Economics / Cycle Caps",
        "",
        "- `SMART_FARM_AGRI_TECH`: technology and policy are Stage 1; orders, energy cost, utilization, and FCF decide escalation.",
        "- `AGRI_MACHINERY_PRECISION_CYCLE`: autonomous equipment still depends on farm income, financing cost, and replacement cycles.",
        "- `AGRI_LIVESTOCK_FOOD_COMMODITY`: price spikes can be cyclical success, but disease/price normalization caps Green.",
        "- `EDUCATION_SPECIALTY_SERVICES`: AI education can work only when contracts, completion, retention, and margin are visible.",
...
def render_round52_price_validation_plan_markdown() -> str:
    lines = [
    ...
    for row in round52_case_candidate_rows():
...
def _score_price_alignment(candidate: Round52CaseCandidate) -> str:
...
def _rerating_result(candidate: Round52CaseCandidate) -> str:
...
__all__ = [
    ...
    "ROUND52_DEFAULT_CASES_PATH",
    "ROUND52_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND52_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND52_PRICE_FIELDS",
    "ROUND52_SCORE_TARGETS",
    "ROUND52_SOURCE_ROUND_PATH",
    "Round52CaseCandidate",
    "Round52ScoreTarget",
    "Round52ScoreWeightDraft",
