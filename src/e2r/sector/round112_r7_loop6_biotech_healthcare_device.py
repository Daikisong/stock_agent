"""Round-112 R7 Loop-6 biotech, healthcare, and medical-device pack.

Round 112 tightens the R7 healthcare pack. It separates approvals, clinical
...
ROUND112_SOURCE_ROUND_PATH = "docs/round/round_112.md"
ROUND112_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round112_r7_loop6_biotech_healthcare_device"
ROUND112_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r7_loop6_round112.jsonl"
ROUND112_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round112_r7_loop6_v6.csv"


@dataclass(frozen=True)
class Round112ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round112ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round112ScoreWeightDraft
...
GATE_WEIGHT = Round112ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")
CAP_WEIGHT = Round112ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+")


ROUND112_SCORE_TARGETS: tuple[Round112ScoreTarget, ...] = (
    Round112ScoreTarget(
        "CDMO_HEALTHCARE_CONTRACT",
        E2RArchetype.CDMO_HEALTHCARE_CONTRACT,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round112ScoreWeightDraft(20, 24, 12, 12, 12, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        Round112ScoreWeightDraft(19, 21, 12, 12, 11, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(19, 20, 11, 12, 10, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(16, 17, 7, 11, 9, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        GATE_WEIGHT,
        ("biotech_funding_crunch", "pharma_rd_budget_cut", "trial_delay", "forecast_cut"),
        ("risk_event_detected",),
        ("not_applicable_gate_only",),
        ("not_applicable_gate_only",),
        ("forecast_cut", "customer_budget_cut", "trial_delay", "order_cancellation", "revenue_decline"),
        (),
        ("biotech_funding_crunch", "customer_budget_cut", "forecast_cut", "trial_delay", "revenue_decline"),
        ("funding_cycle", "customer_budget", "forecast_cut", "trial_delay"),
        "CRO funding-cycle pressure is a RedTeam gate because service backlog can break when biotech and pharma budgets tighten.",
        gate_only=True,
    ),
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(18, 18, 6, 12, 9, 0, 6),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(16, 15, 5, 11, 8, 0, 6),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(17, 17, 6, 12, 9, 0, 6),
        ("pbm_formulary_switch", "zero_copay_program", "preferred_drug_list", "payer_policy_change"),
        ("pbm_listing", "zero_copay_or_preferred_status", "prescription_conversion", "margin_defense"),
        ("sustained_prescription_share_gain", "payer_access_scaled", "gross_margin_stable", "launch_revenue_conversion"),
        ("pbm_switch_headline_overheated", "discount_story_priced_before_scripts"),
        ("rebate_defense_by_originator", "prescription_conversion_delay", "pbm_exclusion", "margin_compression", "coverage_gap"),
        ("pbm_listing", "prescription_conversion", "margin_defense", "payer_access_scaled"),
        ("slow_switching", "pbm_exclusion", "rebate_defense", "margin_pressure", "coverage_gap"),
        ("pbm", "formulary", "prescription_switch", "margin"),
        "PBM formulary switching is stronger than cash-pay discount, but it still needs prescription conversion and margin defense.",
    ),
    Round112ScoreTarget(
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round112ScoreWeightDraft(22, 20, 12, 13, 8, 0, 6),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(21, 19, 11, 13, 9, 0, 6),
        ("oral_glp1_approval", "self_pay_price", "distribution_channel", "oral_glp1_launch"),
        ("weekly_scripts", "insurance_coverage", "refill_rate", "price_defense", "sales_ramp"),
        ("repeat_refill", "insurance_coverage", "op_eps_revision", "real_world_adherence", "gross_to_net_stable"),
        ("oral_glp1_approval_story_crowded", "market_size_priced_before_refills"),
        ("scripts_missing", "coverage_gap", "price_competition", "boxed_warning", "adherence_failure"),
        ("weekly_scripts", "insurance_coverage", "repeat_refill", "price_defense", "op_eps_revision"),
        ("scripts_missing", "coverage_gap", "price_competition", "boxed_warning", "slow_uptake"),
        ("approval", "scripts", "coverage", "price", "refills"),
        "Oral GLP-1 approval is Stage 1/2; Green waits for scripts, coverage, refills, price defense, and OP/EPS.",
    ),
    Round112ScoreTarget(
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(18, 15, 5, 13, 7, 0, 6),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round112ScoreWeightDraft(7, 10, 8, 9, 5, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round112ScoreWeightDraft(6, 10, 7, 12, 6, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(18, 17, 8, 13, 12, 0, 7),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(16, 16, 8, 13, 11, 0, 7),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        GATE_WEIGHT,
        ("subgroup_performance_risk", "dataset_bias", "external_validation_gap", "liability_risk"),
        ("risk_event_detected",),
        ("not_applicable_gate_only",),
        ("not_applicable_gate_only",),
        ("subgroup_performance_issue", "dataset_bias", "workflow_not_integrated", "reimbursement_absent", "liability_event"),
        (),
        ("subgroup_performance_risk", "dataset_bias", "no_reimbursement", "no_hospital_adoption", "liability"),
        ("subgroup", "dataset_bias", "deployment", "reimbursement", "liability"),
        "Medical-AI subgroup weakness is a RedTeam gate because AUC can look strong while real deployment fails.",
        gate_only=True,
    ),
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(16, 16, 7, 12, 9, 1, 6),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round112ScoreWeightDraft(15, 13, 5, 10, 8, 0, 6),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round112ScoreWeightDraft(20, 22, 13, 14, 12, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round112ScoreWeightDraft(21, 23, 13, 14, 12, 1, 5),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        GATE_WEIGHT,
        ("glp1_procedure_impact", "bariatric_slowdown", "procedure_mix_shift", "hospital_capex_slowdown"),
        ("risk_event_detected",),
        ("not_applicable_gate_only",),
        ("not_applicable_gate_only",),
        ("bariatric_slowdown", "procedure_mix_worse", "glp1_procedure_impact", "hospital_capex_slowdown", "system_placement_slowdown"),
        (),
        ("glp1_procedure_impact", "bariatric_slowdown", "procedure_mix_worse", "hospital_capex_slowdown"),
        ("procedure_mix", "glp1", "bariatric", "hospital_capex"),
        "GLP-1 procedure-mix pressure is a surgical-robot RedTeam overlay; installed-base growth must still convert to procedures and consumables.",
        gate_only=True,
    ),
    Round112ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round112ScoreWeightDraft(19, 20, 12, 13, 11, 0, 5),
    ...
    Round112ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round112ScoreWeightDraft(20, 5, 5, 5, 5, 0, 5),
...
ROUND112_CASE_CANDIDATES: tuple[Round112CaseCandidate, ...] = (
    Round112CaseCandidate(
        ...
        ("round_112.md Reuters Samsung Biologics GSK US facility",),
    ...
    Round112CaseCandidate(
        ...
        ("round_112.md Samsung Biologics CDMO structure reference",),
    ...
    Round112CaseCandidate(
        ...
        ("round_112.md Investors Intuitive Surgical Q1 2026",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Straumann dental implant growth",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Lilly oral GLP-1 approval",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Foundayo switch maintenance",),
    ...
    Round112CaseCandidate(
        ...
        ("round_112.md Reuters Humira biosimilar GoodRx access",),
        "A 92% discount improves access, but slow prescription switching and margin defense remain core gates.",
        (E2RArchetype.BIOSIMILAR_COMMERCIALIZATION,),
    ),
    Round112CaseCandidate(
        "cigna_humira_biosimilar_zero_copay_case",
        "BIOSIMILAR_PBM_FORMULARY_SWITCH",
        "BIOSIMILAR_PBM_REF",
        "Cigna Humira biosimilar zero-copay formulary switch",
        "US",
        "success_candidate",
        None,
        date(2024, 4, 25),
        ...
        None,
        None,
        ("pbm_formulary_switch_flag", "zero_copay_program", "pbm_coverage_flag", "prescription_conversion_rate"),
        ("originator_rebate_defense", "margin_pressure", "coverage_gap", "slow_switching"),
        "pbm_formulary_switch_watch",
        "missing_direct_symbol_mapping",
        ("round_112.md Reuters Cigna Humira biosimilar zero copay",),
        "PBM access is stronger than cash-pay access, but prescription conversion and margin defense remain required.",
        (E2RArchetype.BIOSIMILAR_COMMERCIALIZATION, E2RArchetype.REIMBURSEMENT_ACCESS_OVERLAY),
    ),
    Round112CaseCandidate(
        "unitedhealth_humira_preferred_list_case",
        "BIOSIMILAR_PBM_FORMULARY_SWITCH",
        "BIOSIMILAR_PBM_REF",
        "UnitedHealth Humira biosimilar preferred-list switch",
        "US",
        "success_candidate",
        None,
        date(2024, 9, 10),
        ...
        None,
        None,
        ("preferred_drug_list", "pbm_formulary_switch_flag", "pbm_coverage_flag", "biosimilar_prescription_volume"),
        ("originator_rebate_defense", "margin_pressure", "prescription_conversion_delay", "pbm_exclusion"),
        "pbm_preferred_list_watch",
        "missing_direct_symbol_mapping",
        ("round_112.md UnitedHealth Humira biosimilar preferred list",),
        "Preferred-list status improves access evidence, but Stage promotion still needs actual prescription switching and economics.",
        (E2RArchetype.BIOSIMILAR_COMMERCIALIZATION, E2RArchetype.REIMBURSEMENT_ACCESS_OVERLAY),
    ),
    Round112CaseCandidate(
        ...
        "glp1_4b_to_4c",
        "needs_price_backfill",
        ("round_112.md Reuters Novo 2026 outlook warning",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Hims GLP-1 revenue miss",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Hims compounded GLP-1 crackdown",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters bluebird bio take-private cash crunch",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Charles River forecast cut",),
        "CRO is service revenue, but funding-cycle cuts can break backlog and forecast visibility.",
        (E2RArchetype.CRO_CLINICAL_SERVICE,),
    ),
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Teladoc record low",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md Reuters Recursion Exscientia merger",),
    ...
    Round112CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_112.md arXiv Lunit DBT subgroup performance",),
    ...
    Round112CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_112.md Reuters Amgen Samsung Bioepis patent litigation",),
    ...
    Round112CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_112.md AP FDA unapproved Botox warning",),
...
ROUND112_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def round112_target_for(target_id: str) -> Round112ScoreTarget | None:
    for target in ROUND112_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round112_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND112_CASE_CANDIDATES:
        target = round112_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round112 R7 Loop-6 case for {candidate.target_id}; "
...
def round112_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round112_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND112_CASE_CANDIDATES:
        target = round112_target_for(candidate.target_id)
...
def round112_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round112_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round112_backfill": "true"} for field in ROUND112_PRICE_FIELDS)


def round112_summary() -> dict[str, int | bool]:
    records = round112_case_records()
    return {
        "target_count": len(ROUND112_SCORE_TARGETS),
        ...
        "green_possible_count": sum(1 for target in ROUND112_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND112_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND112_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND112_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round112_r7_loop6_reports(
    *,
    output_directory: str | Path = ROUND112_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND112_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND112_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round112_r7_loop6_biotech_healthcare_device_summary.md",
        "case_matrix": output / "round112_r7_loop6_case_matrix.csv",
        "stage_date_plan": output / "round112_r7_loop6_stage_date_plan.csv",
        "green_guardrails": output / "round112_r7_loop6_green_guardrails.md",
        "risk_overlays": output / "round112_r7_loop6_risk_overlays.md",
        "price_validation_plan": output / "round112_r7_loop6_price_validation_plan.md",
        "price_fields": output / "round112_r7_loop6_price_fields.csv",
    }
    _write_case_jsonl(round112_case_records(), cases)
    _write_rows(round112_score_profile_rows(), score_profiles)
    _write_rows(round112_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round112_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round112_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round112_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round112_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round112_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round112_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round112_summary_markdown() -> str:
    summary = round112_summary()
    lines = [
        "# Round-112 R7 Loop-6 Biotech / Healthcare / Medical Device Summary",
        "",
        f"- source_round: `{ROUND112_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R7 Loop 6 says approval, clinical success, AI papers, and TAM are not commercialization by themselves.",
...
def render_round112_green_guardrail_markdown() -> str:
    lines = [
        "# Round-112 R7 Loop-6 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R7 Loop-6 v6.0 weights to production scoring yet.",
...
def render_round112_risk_overlay_markdown() -> str:
    lines = [
        "# Round-112 R7 Loop-6 Risk Overlays",
        "",
        ...
        "- `ORAL_GLP1_APPROVAL_COMMERCIALIZATION`: oral FDA approval is Stage 1/2 until weekly scripts, insurance, repeat refills, price defense, and OP/EPS are visible.",
        ...
        "- `MEDICAL_AI_SUBGROUP_GENERALIZATION_RISK`: subgroup weakness, dataset bias, or liability risk blocks paper-only AI narratives.",
        ...
        "- `BIOSIMILAR_PBM_FORMULARY_SWITCH`: PBM preferred-list or zero-copay access is stronger than cash-pay discount, but scripts and margin still gate promotion.",
        ...
        "- `CRO_FUNDING_CYCLE_OVERLAY`: CRO backlog visibility can break when biotech funding or pharma R&D budgets are cut.",
        ...
        "- `SURGICAL_ROBOT_GLP1_PROCEDURE_MIX_OVERLAY`: GLP-1-driven bariatric/procedure-mix pressure is a robot-platform RedTeam overlay.",
        "",
...
def render_round112_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-112 R7 Loop-6 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round112_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "- `ORAL_GLP1_APPROVAL_COMMERCIALIZATION`: approval needs weekly scripts, coverage, refills, and price defense before higher-stage confidence.",
            ...
            "- `BIOSIMILAR_PBM_FORMULARY_SWITCH`: PBM access needs prescription conversion and economics before Green.",
            "- `AI_CLINICAL_VALIDATION_NOT_COMMERCIAL`: paper/AUC validates model quality but not paid deployment.",
            "- `MEDICAL_AI_SUBGROUP_GENERALIZATION_RISK`: subgroup weakness, dataset bias, and liability risk cap medical-AI promotion.",
            "- `GENE_THERAPY_CASH_CRUNCH`: approval fails to convert into cash-flow-safe commercialization.",
            "- `CRO_FUNDING_CYCLE_OVERLAY`: biotech funding pressure can turn CRO visibility into a risk event.",
            ...
            "- `SURGICAL_ROBOT_GLP1_PROCEDURE_MIX_OVERLAY`: procedure-mix pressure from GLP-1 adoption remains a RedTeam overlay.",
        ]
    )
    return "\n".join(lines) + "\n"


def _score_price_alignment(candidate: Round112CaseCandidate) -> str:
...
def _rerating_result(candidate: Round112CaseCandidate) -> str:
    if candidate.case_type == "structural_success":
...
def _score_weight_hint(target: Round112ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND112_CASE_CANDIDATES",
    "ROUND112_DEFAULT_CASES_PATH",
    "ROUND112_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND112_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND112_PRICE_FIELDS",
    "ROUND112_SCORE_TARGETS",
    "Round112CaseCandidate",
    "Round112ScoreTarget",
    "Round112ScoreWeightDraft",
    "render_round112_green_guardrail_markdown",
    "render_round112_price_validation_plan_markdown",
    "render_round112_risk_overlay_markdown",
    "render_round112_summary_markdown",
    "round112_case_candidate_rows",
    "round112_case_records",
    "round112_price_field_rows",
    "round112_score_profile_rows",
    "round112_stage_date_rows",
    "round112_summary",
    "round112_target_for",
