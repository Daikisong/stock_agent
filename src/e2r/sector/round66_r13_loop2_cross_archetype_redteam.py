"""Round-66 R13 Loop-2 cross-archetype RedTeam / 4B / price validation pack.

Round 66 is a common validation layer over the R1-R12 sector/archetype work.
...
ROUND66_SOURCE_ROUND_PATH = "docs/round/round_66.md"
ROUND66_LARGE_SECTOR = "CROSS_ARCHETYPE_REDTEAM_4B_PRICE_VALIDATION"
ROUND66_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round66_r13_loop2_cross_archetype_redteam"
ROUND66_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r13_loop2_round66.jsonl"
ROUND66_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round66_r13_loop2_v2.csv"


@dataclass(frozen=True)
class Round66OverlayWeightDraft:
    eps_fcf: str
...
@dataclass(frozen=True)
class Round66OverlayTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round66OverlayWeightDraft
...
ROUND66_OVERLAY_TARGETS: tuple[Round66OverlayTarget, ...] = (
    Round66OverlayTarget(
        "STRUCTURAL_SUCCESS_ALIGNED",
        E2RArchetype.STRUCTURAL_SUCCESS_ALIGNED,
        Round10ThemePosture.GREEN_POSSIBLE,
        Round66OverlayWeightDraft("+", "+", "+", "+", "+", "optional", "+", "pass_if_no_redteam"),
    ...
    Round66OverlayTarget(
        ...
        Round66OverlayWeightDraft("maintain", "maintain", "maintain", "weaken", "deduct", "optional", "maintain", "stage4b_watch"),
    ...
    Round66OverlayTarget(
        ...
        Round66OverlayWeightDraft("0", "0", "0", "-", "-", "0", "-", "green_block"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round66OverlayWeightDraft("0~+", "0", "0", "+", "0", "0", "medium", "event_split"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round66OverlayWeightDraft("+", "+", "optional", "+", "optional", "0", "+", "stage2_candidate"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round66OverlayWeightDraft("+", "low", "+", "0", "low", "0", "medium", "cycle_cap"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("-", "-", "-", "-", "-", "0", "-", "score_recalibration"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round66OverlayWeightDraft("+", "+", "optional", "0", "-", "optional", "+", "alignment_review"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_block"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_review"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "hard_soft_gate"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("-", "-", "0", "-", "-", "-", "medium", "green_block"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("hard-", "hard-", "0", "hard-", "hard-", "hard-", "+", "hard_4c"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate", "reit_hard_review"),
    ...
    Round66OverlayTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round66OverlayWeightDraft("0", "0", "0", "0", "0", "0", "low", "green_block"),
...
ROUND66_CASE_CANDIDATES: tuple[Round66CaseCandidate, ...] = (
    Round66CaseCandidate(
        ...
        ("round_66.md Reuters SK Hynix AI boom / market value",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md Reuters Hyundai sales target / hybrid / buyback",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md Reuters Korea Commercial Act revision",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md event-to-contract escalation rule",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md AP SMCI auditor resignation",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md Reuters CrowdStrike outage and lawsuit",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md Reuters TerraUSD/Luna collapse",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md Reuters bluebird bio cash crunch",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md Reuters Novo GLP-1 guide down",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md Reuters Hindenburg Equinix short report",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md price-only rally definition",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md event premium bucket",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md cyclical success rule",),
    ...
    Round66CaseCandidate(
        ...
        "false_positive_score",
        "needs_price_backfill",
        ("round_66.md false-positive score rule",),
    ...
    Round66CaseCandidate(
        ...
        "evidence_good_but_price_failed",
        "needs_price_backfill",
        ("round_66.md evidence-good price-failed rule",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md legal/regulatory RedTeam rule",),
    ...
    Round66CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_66.md leverage/FCF breakdown rule",),
    ...
    Round66CaseCandidate(
        ...
        "unknown_insufficient_evidence",
        "needs_price_backfill",
        ("round_66.md insufficient evidence rule",),
        "Unknown evidence must remain unknown; missing fields are not filled.",
    ),
)


ROUND66_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "market",
...
def round66_target_for(target_id: str) -> Round66OverlayTarget | None:
    for target in ROUND66_OVERLAY_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round66_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND66_CASE_CANDIDATES:
        target = round66_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round66 R13 Loop-2 cross-archetype validation case for {candidate.target_id}; "
            ...
            score_price_alignment=_round66_score_price_alignment(candidate),
            rerating_result=_round66_rerating_result(candidate),
            price_pattern=candidate.alignment_hint,
            score_weight_hint=_round66_score_weight_hint(target),
            green_guardrails=(
...
def round66_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round66_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND66_CASE_CANDIDATES:
        target = round66_target_for(candidate.target_id)
...
def round66_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round66_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round66_backfill": "true"} for field in ROUND66_PRICE_FIELDS)


def round66_summary() -> dict[str, int | bool]:
    records = round66_case_records()
    return {
        "target_count": len(ROUND66_OVERLAY_TARGETS),
        ...
        "hard_gate_target_count": sum(1 for target in ROUND66_OVERLAY_TARGETS if target.hard_gate),
        "green_possible_count": sum(1 for target in ROUND66_OVERLAY_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND66_OVERLAY_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND66_OVERLAY_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round66_r13_loop2_reports(
    *,
    output_directory: str | Path = ROUND66_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND66_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND66_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round66_r13_loop2_cross_archetype_redteam_summary.md",
        "case_matrix": output / "round66_r13_loop2_case_matrix.csv",
        "target_matrix": output / "round66_r13_loop2_overlay_target_matrix.csv",
        "stage_date_plan": output / "round66_r13_loop2_stage_date_plan.csv",
        "redteam_gate_plan": output / "round66_r13_loop2_redteam_gate_plan.md",
        "price_validation_plan": output / "round66_r13_loop2_price_validation_plan.md",
        "price_fields": output / "round66_r13_loop2_price_fields.csv",
    }
    _write_case_jsonl(round66_case_records(), cases)
    _write_rows(round66_score_profile_rows(), score_profiles)
    _write_rows(round66_score_profile_rows(), paths["target_matrix"])
    _write_rows(round66_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round66_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round66_price_field_rows(), paths["price_fields"])
    paths["summary"].write_text(render_round66_summary_markdown(), encoding="utf-8")
    paths["redteam_gate_plan"].write_text(render_round66_redteam_gate_plan_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round66_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round66_summary_markdown() -> str:
    summary = round66_summary()
    lines = [
        "# Round-66 R13 Loop-2 Cross-Archetype RedTeam / 4B / Price Validation",
        "",
        f"- source_round: `{ROUND66_SOURCE_ROUND_PATH}`",
        f"- large_sector: `{ROUND66_LARGE_SECTOR}`",
        ...
        "## Interpretation",
        "",
        "- Round 66 is a common validation overlay, not a sector score-owner.",
...
def render_round66_redteam_gate_plan_markdown() -> str:
    lines = [
        "# Round-66 R13 Loop-2 RedTeam Gate Plan",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply Round66 overlay symbols to production scoring yet.",
            "- Do not lower Stage 3-Green to improve recall.",
            "- Do not use R13 Loop-2 case records as candidate-generation input.",
...
def render_round66_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-66 R13 Loop-2 Price / Stage Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round66_case_candidate_rows():
...
def _round66_score_price_alignment(candidate: Round66CaseCandidate) -> str:
...
def _round66_rerating_result(candidate: Round66CaseCandidate) -> str:
...
def _round66_score_weight_hint(target: Round66OverlayTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
        "eps_fcf": _round66_symbolic_weight(weights["eps_fcf"]),
        "visibility": _round66_symbolic_weight(weights["structural_visibility"]),
        "bottleneck": _round66_symbolic_weight(weights["bottleneck_pricing"]),
        "mispricing": _round66_symbolic_weight(weights["market_mispricing"]),
        "valuation": _round66_symbolic_weight(weights["valuation"]),
        "capital_allocation": _round66_symbolic_weight(weights["capital_allocation"]),
        "information_confidence": _round66_symbolic_weight(weights["information_confidence"]),
    }


def _round66_symbolic_weight(value: str) -> float:
    return {
        "+": 1.0,
        "0": 0.0,
        "-": -1.0,
...
__all__ = [
    ...
    "ROUND66_DEFAULT_CASES_PATH",
    "ROUND66_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND66_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND66_LARGE_SECTOR",
    "ROUND66_OVERLAY_TARGETS",
    "ROUND66_PRICE_FIELDS",
    "Round66CaseCandidate",
    "Round66OverlayTarget",
    "Round66OverlayWeightDraft",
