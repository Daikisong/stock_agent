"""Round-148 R3 Loop-9 battery, EV, and green-energy pack.

Round 148 turns the R3 battery/EV/green-energy pack into a score-stage-price
...
ROUND148_SOURCE_ROUND_PATH = "docs/round/round_148.md"
ROUND148_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round148_r3_loop9_battery_ev_green"
ROUND148_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r3_loop9_round148.jsonl"
ROUND148_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round148_r3_loop9_v9.csv"


@dataclass(frozen=True)
class Round148ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round148ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round148ScoreWeightDraft
...
@dataclass(frozen=True)
class Round148ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
) -> Round148ScoreWeightDraft:
    return Round148ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round148ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND148_BASE_SCORE_WEIGHTS: tuple[Round148BaseScoreWeight, ...] = (
    Round148BaseScoreWeight(
...
ROUND148_STAGE_CAPS: tuple[Round148StageCap, ...] = (
    Round148StageCap(
        "narrative_only_cap",
        "Stage 1",
...
ROUND148_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round148ScoreStagePriceAlignment, ...] = (
    Round148ScoreStagePriceAlignment(
...
ROUND148_SCORE_TARGETS: tuple[Round148ScoreTarget, ...] = (
    _target(
        ...
        note="Loop 9 lowers battery-material scores because EV CAPA, idle plants, and contract cancellations can quickly become 4C.",
    ),
    _target(
...
ROUND148_CASE_CANDIDATES: tuple[Round148CaseCandidate, ...] = (
    Round148CaseCandidate(
        ...
        ("round_148.md Reuters LGES $4.3B LFP contract",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters Tesla-LGES Megapack 3 Lansing confirmation",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters SK On Flatiron ESS deal",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters GM-LG Ohio battery plant",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters SK On Ford JV dissolution",),
    ...
    Round148CaseCandidate(
        ...
        ("round_148.md Financial Times Ford Energy storage pivot",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters Ford LGES contract cancellation",),
    ...
    Round148CaseCandidate(
        ...
        "ev_battery_contract_cancellation_hard_4c",
        "needs_price_backfill",
        ("round_148.md LGES-Freudenberg contract cancellation",),
    ...
    Round148CaseCandidate(
        ...
        ("round_148.md Reuters Redwood recycling funding",),
    ...
    Round148CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_148.md second-life battery grid storage SOH guardrail",),
    ...
    Round148CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_148.md arXiv graphite battery supply security",),
    ...
    Round148CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_148.md Reuters EQT KJ Environment platform",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters Hyundai hydrogen fuel-cell plant",),
    ...
    Round148CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_148.md Reuters Qcells customs detention",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters Orsted Sunrise Wind impairment",),
    ...
    Round148CaseCandidate(
        ...
        "missing_price_data",
        ("round_148.md Reuters lithium prices after crash",),
    ...
    Round148CaseCandidate(
        ...
        "missing_price_data",
        ("round_148.md Reuters energy storage lithium demand",),
    ...
    Round148CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_148.md Reuters lithium ESS demand sodium-ion risk",),
    ...
    Round148CaseCandidate(
        ...
        "missing_price_data",
        ("round_148.md Reuters Korea EV battery certification",),
    ...
    Round148CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_148.md Guardian Moss Landing battery storage fire",),
    ...
    Round148CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_148.md arXiv battery health validation",),
    ...
    Round148CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_148.md Reuters Volkswagen QuantumScape solid-state license",),
    ...
    Round148CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_148.md speculative battery technology guardrail",),
...
ROUND148_PRICE_FIELDS: tuple[str, ...] = (
...
def round148_target_for(target_id: str) -> Round148ScoreTarget | None:
    for target in ROUND148_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round148_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND148_CASE_CANDIDATES:
        target = round148_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round148 R3 Loop-9 case for {candidate.target_id}; "
...
def round148_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round148_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND148_CASE_CANDIDATES:
        target = round148_target_for(candidate.target_id)
...
def round148_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round148_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round148_backfill": "true"} for field in ROUND148_PRICE_FIELDS)


def round148_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND148_BASE_SCORE_WEIGHTS
    )


def round148_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND148_STAGE_CAPS
    )


def round148_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND148_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round148_summary() -> dict[str, int | bool]:
    records = round148_case_records()
    return {
        "target_count": len(ROUND148_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND148_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND148_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND148_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND148_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND148_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND148_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND148_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round148_r3_loop9_reports(
    *,
    output_directory: str | Path = ROUND148_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND148_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND148_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round148_r3_loop9_battery_ev_green_summary.md",
        "case_matrix": output / "round148_r3_loop9_case_matrix.csv",
        "stage_date_plan": output / "round148_r3_loop9_stage_date_plan.csv",
        "green_guardrails": output / "round148_r3_loop9_green_guardrails.md",
        "risk_overlays": output / "round148_r3_loop9_risk_overlays.md",
        "price_validation_plan": output / "round148_r3_loop9_price_validation_plan.md",
        "price_fields": output / "round148_r3_loop9_price_fields.csv",
        "base_score_weights": output / "round148_r3_loop9_base_score_weights.csv",
        "stage_caps": output / "round148_r3_loop9_stage_caps.csv",
        "score_stage_price_alignment": output / "round148_r3_loop9_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round148_r3_loop9_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round148_case_records(), cases)
    _write_rows(round148_score_profile_rows(), score_profiles)
    _write_rows(round148_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round148_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round148_price_field_rows(), paths["price_fields"])
    _write_rows(round148_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round148_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round148_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round148_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round148_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round148_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round148_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round148_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round148_summary_markdown() -> str:
    summary = round148_summary()
    lines = [
        "# Round-148 R3 Loop-9 Battery / EV / Green-Energy Summary",
        "",
        f"- source_round: `{ROUND148_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R3 Loop 9 says Stage 2 visibility and Stage 3 operating confirmation are different things.",
...
def render_round148_green_guardrail_markdown() -> str:
    lines = [
        "# Round-148 R3 Loop-9 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R3 Loop-9 v9.0 weights to production scoring yet.",
...
def render_round148_risk_overlay_markdown() -> str:
    lines = [
        "# Round-148 R3 Loop-9 Risk Overlays",
        "",
...
def render_round148_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-148 R3 Loop-9 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round148_case_candidate_rows():
...
def render_round148_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-148 R3 Loop-9 Score / Stage / Price Alignment",
        "",
        "Round 148 checks whether the score table's stage interpretation matches the observed operating and price path.",
...
def _score_price_alignment(candidate: Round148CaseCandidate) -> str:
...
def _rerating_result(candidate: Round148CaseCandidate) -> str:
...
def _score_weight_hint(target: Round148ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
