"""Round-168 R10 Loop-10 construction, real-estate, and building-materials pack.

Round 168 tightens the Round-50 R10 pack. It separates PF relief rallies,
...
Loop 10 revalidates sponsor-premium, no-revenue/no-tenant, water-rights,
ratepayer/utility-cost, AFFO-integrity, and building-solution gates against
fresh R10 case evidence.
...
ROUND168_SOURCE_ROUND_PATH = "docs/round/round_168.md"
ROUND168_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round168_r10_loop10_construction_real_estate_materials"
ROUND168_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r10_loop10_round168.jsonl"
ROUND168_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round168_r10_loop10_v10.csv"

ROUND168_SOURCE_CANONICAL_TARGET_IDS: tuple[str, ...] = (
...
ROUND168_HELPER_OVERLAY_TARGET_IDS: tuple[str, ...] = (
    "LOW_CARBON_CEMENT_PREMIUM",
    "PF_CREDIT_REDTEAM_OVERLAY",
)
ROUND168_SOURCE_CANONICAL_TARGET_COUNT = len(ROUND168_SOURCE_CANONICAL_TARGET_IDS)
ROUND168_HELPER_OVERLAY_TARGET_COUNT = len(ROUND168_HELPER_OVERLAY_TARGET_IDS)


@dataclass(frozen=True)
class Round168ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round168ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round168ScoreWeightDraft
...
GATE_WEIGHT = Round168ScoreWeightDraft("gate", "gate", "gate", "gate", "gate", "gate", "gate")


ROUND168_BASE_SCORE_AXES: tuple[Round168BaseScoreAxis, ...] = (
    Round168BaseScoreAxis(
...
ROUND168_STAGE_CAPS: tuple[Round168StageCap, ...] = (
    Round168StageCap(
        "stage1_headline_cap",
        "45",
        (
...
ROUND168_SCORE_TARGETS: tuple[Round168ScoreTarget, ...] = (
    Round168ScoreTarget(
        "CONSTRUCTION_REAL_ESTATE_CREDIT",
        E2RArchetype.CONSTRUCTION_REAL_ESTATE_CREDIT,
        Round10ThemePosture.REDTEAM_FIRST,
        Round168ScoreWeightDraft(12, 8, 5, 11, 7, 0, 5),
    ...
    Round168ScoreTarget(
        ...
        Round168ScoreWeightDraft(10, 8, 4, 10, 7, 0, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round168ScoreWeightDraft(11, 9, 4, 10, 7, 0, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round168ScoreWeightDraft(15, 12, 5, 12, 9, 1, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round168ScoreWeightDraft(15, 16, 5, 13, 11, 5, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round168ScoreWeightDraft(10, 7, 4, 11, 6, 0, 5),
    ...
    Round168ScoreTarget(
        ...
        Round168ScoreWeightDraft(18, 22, 18, 13, 11, 5, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round168ScoreWeightDraft(11, 12, 13, 12, 7, 1, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round168ScoreWeightDraft(12, 13, 13, 12, 8, 1, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round168ScoreWeightDraft(13, 15, 18, 13, 7, 2, 5),
    ...
    Round168ScoreTarget(
        "DATA_CENTER_LOCAL_OPPOSITION_OVERLAY",
        E2RArchetype.DATA_CENTER_LOCAL_OPPOSITION_OVERLAY,
        Round10ThemePosture.REDTEAM_FIRST,
        GATE_WEIGHT,
        ("local_opposition", "zoning_pause", "referendum", "community_opposition"),
        ("local_opposition_resolved", "zoning_approval", "community_approval"),
        ("community_approval", "zoning_approval", "project_schedule_intact"),
        ("local_opposition_risk_underpriced", "zoning_delay_ignored"),
        ("moratorium", "zoning_pause", "referendum_or_moratorium", "project_delay", "project_withdrawal"),
        ("community_approval_flag", "zoning_approval_flag", "local_opposition_resolved_flag"),
        ("moratorium", "zoning_pause", "referendum", "community_opposition", "project_delay"),
        ("moratorium", "zoning", "community", "project_timing"),
        "local opposition, zoning pauses, zoning pauses, and referendum risk are hard timing gates for data-center real assets.",
        gate_only=True,
    ),
    Round168ScoreTarget(
        "DATA_CENTER_WATER_RIGHTS_REFERENDUM",
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round168ScoreWeightDraft(17, 19, 12, 12, 10, 5, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round168ScoreWeightDraft(18, 15, 12, 11, 10, 3, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round168ScoreWeightDraft(13, 9, 8, 8, 6, 1, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round168ScoreWeightDraft(16, 14, 11, 12, 9, 2, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.GREEN_POSSIBLE,
        Round168ScoreWeightDraft(17, 16, 9, 12, 10, 3, 5),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.WATCH_YELLOW_FIRST,
        Round168ScoreWeightDraft(10, 8, 8, 10, 7, 0, 4),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round168ScoreWeightDraft(5, 5, 4, 8, 5, 0, 3),
    ...
    Round168ScoreTarget(
        ...
        Round10ThemePosture.REDTEAM_FIRST,
        Round168ScoreWeightDraft("cap", "cap", "cap", "cap", "cap", "cap", "+"),
...
ROUND168_CASE_CANDIDATES: tuple[Round168CaseCandidate, ...] = (
    Round168CaseCandidate(
    ...
    Round168CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_168.md Reuters Equinix annual sales forecast above estimates on AI data-center demand",),
    ...
    Round168CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_168.md Reuters Blackstone data center REIT raises $1.75 billion in US IPO",),
    ...
    Round168CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_168.md Reuters Fermi data center REIT Nasdaq debut after IPO",),
    ...
    Round168CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_168.md FT Fermi shares plunge on net loss",),
    ...
    Round168CaseCandidate(
        ...
        date(2026, 5, 15),
        None,
        ("local_opposition_flag", "zoning_pause_flag", "community_opposition_flag"),
        ("moratorium", "zoning_pause", "project_delay", "community_opposition"),
        "data_center_local_opposition",
        "needs_price_backfill",
        ("round_168.md Guardian Seattle large data center moratorium watch",),
        "Urban data-center local opposition risk can delay real assets even when AI demand is strong.",
        (E2RArchetype.DATA_CENTER_POWER_WATER_PERMITTING,),
    ),
    Round168CaseCandidate(
        ...
        date(2026, 5, 15),
        None,
        ("local_opposition_flag", "zoning_pause_flag", "community_submission_count"),
        ("moratorium", "zoning_pause", "referendum_or_moratorium", "project_delay"),
        "data_center_local_opposition",
        "needs_price_backfill",
        ("round_168.md Indianapolis data center moratorium resolution",),
        "local opposition, zoning pauses are a timing and execution gate, not a positive AI-infrastructure score input.",
        (E2RArchetype.DATA_CENTER_POWER_WATER_PERMITTING, E2RArchetype.DATA_CENTER_RATEPAYER_UTILITY_COST_OVERLAY),
    ),
    Round168CaseCandidate(
    ...
    Round168CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_168.md Reuters Cemex core earnings increase but volumes weak",),
    ...
    Round168CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_168.md Reuters Holcim acquires French precast concrete maker Alkern",),
...
ROUND168_PRICE_FIELDS: tuple[str, ...] = (
    "case_id",
    "symbol",
    "company_name",
    "primary_archetype",
...
def target_for(target_id: str) -> Round168ScoreTarget | None:
    for target in ROUND168_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round168_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND168_CASE_CANDIDATES:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round168 R10 case for {candidate.target_id}; "
...
def round168_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round168_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND168_CASE_CANDIDATES:
        target = target_for(candidate.target_id)
...
def round168_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round168_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round168_backfill": "true"} for field in ROUND168_PRICE_FIELDS)


def round168_base_score_axis_rows() -> tuple[dict[str, str], ...]:
    return tuple(axis.as_dict() for axis in ROUND168_BASE_SCORE_AXES)


def round168_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(cap.as_dict() for cap in ROUND168_STAGE_CAPS)


def round168_summary() -> dict[str, int | bool]:
    records = round168_case_records()
    return {
        "target_count": len(ROUND168_SCORE_TARGETS),
        "source_canonical_target_count": ROUND168_SOURCE_CANONICAL_TARGET_COUNT,
        "helper_overlay_target_count": ROUND168_HELPER_OVERLAY_TARGET_COUNT,
        "base_score_axis_count": len(ROUND168_BASE_SCORE_AXES),
        "stage_cap_count": len(ROUND168_STAGE_CAPS),
        ...
        "green_possible_count": sum(1 for target in ROUND168_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND168_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND168_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND168_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round168_r10_reports(
    *,
    output_directory: str | Path = ROUND168_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND168_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND168_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round168_r10_loop10_construction_real_estate_materials_summary.md",
        "case_matrix": output / "round168_r10_loop10_case_matrix.csv",
        "stage_date_plan": output / "round168_r10_loop10_stage_date_plan.csv",
        "green_guardrails": output / "round168_r10_loop10_green_guardrails.md",
        "risk_overlays": output / "round168_r10_loop10_risk_overlays.md",
        "price_validation_plan": output / "round168_r10_loop10_price_validation_plan.md",
        "price_fields": output / "round168_r10_loop10_price_fields.csv",
        "base_score_axes": output / "round168_r10_loop10_base_score_axes.csv",
        "stage_caps": output / "round168_r10_loop10_stage_caps.csv",
    }
    _write_case_jsonl(round168_case_records(), cases)
    _write_rows(round168_score_profile_rows(), score_profiles)
    _write_rows(round168_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round168_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round168_price_field_rows(), paths["price_fields"])
    _write_rows(round168_base_score_axis_rows(), paths["base_score_axes"])
    _write_rows(round168_stage_cap_rows(), paths["stage_caps"])
    paths["summary"].write_text(render_round168_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round168_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round168_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round168_price_validation_plan_markdown(), encoding="utf-8")
    return paths


def render_round168_summary_markdown() -> str:
    summary = round168_summary()
    lines = [
        "# Round 168 R10 Loop-10 Construction / Real Estate / Building Materials Summary",
        "",
        "Round 168 is calibration material only. It does not change production scoring.",
        "The source round defines 26 canonical targets; 2 older helper overlays remain for continuity and peer-case calibration.",
        "",
        "## Counts",
    ]
    ...
    lines.extend(
        [
            ...
            "",
            "## R10 v10 Base Score Axes",
            "",
            "These axes are calibration material only. They document how Round 168 weighs cash-flow conversion before real-estate, data-center, or building-material headlines can become higher-conviction evidence.",
        ]
    )
    for axis in ROUND168_BASE_SCORE_AXES:
    ...
    for cap in ROUND168_STAGE_CAPS:
        lines.append(f"- {cap.cap_id}: {cap.score_cap}")
    return "\n".join(lines) + "\n"


def render_round168_green_guardrail_markdown() -> str:
    lines = [
        "# Round 168 R10 Loop-10 Green Guardrails",
        "",
        "- Do not apply R10 Loop-10 v10.0 weights to production scoring yet.",
...
def render_round168_risk_overlay_markdown() -> str:
    lines = [
        "# Round 168 R10 Loop-10 Risk Overlays",
        "",
        ...
        "- `DATA_CENTER_LOCAL_OPPOSITION_OVERLAY`: moratorium, zoning pause, and community opposition can delay or break data-center project timing.",
...
def render_round168_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-168 R10 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round168_case_candidate_rows():
    ...
    lines.extend(
        [
            ...
            "- `data_center_local_opposition`: local zoning or local opposition risk can delay project timing even when AI demand is real.",
...
def _score_price_alignment(candidate: Round168CaseCandidate) -> str:
...
def _rerating_result(candidate: Round168CaseCandidate) -> str:
...
def _score_weight_hint(target: Round168ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND168_CASE_CANDIDATES",
    "ROUND168_BASE_SCORE_AXES",
    "ROUND168_DEFAULT_CASES_PATH",
    "ROUND168_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND168_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND168_HELPER_OVERLAY_TARGET_COUNT",
    "ROUND168_HELPER_OVERLAY_TARGET_IDS",
    "ROUND168_PRICE_FIELDS",
    "ROUND168_SCORE_TARGETS",
    "ROUND168_SOURCE_CANONICAL_TARGET_COUNT",
    "ROUND168_SOURCE_CANONICAL_TARGET_IDS",
    "ROUND168_SOURCE_ROUND_PATH",
    "Round168CaseCandidate",
    "Round168BaseScoreAxis",
    "Round168ScoreTarget",
    "Round168ScoreWeightDraft",
    "render_round168_green_guardrail_markdown",
    "render_round168_price_validation_plan_markdown",
    "render_round168_risk_overlay_markdown",
    "render_round168_summary_markdown",
    "round168_case_candidate_rows",
    "round168_base_score_axis_rows",
    "round168_case_records",
    "round168_price_field_rows",
    "round168_score_profile_rows",
    "round168_stage_date_rows",
    "round168_summary",
    "target_for",
    "write_round168_r10_reports",
]
