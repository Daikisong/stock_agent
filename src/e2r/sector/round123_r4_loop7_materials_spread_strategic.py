"""Round-123 R4 Loop-7 materials, spread, and strategic-resources pack.

Round 123 turns R4 into a score-stage-price alignment layer for chemicals,
...
ROUND123_SOURCE_ROUND_PATH = "docs/round/round_123.md"
ROUND123_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round123_r4_loop7_materials_spread_strategic"
ROUND123_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r4_loop7_round123.jsonl"
ROUND123_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round123_r4_loop7_v7.csv"


@dataclass(frozen=True)
class Round123ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round123ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round123ScoreWeightDraft
...
@dataclass(frozen=True)
class Round123ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
) -> Round123ScoreWeightDraft:
    return Round123ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round123ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND123_BASE_SCORE_WEIGHTS: tuple[Round123BaseScoreWeight, ...] = (
    Round123BaseScoreWeight(
        "eps_fcf_transition",
        22,
    ...
    Round123BaseScoreWeight(
        ...
        10,
        "Capital raise, share issuance, all-stock dilution, CAPEX burden, dividend cut, and buyback quality are explicit score axes.",
    ),
    Round123BaseScoreWeight(
...
ROUND123_STAGE_CAPS: tuple[Round123StageCap, ...] = (
    Round123StageCap(
...
ROUND123_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round123ScoreStagePriceAlignment, ...] = (
    Round123ScoreStagePriceAlignment(
...
ROUND123_SCORE_TARGETS: tuple[Round123ScoreTarget, ...] = (
    _target(
        "REFINING_OIL_SPREAD",
...
ROUND123_CASE_CANDIDATES: tuple[Round123CaseCandidate, ...] = (
    Round123CaseCandidate(
        "mp_materials_dod_price_floor_case",
        "RARE_METALS_PRICE_FLOOR_OFFTAKE",
        "MP",
        ...
        ("round_123.md AP MP Materials Pentagon agreement",),
    ...
    Round123CaseCandidate(
        ...
        "needs_exact_stage_date_backfill",
        ("round_123.md AP MP Materials Apple magnet agreement",),
    ...
    Round123CaseCandidate(
        ...
        ("round_123.md Reuters MP Materials $500M offering",),
    ...
    Round123CaseCandidate(
        ...
        ("round_123.md Reuters rare-earth export controls",),
    ...
    Round123CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_123.md Reuters rare-earth approval delay",),
    ...
    Round123CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_123.md WSJ copper record high",),
    ...
    Round123CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_123.md Reuters sulfur squeeze Indonesian nickel sector",),
    ...
    Round123CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_123.md Reuters Barrick Q1 profit and buyback",),
    ...
    Round123CaseCandidate(
        ...
        "gold_miner_jurisdiction_rerating",
        "missing_direct_symbol_mapping",
        ("round_123.md Reuters Equinox Orla gold producer merger",),
    ...
    Round123CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_123.md Reuters POSCO Alaska LNG deal",),
    ...
    Round123CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_123.md Reuters SK Innovation Q1 profit",),
    ...
    Round123CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_123.md Reuters Korean petrochemical oversupply",),
    ...
    Round123CaseCandidate(
        ...
        "missing_price_data",
        ("round_123.md Reuters lithium prices after crash",),
    ...
    Round123CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_123.md FT BHP dividend cut",),
    ...
    Round123CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_123.md Reuters Korea Zinc tender offer",),
    ...
    Round123CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_123.md Reuters Korea Zinc share issuance probe",),
    ...
    Round123CaseCandidate(
        ...
        ("round_123.md Reuters International Paper DS Smith divestment",),
    ...
    Round123CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_123.md packaging consolidation remedy calibration",),
    ...
    Round123CaseCandidate(
        ...
        "missing_price_data",
        ("round_123.md advanced material speculative theme note",),
...
ROUND123_PRICE_FIELDS: tuple[str, ...] = (
...
def round123_target_for(target_id: str) -> Round123ScoreTarget | None:
    for target in ROUND123_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round123_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND123_CASE_CANDIDATES:
        target = round123_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round123 R4 Loop-7 case for {candidate.target_id}; "
...
def round123_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round123_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND123_CASE_CANDIDATES:
        target = round123_target_for(candidate.target_id)
...
def round123_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round123_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round123_backfill": "true"} for field in ROUND123_PRICE_FIELDS)


def round123_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND123_BASE_SCORE_WEIGHTS
    )


def round123_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND123_STAGE_CAPS
    )


def round123_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND123_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round123_summary() -> dict[str, int | bool]:
    records = round123_case_records()
    return {
        "target_count": len(ROUND123_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND123_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND123_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND123_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND123_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND123_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND123_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND123_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round123_r4_loop7_reports(
    *,
    output_directory: str | Path = ROUND123_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND123_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND123_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round123_r4_loop7_materials_spread_strategic_summary.md",
        "case_matrix": output / "round123_r4_loop7_case_matrix.csv",
        "stage_date_plan": output / "round123_r4_loop7_stage_date_plan.csv",
        "green_guardrails": output / "round123_r4_loop7_green_guardrails.md",
        "risk_overlays": output / "round123_r4_loop7_risk_overlays.md",
        "price_validation_plan": output / "round123_r4_loop7_price_validation_plan.md",
        "price_fields": output / "round123_r4_loop7_price_fields.csv",
        "base_score_weights": output / "round123_r4_loop7_base_score_weights.csv",
        "stage_caps": output / "round123_r4_loop7_stage_caps.csv",
        "score_stage_price_alignment": output / "round123_r4_loop7_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round123_r4_loop7_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round123_case_records(), cases)
    _write_rows(round123_score_profile_rows(), score_profiles)
    _write_rows(round123_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round123_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round123_price_field_rows(), paths["price_fields"])
    _write_rows(round123_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round123_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round123_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round123_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round123_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round123_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round123_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round123_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round123_summary_markdown() -> str:
    summary = round123_summary()
    lines = [
        "# Round-123 R4 Loop-7 Materials / Spread / Strategic Resources Summary",
        "",
        f"- source_round: `{ROUND123_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R4 Loop 7 says price increase and structural rerating are different things.",
...
def render_round123_green_guardrail_markdown() -> str:
    lines = [
        "# Round-123 R4 Loop-7 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R4 Loop-7 v7.0 weights to production scoring yet.",
...
def render_round123_risk_overlay_markdown() -> str:
    lines = [
        "# Round-123 R4 Loop-7 Risk Overlays",
        "",
...
def render_round123_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-123 R4 Loop-7 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round123_case_candidate_rows():
...
def render_round123_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-123 R4 Loop-7 Score / Stage / Price Alignment",
        "",
        "Round 123 checks whether R4 score interpretation matches the observed price, operating, and capital path.",
...
def _score_price_alignment(candidate: Round123CaseCandidate) -> str:
...
def _rerating_result(candidate: Round123CaseCandidate) -> str:
...
def _score_weight_hint(target: Round123ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND123_CASE_CANDIDATES",
    "ROUND123_DEFAULT_CASES_PATH",
    "ROUND123_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND123_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND123_PRICE_FIELDS",
    "ROUND123_BASE_SCORE_WEIGHTS",
    "ROUND123_SCORE_TARGETS",
    "ROUND123_SCORE_STAGE_PRICE_ALIGNMENT",
    "ROUND123_STAGE_CAPS",
    "Round123BaseScoreWeight",
    "Round123CaseCandidate",
    "Round123ScoreStagePriceAlignment",
    ...
    "Round123ScoreWeightDraft",
    "Round123StageCap",
    "render_round123_green_guardrail_markdown",
    "render_round123_price_validation_plan_markdown",
    "render_round123_risk_overlay_markdown",
    "render_round123_score_stage_price_alignment_markdown",
    "render_round123_summary_markdown",
    "round123_base_score_weight_rows",
    "round123_case_candidate_rows",
    "round123_case_records",
    "round123_price_field_rows",
    "round123_score_stage_price_alignment_rows",
    "round123_score_profile_rows",
    "round123_stage_cap_rows",
    "round123_stage_date_rows",
    "round123_summary",
    "round123_target_for",
    "write_round123_r4_loop7_reports",
]
