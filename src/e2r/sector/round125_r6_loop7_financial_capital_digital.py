"""Round-125 R6 Loop-7 financial, capital-allocation, and digital-finance pack.

Round 125 separates cheapness from discount removal. Low PBR, value-up policy,
...
ROUND125_SOURCE_ROUND_PATH = "docs/round/round_125.md"
ROUND125_DEFAULT_OUTPUT_DIRECTORY = "output/e2r_round125_r6_loop7_financial_capital_digital"
ROUND125_DEFAULT_CASES_PATH = "data/e2r_case_library/cases_r6_loop7_round125.jsonl"
ROUND125_DEFAULT_SCORE_PROFILE_PATH = "data/sector_taxonomy/score_weight_profiles_round125_r6_loop7_v7.csv"


@dataclass(frozen=True)
class Round125ScoreWeightDraft:
    eps_fcf: int | str
...
@dataclass(frozen=True)
class Round125ScoreTarget:
    target_id: str
    canonical_archetype: E2RArchetype
    posture: Round10ThemePosture
    score_weight: Round125ScoreWeightDraft
...
@dataclass(frozen=True)
class Round125ScoreStagePriceAlignment:
    case_id: str
    score_stage: str
...
def _w(
    ...
    capital: int | str,
    confidence: int | str,
) -> Round125ScoreWeightDraft:
    return Round125ScoreWeightDraft(eps_fcf, visibility, bottleneck, mispricing, valuation, capital, confidence)
...
def _target(
    ...
    posture: Round10ThemePosture,
    weight: Round125ScoreWeightDraft,
    *,
    stage1: tuple[str, ...],
    stage2: tuple[str, ...],
    stage3: tuple[str, ...],
...
ROUND125_BASE_SCORE_WEIGHTS: tuple[Round125BaseScoreWeight, ...] = (
    Round125BaseScoreWeight(
    ...
    Round125BaseScoreWeight(
        ...
        10,
        "Governance execution, disclosure detail, exchange security, reserve design, and regulation decide confidence.",
    ),
)


ROUND125_STAGE_CAPS: tuple[Round125StageCap, ...] = (
    Round125StageCap(
...
ROUND125_SCORE_STAGE_PRICE_ALIGNMENT: tuple[Round125ScoreStagePriceAlignment, ...] = (
    Round125ScoreStagePriceAlignment(
    ...
    Round125ScoreStagePriceAlignment(
        ...
        "4C-watch",
        "transaction/capital-gains/dividend/corporate tax policy changes can shock brokerage and value-up trades",
        "tax-policy overlay remains necessary",
        "strengthen tax-policy, trading-value, dividend-tax, and market-sentiment penalties",
    ),
)


ROUND125_SCORE_TARGETS: tuple[Round125ScoreTarget, ...] = (
    _target(
...
ROUND125_CASE_CANDIDATES: tuple[Round125CaseCandidate, ...] = (
    Round125CaseCandidate(
        "korea_commercial_act_treasury_cancel_case",
        "TREASURY_CANCEL_MANDATE_POLICY",
        ...
        ("round_125.md Reuters commercial act treasury cancellation",),
    ...
    Round125CaseCandidate(
        ...
        ("round_125.md Reuters SK Square buybacks",),
    ...
    Round125CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_125.md Reuters Samsung treasury cancellation",),
    ...
    Round125CaseCandidate(
        ...
        ("round_125.md section 4-4 bank and financial holding candidate",),
        "Round 125 keeps banks and financial holdings Green-capable only after ROE, CET1, credit cost, PF exposure, and return execution are verified.",
        (E2RArchetype.FINANCIAL_SPREAD_BALANCE_SHEET,),
    ),
    Round125CaseCandidate(
        ...
        "needs_named_case_and_price_backfill",
        ("round_125.md section 4-5 insurance underwriting candidate",),
        "Round 125 keeps insurance Green-capable, but separates CSM quality, K-ICS, loss ratio, and investment-loss risks from bank value-up.",
    ),
    Round125CaseCandidate(
        "samsung_ct_activist_rejection_case",
        "GOVERNANCE_EXECUTION_FAILURE_OVERLAY",
        ...
        ("round_125.md Financial Times Samsung C&T activist rejection",),
    ...
    Round125CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_125.md Reuters Korea Zinc tender offer",),
    ...
    Round125CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_125.md Reuters Korea Zinc share issuance probe",),
    ...
    Round125CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_125.md Reuters Korea tax policy shock",),
    ...
    Round125CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_125.md Barron's AI windfall tax policy shock",),
    ...
    Round125CaseCandidate(
        ...
        ("round_125.md Reuters Mynt GCash IPO",),
    ...
    Round125CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_125.md Reuters Clear Street IPO valuation cut",),
    ...
    Round125CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_125.md Reuters Toss global push won stablecoin",),
    ...
    Round125CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_125.md Reuters Circle IPO valuation",),
    ...
    Round125CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_125.md Reuters Bank of England stablecoin regulation",),
    ...
    Round125CaseCandidate(
        ...
        "needs_source_date_and_price_backfill",
        ("round_125.md Reuters TerraUSD Do Kwon",),
    ...
    Round125CaseCandidate(
        ...
        "needs_price_backfill",
        ("round_125.md Reuters Hana Bank Dunamu stake",),
    ...
    Round125CaseCandidate(
        ...
        ("round_125.md WSJ Dunamu Naver Financial merger option",),
    ...
    Round125CaseCandidate(
        ...
        "needs_named_case_and_price_backfill",
        ("round_125.md digital asset exchange security cycle checklist",),
    ...
    Round125CaseCandidate(
        ...
        "missing_direct_symbol_mapping",
        ("round_125.md Reuters Korean PF restructuring scrutiny",),
    ...
    Round125CaseCandidate(
        ...
        "missing_public_price_data",
        ("round_125.md Reuters FBI Bybit hack attribution",),
...
ROUND125_PRICE_FIELDS: tuple[str, ...] = (
...
def round125_target_for(target_id: str) -> Round125ScoreTarget | None:
    for target in ROUND125_SCORE_TARGETS:
        if target.target_id == target_id:
            return target
    return None


def round125_case_records() -> tuple[E2RCaseRecord, ...]:
    records: list[E2RCaseRecord] = []
    for candidate in ROUND125_CASE_CANDIDATES:
        target = round125_target_for(candidate.target_id)
        if target is None:
        ...
        record = E2RCaseRecord(
            ...
            evidence_summary=(
                f"Round125 R6 Loop-7 case for {candidate.target_id}; "
...
def round125_score_profile_rows() -> tuple[dict[str, str], ...]:
...
def round125_case_candidate_rows() -> tuple[dict[str, str], ...]:
    rows: list[dict[str, str]] = []
    for candidate in ROUND125_CASE_CANDIDATES:
        target = round125_target_for(candidate.target_id)
...
def round125_stage_date_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "target_id": target.target_id,
...
def round125_price_field_rows() -> tuple[dict[str, str], ...]:
    return tuple({"field": field, "required_for_round125_backfill": "true"} for field in ROUND125_PRICE_FIELDS)


def round125_base_score_weight_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
        ...
        for row in ROUND125_BASE_SCORE_WEIGHTS
    )


def round125_stage_cap_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "cap_id": row.cap_id,
        ...
        for row in ROUND125_STAGE_CAPS
    )


def round125_score_stage_price_alignment_rows() -> tuple[dict[str, str], ...]:
    return tuple(
        {
            "case_id": row.case_id,
        ...
        for row in ROUND125_SCORE_STAGE_PRICE_ALIGNMENT
    )


def round125_summary() -> dict[str, int | bool]:
    records = round125_case_records()
    return {
        "target_count": len(ROUND125_SCORE_TARGETS),
        "case_candidate_count": len(records),
        "base_score_component_count": len(ROUND125_BASE_SCORE_WEIGHTS),
        "stage_cap_count": len(ROUND125_STAGE_CAPS),
        "score_stage_price_alignment_count": len(ROUND125_SCORE_STAGE_PRICE_ALIGNMENT),
        ...
        "green_possible_count": sum(1 for target in ROUND125_SCORE_TARGETS if target.posture == Round10ThemePosture.GREEN_POSSIBLE),
        "watch_yellow_first_count": sum(1 for target in ROUND125_SCORE_TARGETS if target.posture == Round10ThemePosture.WATCH_YELLOW_FIRST),
        "redteam_first_count": sum(1 for target in ROUND125_SCORE_TARGETS if target.posture == Round10ThemePosture.REDTEAM_FIRST),
        "gate_only_target_count": sum(1 for target in ROUND125_SCORE_TARGETS if target.gate_only),
        "production_scoring_changed": False,
        "case_records_are_candidate_generation_input": False,
    }


def write_round125_r6_loop7_reports(
    *,
    output_directory: str | Path = ROUND125_DEFAULT_OUTPUT_DIRECTORY,
    cases_path: str | Path = ROUND125_DEFAULT_CASES_PATH,
    score_profile_path: str | Path = ROUND125_DEFAULT_SCORE_PROFILE_PATH,
) -> dict[str, Path]:
    ...
    paths = {
        ...
        "summary": output / "round125_r6_loop7_financial_capital_digital_summary.md",
        "case_matrix": output / "round125_r6_loop7_case_matrix.csv",
        "stage_date_plan": output / "round125_r6_loop7_stage_date_plan.csv",
        "green_guardrails": output / "round125_r6_loop7_green_guardrails.md",
        "risk_overlays": output / "round125_r6_loop7_risk_overlays.md",
        "price_validation_plan": output / "round125_r6_loop7_price_validation_plan.md",
        "price_fields": output / "round125_r6_loop7_price_fields.csv",
        "base_score_weights": output / "round125_r6_loop7_base_score_weights.csv",
        "stage_caps": output / "round125_r6_loop7_stage_caps.csv",
        "score_stage_price_alignment": output / "round125_r6_loop7_score_stage_price_alignment.csv",
        "score_stage_price_alignment_md": output / "round125_r6_loop7_score_stage_price_alignment.md",
    }
    _write_case_jsonl(round125_case_records(), cases)
    _write_rows(round125_score_profile_rows(), score_profiles)
    _write_rows(round125_case_candidate_rows(), paths["case_matrix"])
    _write_rows(round125_stage_date_rows(), paths["stage_date_plan"])
    _write_rows(round125_price_field_rows(), paths["price_fields"])
    _write_rows(round125_base_score_weight_rows(), paths["base_score_weights"])
    _write_rows(round125_stage_cap_rows(), paths["stage_caps"])
    _write_rows(round125_score_stage_price_alignment_rows(), paths["score_stage_price_alignment"])
    paths["summary"].write_text(render_round125_summary_markdown(), encoding="utf-8")
    paths["green_guardrails"].write_text(render_round125_green_guardrail_markdown(), encoding="utf-8")
    paths["risk_overlays"].write_text(render_round125_risk_overlay_markdown(), encoding="utf-8")
    paths["price_validation_plan"].write_text(render_round125_price_validation_plan_markdown(), encoding="utf-8")
    paths["score_stage_price_alignment_md"].write_text(
        render_round125_score_stage_price_alignment_markdown(),
        encoding="utf-8",
    )
    return paths


def render_round125_summary_markdown() -> str:
    summary = round125_summary()
    lines = [
        "# Round-125 R6 Loop-7 Financial / Capital / Digital Summary",
        "",
        f"- source_round: `{ROUND125_SOURCE_ROUND_PATH}`",
        ...
        "## Interpretation",
        "",
        "- R6 Loop 7 says low PBR, value-up policy, and digital-asset labels are not enough; execution decides.",
...
def render_round125_green_guardrail_markdown() -> str:
    lines = [
        "# Round-125 R6 Loop-7 Green Guardrails",
        "",
    ...
    lines.extend(
        [
            ...
            "## What Not To Change",
            "",
            "- Do not apply R6 Loop-7 v7.0 weights to production scoring yet.",
...
def render_round125_risk_overlay_markdown() -> str:
    lines = [
        "# Round-125 R6 Loop-7 Risk Overlays",
        "",
...
def render_round125_price_validation_plan_markdown() -> str:
    lines = [
        "# Round-125 R6 Loop-7 Price Validation Plan",
        "",
        "## Method",
        "",
    ...
    for row in round125_case_candidate_rows():
...
def render_round125_score_stage_price_alignment_markdown() -> str:
    lines = [
        "# Round-125 R6 Loop-7 Score / Stage / Price Alignment",
        "",
        "Round 125 checks whether financial, capital-allocation, and digital-finance score interpretation matches the observed price and operating path.",
...
def _score_price_alignment(candidate: Round125CaseCandidate) -> str:
...
def _rerating_result(candidate: Round125CaseCandidate) -> str:
...
def _score_weight_hint(target: Round125ScoreTarget) -> dict[str, float]:
    weights = target.score_weight.as_dict()
    return {
...
__all__ = [
    "ROUND125_CASE_CANDIDATES",
    "ROUND125_DEFAULT_CASES_PATH",
    "ROUND125_DEFAULT_OUTPUT_DIRECTORY",
    "ROUND125_DEFAULT_SCORE_PROFILE_PATH",
    "ROUND125_PRICE_FIELDS",
    "ROUND125_BASE_SCORE_WEIGHTS",
    "ROUND125_SCORE_TARGETS",
    "ROUND125_SCORE_STAGE_PRICE_ALIGNMENT",
    "ROUND125_STAGE_CAPS",
    "Round125BaseScoreWeight",
    "Round125CaseCandidate",
    "Round125ScoreStagePriceAlignment",
    ...
    "Round125ScoreWeightDraft",
    "Round125StageCap",
    "render_round125_green_guardrail_markdown",
    "render_round125_price_validation_plan_markdown",
    "render_round125_risk_overlay_markdown",
    "render_round125_score_stage_price_alignment_markdown",
    "render_round125_summary_markdown",
    "round125_base_score_weight_rows",
    "round125_case_candidate_rows",
    "round125_case_records",
    "round125_price_field_rows",
    "round125_score_stage_price_alignment_rows",
    "round125_score_profile_rows",
    "round125_stage_cap_rows",
    "round125_stage_date_rows",
    "round125_summary",
    "round125_target_for",
    "write_round125_r6_loop7_reports",
]
