    ...
    *,
    ...
    return {
        ...
        "rules": [
            ...
            "If existing_evidence_summary.full_thesis_queue_context.planner_failure_feedback is non-empty, treat it as source-route repair guidance only. It is not score evidence. Use previous_claim_failure_primary_mode, source_route_repair_actions, previous_seed_materialization_primary_failure_axis, and seed_materialization_repair_actions to avoid repeating the prior rejected claim/seed materialization pattern and produce source_task_drafts/query_intents that can create a new source-backed claim for the primitive_gap.",
