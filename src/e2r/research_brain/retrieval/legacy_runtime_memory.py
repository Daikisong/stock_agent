"""Compatibility runtime memory projection owned by Research Brain."""
...
from e2r.research_brain.recipes.legacy_route_recovery import build_source_route_patterns
