"""Write research reverse-engineering reports."""
...
from .archetype_pattern_extractor import build_archetype_coverage_matrix, build_source_quality_matrix
from .research_case_extractor import extract_research_cases
from .research_to_runtime_memory import build_memory_card_matrix, build_runtime_memory_cards
